...
const sidebars: SidebarsConfig = {
  ...
  cloudcostmanagement: [
    // Cloud Cost Management Landing Page
    {
      ...
      {
        type: "category",
        label: "AutoStopping Rules - Option 2",
        link: {
          type: "generated-index",
        },
       collapsed: true,
      ...
      {
        type: "category",
        label: "AutoStopping Rules - Original",
        link: {
          type: "generated-index",
        },
       collapsed: true,
       items: [ { type: "autogenerated", dirName: "cloud-cost-management/4-use-ccm-cost-optimization/autostopping-option-two", } ],
      },
      {
        type: "category",
        label: "AutoStopping Rules - Option 3",
        link: {
          type: "generated-index",
        },
       collapsed: true,
       items: [ { type: "autogenerated", dirName: "cloud-cost-management/4-use-ccm-cost-optimization/autostopping-option-three", } ],
      },
      {
        type: "category",
