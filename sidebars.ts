...
const sidebars: SidebarsConfig = {
  allcontent: [
    // Documentation Parent
    {
      ...
      items: [
        ...
        // AI Code Review Landing Page - hidden from navigation (HDH-1155).
        // The aicr sidebar below is still built, so /docs/ai-code-review and every
        // page under it stay reachable by direct URL. Uncomment at beta launch.
        // {
        //   type: 'link',
        //   label: 'AI Code Review',
        //   className: 'sidebar-aicr',
        //   href: '/docs/ai-code-review',
        //   customProps: {
        //     description:
        //       'Review pull requests with an AI agent that understands your delivery data. (Beta)',
        //   },
        // },
        ...
        // Cloud Development Environments Landing Page - hidden from navigation (HDH-542)
        // {
        //   type: 'link',
        ...
        // SEI
        {
          ...
          customProps: {
            description:
              'Use AI-powered insights to optimize AI adoption, improve engineering efficiency, and accelerate software delivery.',
          },
        },
        // SMP landing page
        {
  ...
  aicr: [
    {
      ...
      customProps: {
        description:
          'Review pull requests with an AI agent that understands your delivery data.',
      },
      collapsed: true,
      items: [
        {
          type: 'html',
          value: 'New to AI Code Review?',
          className: 'horizontal-bar',
        },
        'ai-code-review/overview',
        'ai-code-review/get-started',
        'ai-code-review/whats-supported',
        {
          type: 'html',
          value: 'Use AI Code Review',
          className: 'horizontal-bar',
        },
        {
          type: 'category',
          ...
          collapsed: true,
          items: [
            { type: 'autogenerated', dirName: 'ai-code-review/platforms' },
          ],
        },
        {
          type: 'category',
          ...
          collapsed: true,
          items: [
            { type: 'autogenerated', dirName: 'ai-code-review/configure' },
          ],
        },
        {
          type: 'category',
          ...
          collapsed: true,
          items: [
            { type: 'autogenerated', dirName: 'ai-code-review/workflows' },
          ],
        },
        {
          type: 'html',
        ...
        'ai-code-review/resources/api-reference',
        'ai-code-review/resources/permissions-and-rbac',
        'ai-code-review/resources/limits-and-quotas',
        'ai-code-review/resources/faqs',
      ],
    },
    // Release Notes
    {
      ...
      label: 'Release Notes',
      className: 'sidebar-Release_Notes',
      href: '/release-notes/ai-code-review',
      customProps: {
        description: 'Learn about recent changes to Harness products.',
      },
    },
      ...
      items: [
        ...
        },
        {
          ...
          link: {
            ...
            slug: "/category/code-repository-cli-commands",
          },
          collapsed: true,
          items: [{ type: "autogenerated", dirName: "code-repository/cli-commands" }],
        },
        {
          type: "html",
          value: "Troubleshooting & Resources",
  ...
  platform: [
    {
      ...
      items: [
        ...
        },
        {
          ...
          link: {
            type: 'doc',
            id: 'platform/authentication/authentication-overview',
          },
          collapsed: true,
        ...
        },
        {
          ...
          link: {
            type: 'doc',
            id: 'platform/organizations-and-projects/overview',
          },
          collapsed: true,
        ...
        },
        {
          ...
          link: {
            type: 'doc',
            id: 'platform/role-based-access-control/rbac-in-harness',
          },
          collapsed: true,
        ...
        },
        {
        ...
        },
         {
          ...
          link: {
            type: 'doc',
            id: 'platform/status-portal/view-personalized-status-portal',
          },
          collapsed: true,
          items: [{ type: 'autogenerated', dirName: 'platform/status-portal' }],
        },
        {
          type: 'category',
          label: 'Pipelines',
        ...
        'platform/customize-harness-ui',
        {
          ...
          link: {
            ...
            description: 'Use Harness Knowledge Graph to manage and query organizational knowledge with AI-powered prompts and context.',
          },
          collapsed: true,
          items: [{ type: 'autogenerated', dirName: 'platform/knowledge-graph' }],
        },
        {
          type: 'html',
          value: 'Use Harness CLI',
          className: 'horizontal-bar',
        },
        {
          type: 'category',
          ...
          link: {
            type: 'generated-index',
            title: 'Harness CLI',
            description: 'Use the Harness CLI to manage pipelines, artifacts, infrastructure, and platform resources from your terminal.',
          },
          collapsed: true,
          items: [
            'platform/harness-cli/harness-cli-overview',
            'platform/harness-cli/install-and-upgrade',
            'platform/harness-cli/authenticate',
            'platform/harness-cli/supported-resources-and-actions',
            'platform/harness-cli/global-flags-and-output',
            {
              type: 'category',
              label: 'Harness CLI Commands',
              link: {
                type: 'generated-index',
                title: 'Harness CLI Commands',
                description: 'Detailed command usage and examples for Platform, Continuous Delivery, Artifact Registry, Infrastructure as Code Management, Code Repository, AI Evaluations, and Knowledge Graph.',
              },
              collapsed: true,
              items: [{ type: 'autogenerated', dirName: 'platform/harness-cli/harness-cli-commands' }],
            },
            'platform/harness-cli/troubleshooting',
          ],
        },
        {
          type: 'html',
        ...
        },
        {
          ...
          link: {
            type: 'doc',
            id: 'platform/harness-ai/overview',
          },
          collapsed: true,
          items: [{ type: 'autogenerated', dirName: 'platform/harness-ai' }],
        },
        {
          type: 'html',
          value: 'Subscriptions & Licenses',
          className: 'horizontal-bar',
        },
        { type: 'autogenerated', dirName: 'platform/subscriptions-licenses' },
        {
          type: 'html',
          value: 'Troubleshooting & Resources',
          className: 'horizontal-bar',
        },
        {
          ...
          collapsed: true,
          items: [{ type: 'autogenerated', dirName: 'platform/get-started/tutorials' }],
        },
        {
          type: 'category',
          label: 'Troubleshooting',
          ...
          collapsed: true,
          items: [{ type: 'autogenerated', dirName: 'platform/knowledgebase/troubleshooting' }],
        },
        {
          type: 'html',
          value: 'Knowledge Base & FAQs',
          className: 'horizontal-bar',
        },
        {
          type: 'category',
          ...
          collapsed: true,
          items: [{ type: 'autogenerated', dirName: 'platform/knowledgebase/articles' }],
        },
        'platform/harness-platform-faqs',
        'platform/new-navigation-faqs',
        'platform/pipeline-faq',
        {
          type: 'html',
        ...
        },
        {
          ...
          collapsed: true,
          items: [{ type: 'autogenerated', dirName: 'platform/reference-architectures' }],
        },
      ],
    },
    // Release Notes
  ...
  artifactregistry: [
    {
      ...
      items: [
        ...
        },
        {
          ...
          link: {
            type: 'doc',
            id: 'artifact-registry/lifecycle-rules/overview',
          },
          collapsed: true,
          items: [{ type: 'autogenerated', dirName: 'artifact-registry/lifecycle-rules' }],
        },
        {
          type: 'category',
          ...
          items: [
            {
              ...
              collapsed: false,
              items: [
                'ai-test-automation/suites/harness-ai-suites',
                'ai-test-automation/suites/playwright-builds',
              ],
            },
            'ai-test-automation/suites/setup-and-teardown',
          ],
        },
        {
          type: 'html',
  ...
  continuousdelivery: [
    {
      ...
      items: [
        ...
        },
        {
          ...
          collapsed: true,
          items: [
            { type: 'autogenerated', dirName: 'continuous-delivery/ai-agent-deployments' },
          ],
        },
        { type: 'html', value: 'Use GitOps', className: 'horizontal-bar' },
        { type: 'autogenerated', dirName: 'continuous-delivery/gitops' },
        { type: 'html', value: 'Use Harness CLI', className: 'horizontal-bar' },
        'continuous-delivery/cli-for-continuous-delivery',
        ...
        },
        {
          ...
          collapsed: true,
          items: [
            { type: 'autogenerated', dirName: 'continuous-delivery/armory' },
          ],
        },
        {
          type: 'link',
          ...
          items: [
            {
              ...
              collapsed: true,
              items: [
                { type: 'autogenerated', dirName: 'infra-as-code-management/iac-provisioners/opentofu' },
              ],
            },
            {
              type: 'category',
              ...
              collapsed: true,
              items: [
                { type: 'autogenerated', dirName: 'infra-as-code-management/iac-provisioners/cdk' },
              ],
            },
          ],
        },
  ...
  databasedevops: [
    // Database DevOps Landing Page
    {
      ...
      items: [
        ...
        "database-devops/get-started/onboarding-guide",
        {
          type: "html",
          value: 'Setup DB DevOps',
          className: "horizontal-bar",
        },
        "database-devops/get-started/get-started-with-changelogs",
        "database-devops/use-database-devops/provision-database-devops",
        {
          type: "category",
          label: "JDBC Connection String",
          collapsed: true,
          items: [
            "database-devops/use-database-devops/set-up-connectors",
            "database-devops/use-database-devops/set-up-db2-connector",
            "database-devops/get-started-bigtable",
          ],
        },
        {
          type: "html",
        ...
        {
          type: "category",
          label: "Changelogs & Schema changes",
          collapsed: false,
          items: [{
            type: "category",
            label: "Liquibase",
            items: [
              "database-devops/get-started/build-a-changelog",
              "database-devops/get-started/mongodb-changelog-generation",
              "database-devops/use-database-devops/schema-synchronization",
              "database-devops/features/subs-properties-in-changelogs",
              "database-devops/features/using-percona-for-mysql",
              "database-devops/concepts/mongodb-command"
            ],
          },
          {
            type: "category",
            label: "Flyway",
            items: [
              "database-devops/concepts/flyway-migrations-file-structure",
            ]
        }],  
      },
        {
          type: "category",
          label: "Create Database Updates",
          collapsed: true,
          items: [
            "database-devops/use-database-devops/configure-llm-for-database-devops",
            "database-devops/use-database-devops/diff-changelog",
          ],
        },
        {
          type: "category",
          label: "Deployment Pipeline Configuration",
          collapsed: true,
          items: [
            "database-devops/gitops/create-a-pipeline",
            {
              type: "category",
              label: "Step Types",
              collapsed: true,
              items: [
                "database-devops/use-database-devops/step-guide/apply-dbschema-step",
                "database-devops/use-database-devops/step-guide/rollback-dbschema-step",
                "database-devops/use-database-devops/step-guide/update-sql",
                "database-devops/use-database-devops/step-guide/rollback-sql",
                "database-devops/use-database-devops/step-guide/test-and-preview",
                {
                  type: "category",
                  label: "Liquibase Command Step",
                  collapsed: true,
                  items: [{ type: "autogenerated", dirName: "database-devops/use-database-devops/liquibase-command-step"}],
                },
                {
                  type: "category",
                  label: "Flyway Command Step",
                  collapsed: true,
                  items: [{ type: "autogenerated", dirName: "database-devops/use-database-devops/flyway-command-step"}],
                },
              ],
            },
            "database-devops/gitops/deploying-database-schema",
            "database-devops/gitops/deploying-database-application-together",
            "database-devops/use-database-devops/targets-with-artifactory",
            {
              type: "category",
              label: "Rollback & Failure Strategies",
              collapsed: true,
              items: [
                "database-devops/use-database-devops/rollback-for-database-schemas",
                "database-devops/use-database-devops/using-rollback-tags",
                "database-devops/features/automatic-and-custom-rollback",
                "database-devops/use-database-devops/failure-strategies",
                ],
            },
          ],
        },
        {
          type: "category",
          label: "Database Authentication & Security",
          collapsed: true,
          items: [
            "database-devops/features/keyless-authentication",
            "database-devops/features/oidc-authentication",
            "database-devops/features/kerberos-authentication",
            "database-devops/features/ssl",
            "database-devops/features/runtime-secrets"
          ],
        },
        {
          type: "category",
          label: "Structure Git Repository",
          collapsed: true,
          items: [
            "database-devops/gitops/gitops-in-dbops",
            "database-devops/gitops/trunk-based-development",
            "database-devops/gitops/environment-based-development",
            "database-devops/gitops/maintaining-database-schema"
          ],
        },
        {
          type: "category",
          ...
          collapsed: true,
          items: [{ type: "autogenerated", dirName: "database-devops/use-database-devops/governance"}],

        },
        {
          type: "category",
          label: "Understanding State of Database",
          collapsed: true,
          items: [
            "database-devops/concepts/deployment-architecture",
            "database-devops/features/unified-environment-overview",
            "database-devops/features/access-applied-changesets"
          ],
        },
        {
          type: "category",
          ...
          collapsed: true,
          items: [
            "database-devops/concepts/key-concepts",
            {
              type: "category", 
              label: "Glossary", 
              items: [{
                type: "autogenerated", dirName: "database-devops/concepts/glossary"
              }],
            }
          ],
        },
        ...
        },
        {
          ...
          collapsed: true,
                    items: [
            "database-devops/troubleshooting/troubleshooting",
            "database-devops/troubleshooting/dbschema-structure",
          ],
        },
      ],
    },
  ...
  cloudcostmanagement: [
    // Cloud & AI Cost Management Landing Page
    {
      ...
      items: [
        ...
        'cloud-cost-management/get-started/quickstart',
        'cloud-cost-management/get-started/navigating-cacm',
        {
          type: 'category',
          label: 'AI Cost Management',
          collapsed: true,
          items: [
            'cloud-cost-management/ai-cost-management/overview',
            'cloud-cost-management/ai-cost-management/quickstart',
          ],
        },
        {
          type: 'html',
        ...
        },
        {
          ...
          items: [
            ...
            'cloud-cost-management/provider-integrations/cloud-providers/azure',
          ],
        },
        'cloud-cost-management/provider-integrations/cloud-providers/kubernetes',
        'cloud-cost-management/provider-integrations/custom-cost-provider',
        {
          type: 'category',
          ...
          items: [
            'cloud-cost-management/sdk-integrations/harness-sdk',
            {
              ...
              collapsed: true,
              link: { type: 'generated-index', title: 'Open-source SDKs', description: 'Instrument LangChain, LlamaIndex, Google ADK, OpenAI Agents, LiteLLM, and Claude Code.' },
              items: [
                'cloud-cost-management/sdk-integrations/langchain',
                'cloud-cost-management/sdk-integrations/llamaindex',
                'cloud-cost-management/sdk-integrations/google-adk',
                'cloud-cost-management/sdk-integrations/openai-agents',
                'cloud-cost-management/sdk-integrations/litellm-proxy',
                'cloud-cost-management/sdk-integrations/claude-code',
              ],
            },
            'cloud-cost-management/sdk-integrations/manual-instrumentation',
          ],
        },
        {
          type: 'html',
        ...
        },
        {
          ...
          collapsed: true,
          items: [
            'cloud-cost-management/ai-cost-management/how-ai-traces-work',
            'cloud-cost-management/ai-cost-management/genai-span-attribute-reference',
            'cloud-cost-management/ai-cost-management/supported-providers-and-frameworks',
          ],
        },
        {
          type: 'category',
  ...
  softwaresupplychainassurance: [
    {
      ...
      items: [
        ...
        },
        {
          ...
          collapsed: true,
          items: [{ type: "autogenerated", dirName: "software-supply-chain-assurance/agents", }],
        },
        {
          type: "category",
  ...
  resiliencetesting: [
    {
      ...
      items: [
        ...
        "resilience-testing/chaos-testing/get-started",
        {
          ...
          link: {
            type: 'doc',
            id: 'resilience-testing/chaos-testing/infrastructure/index',
          },
          collapsed: true,
          items: [
            {
            ...
            },
            {
              ...
              link: {
                type: 'doc',
                id: 'resilience-testing/chaos-testing/infrastructure/kubernetes/index',
              },
              collapsed: true,
              items: [
                {
                ...
                'resilience-testing/chaos-testing/infrastructure/kubernetes/dedicated-delegate',
                'resilience-testing/chaos-testing/infrastructure/kubernetes/centralized-delegate',
                'resilience-testing/chaos-testing/infrastructure/kubernetes/infrastructure-settings',
                'resilience-testing/chaos-testing/infrastructure/kubernetes/openshift',
                'resilience-testing/chaos-testing/infrastructure/kubernetes/network-config',
                'resilience-testing/chaos-testing/infrastructure/kubernetes/permissions',
              ],
            },
            {
              type: 'category',
              ...
              link: {
                type: 'doc',
                id: 'resilience-testing/chaos-testing/infrastructure/linux/index',
              },
              collapsed: true,
              items: [
                {
                ...
                'resilience-testing/chaos-testing/infrastructure/linux/upgrade',
              ],
            },
            {
              type: 'category',
              ...
              link: {
                type: 'doc',
                id: 'resilience-testing/chaos-testing/infrastructure/windows/index',
              },
              collapsed: true,
              items: [
                {
                ...
                'resilience-testing/chaos-testing/infrastructure/windows/upgrade',
              ],
            },
          ],
        },
        ...
        "resilience-testing/chaos-testing/templates",
        {
          ...
          link: {
            type: 'doc',
            id: 'resilience-testing/chaos-testing/chaoshub',
          },
          collapsed: true,
          items: [
            {
            ...
            'resilience-testing/chaos-testing/chaoshub/enterprise-chaoshub',
            'resilience-testing/chaos-testing/chaoshub/manage-chaoshub',
          ],
        },
        ...
        'resilience-testing/access-control/rbac',
        {
          type: 'category',
          label: 'Governance',
          link: {
  ...
  chaosengineering: [
    {
      ...
      items: [
        ...
        "chaos-engineering/guides/probe",
        {
          type: 'category',
          label: 'Probe Templates',
          link: {
            type: 'generated-index',
          },
          collapsed: true,
          className: 'sidebar-hidden',
          items: [{ type: 'autogenerated', dirName: 'chaos-engineering/guides/probes/probe-templates' }],
        },
        {
          type: 'category',
          label: 'Actions',
          link: {
            type: 'doc',
            id: 'chaos-engineering/guides/actions/index',
          },
          collapsed: true,
          items: [
            'chaos-engineering/guides/actions/delay-action',
            'chaos-engineering/guides/actions/custom-script-action',
            'chaos-engineering/guides/actions/container-action',
          ],
        },
        {
          type: 'category',
          ...
          collapsed: true,
          className: 'sidebar-hidden',
          items: [{ type: 'autogenerated', dirName: 'chaos-engineering/guides/actions/action-templates' }],
        },
        ...
        'chaos-engineering/guides/terraform-onboarding',
  ...
  aisre: [
    {
      ...
      items: [
        ...
        },
        {
          ...
          collapsed: true,
          items: [{ type: 'autogenerated', dirName: 'ai-sre/get-started/onboarding' }],
        },
        {
          type: 'category',
  ...
  // clouddevelopmentenvironment sidebar hidden from navigation (HDH-542)
  // Pages remain accessible via direct URL e.g. /docs/cloud-development-environments
  ...
  softwareengineeringinsights: [
    {
      ...
      items: [
        {
          type: "html",
          value: "New to Software Engineering Insights?",
          className: "horizontal-bar",
        },
        'software-engineering-insights/propelo-sei/get-started/overview',
        'software-engineering-insights/propelo-sei/get-started/sei-key-concepts',
      {
        type: 'html',
    ...
    // University
    {
      ...
      href: '/university/sei',
      customProps: {
        description: 'Get certified and learn in Harness AI DLC Insights from our training programs.',
      },
    },
    // All Docs
    {
  ...
  selfmanagedenterpriseedition: [
    {
      ...
      items: [
        ...
        {
          type: 'category',
          label: 'SMP Installation/Upgrade',
          link: {
            type: 'generated-index',
          },
          collapsed: true,
          items: [
            {
              ...
              collapsed: true,
              items: [
                { type: 'autogenerated', dirName: 'self-managed-enterprise-edition/install' },
              ],
            },
            {
              type: 'category',
              ...
              collapsed: true,
              items: [
                { type: 'autogenerated', dirName: 'self-managed-enterprise-edition/smp-operator' },
              ],
            },
          ],
        },
  ...
  harnesssolutionsfactory: [
    {
      ...
      items: [
        ...
        'harness-solutions-factory/use-hsf/created-resources',
        {
          ...
          collapsed: true,
          items: [{ type: 'autogenerated', dirName: 'harness-solutions-factory/use-hsf/workflows' }],
        },
        'harness-solutions-factory/use-hsf/mini-factory-and-factory-floor',
        'harness-solutions-factory/use-hsf/hsf-hub',
        'harness-solutions-factory/use-hsf/ephemeral-workspaces',
        {
          type: 'category',
          ...
          collapsed: true,
          items: [{ type: 'autogenerated', dirName: 'harness-solutions-factory/use-hsf/configurations' }],
        },
        {
          type: 'category',
          label: 'Plugins',
        ...
        },
        {
          ...
          collapsed: true,
          items: [{ type: 'autogenerated', dirName: 'harness-solutions-factory/template-library' }],
        },
        {
          type: 'html',
          value: 'Troubleshooting & Resources',
