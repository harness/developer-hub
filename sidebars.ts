  ...
  infrastructureascodemanagement: [
    {
      ...
      items: [
        ...
        },
        {
          ...
          collapsed: true,
          items: [{ type: 'autogenerated', dirName: 'infra-as-code-management/configuration/connectors-variables' }],
        },
        {
          type: 'category',
          label: 'CLI Commands',
  ...
  harnesssolutionsfactory: [
    {
      ...
      items: [
        ...
        'harness-solutions-factory/new-to-hsf/hsf2-2',
        'harness-solutions-factory/new-to-hsf/hsf2-3',
        {
          type: 'html',
          value: 'Use HSF',
          className: 'horizontal-bar',
        ...
        // 'harness-solutions-factory/use-hsf/factory-floor',
        // 'harness-solutions-factory/use-hsf/mini-factory',
        {
          type: 'category',
