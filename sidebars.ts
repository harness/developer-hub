...
const sidebars: SidebarsConfig = {
  ...
  platform: [
    {
      ...
      items: [
        ...
        },
        {
          ...
          collapsed: true,
          items: [{ type: 'autogenerated', dirName: 'platform/knowledgebase' }],
        },
      ...
      items: [
        ...
        },
        {
          ...
          items: [
            {
              type: 'autogenerated',
              dirName: 'infra-as-code-management/registry/module-registry',
            },
          ],
        },
        ...
        {
          type: 'doc',
          id: 'infra-as-code-management/configuration/ansible',
          className: 'sidebar-item-new',
        },
        {
          type: 'category',
      ...
      items: [
        ...
        },
        {
        ...
        },
         {
          ...
          link: {
            type: 'generated-index',
            slug: '/category/appsec-agent',
          },
          collapsed: true,
          items: [
            { type: 'autogenerated', dirName: 'security-testing-orchestration/appsec-agent' },
          ],
        },
        {
          type: 'category',
  ...
  softwaresupplychainassurance: [
    ...
    },
    {
      ...
      link: {
        type: "generated-index",
        slug:"/category/appsec-agent-ssca",
      },
      collapsed: true,
      items: [ { type: "autogenerated", dirName: "software-supply-chain-assurance/appsec-agent", } ],
    },
    {
      type: "category",
  ...
  resiliencetesting: [
    {
      ...
      items: [
        ...
        "resilience-testing/chaos-testing/probes",
        {
          type: 'category',
  ...
  internaldeveloperportal: [
    {
      ...
      items: [
        ...
        {
          type: 'category',
          label: 'Harness IDP 2.0 Handbook',
          link: {
            type: 'generated-index',
          },
          collapsed: true,
  ...
  softwareengineeringinsights: [
    {
      ...
      },
      {
        ...
        items: [
          { 
            type: 'doc', 
            id: 'software-engineering-insights/harness-sei/analytics-and-reporting/efficiency',
            label: 'Efficiency Insights',
          },
          { 
            type: 'doc', 
            id: 'software-engineering-insights/harness-sei/analytics-and-reporting/productivity',
            label: 'Productivity Insights',
          },
          { 
            type: 'doc', 
            id: 'software-engineering-insights/harness-sei/analytics-and-reporting/ai',
            label: 'AI Insights',
            className: 'sidebar-item-beta',
          },
          { 
  ...
  harnesssolutionsfactory: [
    {
      ...
      items: [
        ...
        'harness-solutions-factory/use-hsf/plugins',
        {
          type: 'category',
        ...
        'harness-solutions-factory/changelog',
      ],
    },
    // Release Notes
    {
