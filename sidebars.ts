  ...
  cloudcostmanagement: [
    // Cloud Cost Management Landing Page
    {
      ...
      "cloud-cost-management/get-started/overview",
      {
        ...
        link: {
          type: "generated-index",
          slug: "/category/get-started-with-ccm",
        },
       collapsed: true,
  ...
  chaosengineering_new: [
    {
      ...
      items: [
        ...
        "chaos-engineering-new/overview",
        "chaos-engineering-new/whats-supported",
        "chaos-engineering-new/on-premise-vs-saas",
        "chaos-engineering-new/key-concepts",
        "chaos-engineering-new/quickstart",
        {
          type: "html",
        ...
        },
        {
          ...
          collapsed: true,
          items: [ { type: "autogenerated", dirName: "chaos-engineering-new/guides/chaos-experiments", } ],
        },
        "chaos-engineering-new/guides/application-maps",
        "chaos-engineering-new/guides/service-discovery",
        "chaos-engineering-new/guides/gamedays",
        "chaos-engineering-new/guides/image-registry",
        {
          type: "category",
          label: "ChaosHub",
          link: {
          ...
          collapsed: true,
          items: [ { type: "autogenerated", dirName: "chaos-engineering-new/guides/chaoshubs", } ],
        },
        {
          type: "category",
          ...
          collapsed: true,
          items: [ { type: "autogenerated", dirName: "chaos-engineering-new/guides/dashboards", } ],
        },
        {
          type: "category",
          label: "Governance",
          ...
          collapsed: true,
          items: [ { type: "autogenerated", dirName: "chaos-engineering-new/guides/governance", } ],
        },
        {
          type: "category",
          ...
          collapsed: true,
          items: [ { type: "autogenerated", dirName: "chaos-engineering-new/guides/infrastructures", } ],
        },
        {
          type: "category",
          label: "Probes",
          ...
          collapsed: true,
          items: [ { type: "autogenerated", dirName: "chaos-engineering-new/guides/probes", } ],
        },
        {
          type: "category",
          label: "Actions",
          ...
          collapsed: true,
          items: [ { type: "autogenerated", dirName: "chaos-engineering-new/guides/actions", } ],
        },
        {
          type: "category",
          ...
          collapsed: true,
          items: [ { type: "autogenerated", dirName: "chaos-engineering-new/guides/on-premises-smp", } ],
        },
        {
          type: "category",
          label: "AI",
          ...
          collapsed: true,
          items: [ { type: "autogenerated", dirName: "chaos-engineering-new/guides/ai", } ],
        },
        {
          type: "html",
        ...
        "chaos-engineering-new/faults/chaos-faults",
        {
          type: "category",
          ...
          items: [ { type: "autogenerated", dirName: "chaos-engineering-new/faults/chaos-faults", } ],
        },
        {
          type: "category",
          label: "Custom Faults",
          ...
          collapsed: true,
          items: [ { type: "autogenerated", dirName: "chaos-engineering-new/faults/custom-faults", } ],
        },
        {
          type: "html",
        ...
        },
        {
          ...
          collapsed: true,
          items: [ { type: "autogenerated", dirName: "chaos-engineering-new/integrations/cicd", } ],
        },
        {
          type: "category",
          ...
          collapsed: true,
          items: [ { type: "autogenerated", dirName: "chaos-engineering-new/integrations/performance-testing", } ],
        },
        {
          type: "category",
          ...
          collapsed: true,
          items: [ { type: "autogenerated", dirName: "chaos-engineering-new/integrations/monitoring", } ],
        },
        {
          type: "html",
        ...
        "chaos-engineering-new/security/index",
        "chaos-engineering-new/security/namespace-considerations",
        {
          type: "category",
          ...
          collapsed: true,
          items: [ { type: "autogenerated", dirName: "chaos-engineering-new/security/security-templates", } ],
        },
        {
          type: "html",
