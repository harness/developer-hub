      ...
      items: [
        ...
        */
        ...
        },
        {
          ...
          collapsed: true,
          items: [ 
            { type: "autogenerated", dirName: "feature-management-experimentation/80-integrations", }
          ],
        },
        {
          type: "category",
    ...
    // Service Reliability Management Page
    {
      ...
      items: [
        ...
        },
        {
          ...
          collapsed: true,
          items: [ { type: "autogenerated", dirName: "service-reliability-management/srm-dashboards", } ],
        },
        {
          type: "html",
          value: "Troubleshooting & Resources",
  ...
  internaldeveloperportal: [
    {
      ...
      items: [
        ...
        },
        {
          ...
          collapsed: true,
          items: [ { type: "autogenerated", dirName: "internal-developer-portal/environment-management", } ],
        },
        {
          type: "category",
          label: "TechDocs",
        ...
        },
        {
          ...
          collapsed: true,
          items: [ { type: "autogenerated", dirName: "internal-developer-portal/layout-and-appearance", } ],
        },
        {
          type: "category",
        ...
        {
          type: "html",
          value: '<span style="font-weight:1000; color:#6B7280;"> Troubleshooting & Resources </span>',
          className: "horizontal-bar",
        },
        {
          type: "category",
