  ...
  chaosengineering_new: [
    {
      ...
      items: [
        ...
        {
          type: "category",
          label: "Application Maps",
          link: {
            type: "generated-index",
          },
          collapsed: true,
          items: [ { type: "autogenerated", dirName: "chaos-engineering-new/guides/application-maps", } ],
        },
        {
          type: "category",
          label: "GameDays",
          ...
          collapsed: true,
          items: [ { type: "autogenerated", dirName: "chaos-engineering-new/guides/gamedays", } ],
        },
        {
          type: "category",
          label: "Probes & Actions",
          link: {
            type: "generated-index",
          },
          collapsed: true,
          items: [ { type: "autogenerated", dirName: "chaos-engineering-new/guides/probes-actions", } ],
        },
        {
          type: "category",
          label: "Pipelines",
        ...
        },
        {
          ...
          collapsed: true,
          items: [ { type: "autogenerated", dirName: "chaos-engineering-new/guides/custom-faults", } ],
        },
        "chaos-engineering-new/guides/ai-reliability-agent/index",
        {
          type: "html",
