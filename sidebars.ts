  ...
  chaosengineering_new: [
    {
      ...
      items: [
        ...
        "chaos-engineering-new/chaos-experiments",
        "chaos-engineering-new/application-maps",
        "chaos-engineering-new/gamedays",
        "chaos-engineering-new/probes-actions",
        "chaos-engineering-new/pipelines",
        {
          type: "category",
          ...
          collapsed: true,
          items: [ { type: "autogenerated", dirName: "chaos-engineering-new/on-premises-smp", } ],
        },
        {
          type: "category",
          label: "Custom Faults",
          ...
          collapsed: true,
          items: [ { type: "autogenerated", dirName: "chaos-engineering-new/custom-faults", } ],
        },
        {
          type: "html",
        ...
        },
        {
          ...
          collapsed: true,
          items: [ { type: "autogenerated", dirName: "chaos-engineering-new/security", } ],
        },
        {
          type: "html",
        ...
        },
        {
          ...
          collapsed: true,
          items: [ { type: "autogenerated", dirName: "chaos-engineering-new/faqs", } ],
        },
        {
          type: "category",
          label: "Troubleshooting",
          ...
          collapsed: true,
          items: [ { type: "autogenerated", dirName: "chaos-engineering-new/troubleshooting", } ],
        },
      ],
    },
    // Release Notes
