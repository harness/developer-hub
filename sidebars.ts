    ...
    // Feature Management & Experimentation
    {
      ...
      items: [
        ...
        */
        ...
        //"feature-management-experimentation/sdks-and-infrastructure/index",
        {
          type: "category",
          ...
          collapsed: true,
          items: [ { type: "autogenerated", dirName: "feature-management-experimentation/20-sdks-and-infrastructure/docs", } ],
        },
        //"feature-management-experimentation/http-api/index",
        {
          ...
          collapsed: true,
          items: [ { type: "autogenerated", dirName: "feature-management-experimentation/30-http-api/docs", } ],
        },
        ...
        //"feature-management-experimentation/feature-management/index",
        {
          type: "category",
          ...
          collapsed: true,
          items: [ { type: "autogenerated", dirName: "feature-management-experimentation/40-feature-management/docs", } ],
        },
        // "feature-management-experimentation/release-monitoring/index",
        // >> this will add all the md files from the given folder to this list level,
        // >> turning sub-folders into categories (without an index doc nor tiles)
        // { 
        //   type: "autogenerated", 
        ...
        // },
        {
          ...
          link: {
            // >> this will display the [index|readme|<foldername>].md file when the category is clicked
            type: 'doc', 
            id: 'feature-management-experimentation/release-monitoring/index',
            // >> this will create a folder with tiles (a tile for each md file)
            // type: "generated-index",
            // slug: "feature-management-experimentation/release-monitoring",
          },
          collapsed: true,
          items: [ { type: "autogenerated", dirName: "feature-management-experimentation/50-release-monitoring/docs", } ],
        },
        {
          type: "category",
          ...
          collapsed: true,
          items: [ { type: "autogenerated", dirName: "feature-management-experimentation/60-experimentation/docs", }
          ],
        },
        {
          type: "html",
        ...
        //"feature-management-experimentation/admin-account-settings/index",
        {
          type: "category",
          label: "Admin & account settings",
          link: {
            type: 'doc', 
            id: 'feature-management-experimentation/admin-account-settings/index',
          },
          collapsed: true,
          items: [ { type: "autogenerated", dirName: "feature-management-experimentation/70-admin-account-settings/docs", }
          ],
        },
        //"feature-management-experimentation/integrations/index",
        {
          type: "category",
          label: "Integrations",
          link: {
          ...
          collapsed: true,
          items: [ { type: "autogenerated", dirName: "feature-management-experimentation/80-integrations/docs", }
          ],
        },
