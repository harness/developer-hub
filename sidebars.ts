  ...
  continuousdelivery: [
    {
      ...
      collapsed: true,
      items: [
        { type: 'html', value: 'New to CD', className: 'horizontal-bar' },
        ...
        'continuous-delivery/cd-integrations',    // This should be the doc id, not file path
        'continuous-delivery/toolchain-policy',   // This too
