...
=======
      ...
      {
        type: "category",
        label: "Asset Governance - Option One",
        link: {
          type: "generated-index",
        },
       collapsed: true,
       items: [ { type: "autogenerated", dirName: "cloud-cost-management/5-use-ccm-cost-governance/asset-governance-new", } ],
      },
      {
        type: "category",
        label: "Asset Governance - Option Two",
        link: {
          type: "generated-index",
        },
       collapsed: true,
       items: [ { type: "autogenerated", dirName: "cloud-cost-management/5-use-ccm-cost-governance/asset-governance-option-two", } ],
      },
      {
        type: "category",
        label: "Anomalies",
        link: {
          type: "generated-index",
>>>>>>> 019d6936b1 (added some improvements)
        },
        {
          type: 'html',
