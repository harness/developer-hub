  ...
  selfmanagedenterpriseedition: [
    {
      ...
      {
        type: "category",
        label: "Helm Charts Configuration",
        link: {
          type: "generated-index",
        },
        collapsed: true,
        items: [ { type: "autogenerated", dirName: "self-managed-enterprise-edition/helm", } ],
      },
      "self-managed-enterprise-edition/smp-installer-with-eks",
      {
        type: "category",
        label: "Install",
        link: {
      ...
      },
      {
        ...
        "self-managed-enterprise-edition/monitor-harness-on-prem",
