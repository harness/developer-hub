  ...
  cloudcostmanagement: [
    // Cloud Cost Management Landing Page
    {
      ...
      },
      {
       ...
       collapsed: true,
       items: [ { type: "autogenerated", dirName: "cloud-cost-management/3-use-ccm-cost-reporting/1-ccm-perspectives" }, { type: "autogenerated", dirName: "cloud-cost-management/cost-reporting/perspectives", } ],
      },
      {
        type: "category",
        label: "BI Dashboards",
