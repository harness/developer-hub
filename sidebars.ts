  ...
  cloudcostmanagement: [
    // Cloud Cost Management Landing Page
    {
      ...
      //"cloud-cost-management/get-started/key-concepts",
      {
       ...
       collapsed: true,
       items: [ { type: "autogenerated", dirName: "cloud-cost-management/cost-reporting/root-cost-analysis", } ],
      },
      {
        type: "category",
        label: "Architecture",
      ...
      },
      {
       ...
       collapsed: true,
       items: [ { type: "autogenerated", dirName: "cloud-cost-management/cost-reporting/ccm-cost-categories", } ],
      },
      {
        type: "category",
       ...
       collapsed: true,
       items: [ { type: "autogenerated", dirName: "cloud-cost-management/cost-reporting", } ],
      },
      {
        type: "category",
       ...
       collapsed: true,
       items: [ { type: "autogenerated", dirName: "cloud-cost-management/cost-optimization", } ],
      },
      {
        type: "category",
        label: "Budgets",
       ...
       collapsed: true,
       items: [ { type: "autogenerated", dirName: "cloud-cost-management/cost-governance", } ],
      },
      {
        type: "category",
      ...
      "cloud-cost-management/product-behaviour",
      {
       ...
       collapsed: true,
       items: [ { type: "autogenerated", dirName: "cloud-cost-management/cost-optimization/autostopping-guides", } ],
      },
      {
        type: "category",
        label: "Self-Managed Enterprise Edition",
