...
### Version: v1.65.0 , Plugin Version: v0.65.0 

#### New Features and Enhancements

- Added support for [AI Bill of Materials (AIBOM)](/docs/software-supply-chain-assurance/open-source-management/generate-aibom-for-repositories), enabling visibility into AI-related components such as models, datasets, agents, libraries, and frameworks used within source repositories through structured AIBOM generation in CycloneDX format.

  <DocImage path={require('./static/scs/aibom-generation.png')} width="70%" height="70%" title="Click to view full size image" />

- Added support for [Resource Groups for Supply Chain Security](/docs/software-supply-chain-assurance/settings/rbac#create-a-new-resource-group), enabling administrators to manage access to SCS resources through configurable resource groups at the Account, Organization, and Project scopes.

  <DocImage path={require('./static/scs/resource-group-selection.png')} width="70%" height="70%" title="Click to view full size image" />

- Added support for [GitLab CI/CD integration](/docs/category/sbom-using-gitlab-cicd), enabling teams to integrate Harness SCS into GitLab workflows to generate and ingest SBOMs, enforce SBOM policies, generate and verify SLSA provenance, and sign and verify software artifacts.
