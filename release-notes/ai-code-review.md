...
<DocsButton icon = "fa-solid fa-square-rss" text="Subscribe via RSS" link="https://developer.harness.io/release-notes/ai-code-review/rss.xml" />

The release notes describe recent changes to Harness AI Code Review.
...
Beta release notes are added here once AI Code Review beta ships.
