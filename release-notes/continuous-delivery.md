...
* Previously, when configuring Datadog metrics for continuous verification, users were allowed to save the configuration without specifying a "Service Instance Identifier". (OIP-833)
