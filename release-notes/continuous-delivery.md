...
- Step group templates did not appear when selecting Use Template on an Approval stage. This issue is fixed. You can now create a step group template with Approval stage, and use them as step entities in the Approval stage. (CDS-96930, ZD-63556)
