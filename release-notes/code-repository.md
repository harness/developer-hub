...
* Added [Jira integration](/docs/code-repository/integrations/jira-integration) to enable visibility between your code repository and issue tracking workflows.
