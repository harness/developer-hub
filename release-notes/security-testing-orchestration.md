...
- The SonarQube integration includes better support for orchestrated branch and PR scanning with SonarQube Enterprise. (STO-7122, STO-6840, STO-6857, ZD-58021, ZD-55282, ZD-55592)
  - Previously, the orchestration scan step downloaded results for the main or master branch regardless of the branch specified in the runtime input (branch scans) or the pull request (pull-request builds).
  - With this enhancement, the orchestration step always downloads results for the scanned branch or scanned pull request.
  - Branch scans do not require any additional configuration.
  - For information about configuring pull-request scans, go to [SonarQube pull-request scan configuration](/docs/security-testing-orchestration/sto-techref-category/sonarqube-sonar-scanner-reference#sonarqube-pull-request-scan-configuration).
