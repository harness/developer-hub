...
- The SonarQube integration includes better support for orchestrated branch and PR scanning with SonarQube Enterprise. (STO-7122, STO-6840, STO-6857, ZD-58021, ZD-55282, ZD-55592)
  - Previously, the orchestration scan step downloaded results for the main or master branch regardless of the branch specified in the runtime input (manual builds) or the pull request (triggered builds).
