...
This release does not include any new features or enchancements.
...
Released .NET SDK 1.3.0
 - Private atributes have been marked for depreciation.
 - The percentage rollout hash has been updated to match Golang SDK.
 - The `netstandard2.0/net461` targets have been added.
 - The `Collection Was Modified` exception has been removed. 
...
Released Javascript SDK 1.20.0
