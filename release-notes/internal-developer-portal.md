...
- IDP now supports a URL allowlist. If the `catalog-info.yaml` from which you read API definitions is hosted on a provider other than your Git provider, add the URL to the allowlist. (IDP-648)
