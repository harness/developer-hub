...
<DocImage path={require('./static/ccm/release-1.63.3-tooltip.png')} width="100%" height="100%" title="Click to view full size image" />
...
<DocImage path={require('./static/ccm/release-1.63.3-report.png')} width="80%" height="80%" title="Click to view full size image" />
