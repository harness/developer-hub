...
* Fixed an issue with extra whitespace in step templates when these were used in a stage that used a Kubernetes cluster build infrastructure. (CI-9723, ZD-49843)
