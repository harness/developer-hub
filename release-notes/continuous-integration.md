...
- **Adjustable VM Pool initialization timeout for Windows deployments**

Virtual machines may have differing startup and initialization durations across operating systems, which can lead to timeout errors in VM Pools. You can now customize the VM initialization timeout in the CI Default Settings to ensure sufficient time to initialize.
