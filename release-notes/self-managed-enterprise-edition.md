...
- In [TI for Ruby](/docs/continuous-integration/use-ci/run-tests/test-v1/ti-for-ruby), test globs starting with `/` are correctly treated as absolute paths. (CI-11819, ZD-57661, ZD-61493)
