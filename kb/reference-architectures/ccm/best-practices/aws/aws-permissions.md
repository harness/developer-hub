...
When to enable: Master/Payer or any account which has a CUR you need to ingest
...
When to enable: Accounts where infrastructure is provisioned, usually every account except for the master/payer
...
When to enable: Master/Payer accounts
