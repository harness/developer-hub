...
### How to move environments and infrastructure from the Project level to the Organization level?
we do not have a built-in feature to move environments and infrastructure from the Project level to the Organization level. However, you can utilize the remote option to save these configurations in Git and import them wherever needed by adjusting the metadata.
