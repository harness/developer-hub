...
We don't have an exact period for when these upgrades occur, but we maintain a list of [Supported platforms and technologies](https://developer.harness.io/docs/platform/platform-whats-supported). You can customize the kubectl binary version using `INIT_SCRIPT`.
