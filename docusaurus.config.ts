  ...
  plugins: [
    ...
    [
      '@docusaurus/plugin-client-redirects',
      {
        redirects: [
          {
            from: '/docs/category/cluster-orchestrator-for-aws-eks-clusters-beta',
            to: '/docs/category/cluster-orchestrator-for-aws-eks-clusters',
          },
          {
            from: '/docs/category/aws-rds-beta',
