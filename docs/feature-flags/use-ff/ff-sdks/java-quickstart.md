...
redirect_from:
  ...
  - /docs/feature-flags/get-started/java-quickstart
---
...
:::info note
Once you have created your flag type, optionally you can [manage targets](/docs/feature-flags/use-ff/ff-target-management/add-targets) and modify the [variations](/docs/feature-flags/use-ff/ff-creating-flag/manage-variations), [rules](/docs/feature-flags/use-ff/ff-target-management/targeting-users-with-flags), and [add prerequisites](/docs/feature-flags/use-ff/ff-creating-flag/add-prerequisites-to-feature-flag) of your flag.
:::
...
* A Target is identified by a name and an identifier.
	...
	+ For more information about Targets, go to [Target Management](/docs/feature-flags/use-ff/ff-target-management/add-targets).
