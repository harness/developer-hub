...
:::info note
 For steps to set up your policies on the Harness Platform, go to [Use Harness Policy Engine for Feature Flags.](../../platform/Governance/14_Policy-as-code/using-harness-policy-engine-for-feature-flags.md)
:::
...
When you create the policy you can choose whether a Feature Flag receives only a warning message, or receives an error and can’t be saved when the policy isn’t met. For more information about how to do this, go to [Creating a Policy](../../platform/Governance/14_Policy-as-code/using-harness-policy-engine-for-feature-flags.md#step-1-create-a-policy).
...
To add policies for Feature Flags, go to [Use Harness Policy Engine for Feature Flags](../../platform/Governance/14_Policy-as-code/using-harness-policy-engine-for-feature-flags.md).
