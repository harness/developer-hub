...
```
Billing Admins can manage payments on the Harness Platform. To add a Billing Admin, use our [Role Based Access Control](../../platform/User-Management/3-add-users.md) and add the user with a role of **Billing Admin**.
