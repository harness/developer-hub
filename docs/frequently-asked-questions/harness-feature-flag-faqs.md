...
```
For more information, see [Java SDK reference](../../feature-flags/ff-sdks/server-sdks/integrate-feature-flag-with-java-sdk.md) and [Add targets](../../feature-flags/ff-using-flags/ff-target-management/add-targets.md).
