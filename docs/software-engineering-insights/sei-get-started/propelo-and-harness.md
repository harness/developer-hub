...
| Integrations | SEI connectors | Integrations that previously used **Ingestion Satellites** now use a [generic SEI connector](../sei-integrations/sei-connector-generic.md). |
