import filterSets from '@site/docs/software-engineering-insights/propelo-sei/setup-sei/sei-profiles/static/filter-sets.png';
import allocationGoals from '@site/docs/software-engineering-insights/propelo-sei/setup-sei/sei-profiles/static/allocation-goals.png';
import issueManagementSystem from '@site/docs/software-engineering-insights/propelo-sei/setup-sei/sei-profiles/static/ba-select-im.png';
import category from '@site/docs/software-engineering-insights/propelo-sei/setup-sei/sei-profiles/static/ba-new-category.png';
import scopeFetchingTickets from '@site/docs/software-engineering-insights/propelo-sei/setup-sei/sei-profiles/static/scope-fetching-tickets.png';
import scopeFetchingAdvanced from '@site/docs/software-engineering-insights/propelo-sei/setup-sei/sei-profiles/static/scope-fetch-tickets-advanced.png';
...
<img src={filterSets} alt="Filter Sets" width="1000" />
...
<img src={allocationGoals} alt="Allocation Goals" width="1000" />
...
<img src={issueManagementSystem} alt="Issue Management System" width="1000" />
...
* Select **+ New Category** under the **RANKED CATEGORIES** section.
  ...
  <img src={category} alt="New Category" width="1000" />
...
<img src={scopeFetchingTickets} alt="Scope of Fetching Tickets" width="1000" />
...
<img src={scopeFetchingAdvanced} alt="Advanced Options for Filter Sets" width="1000" />
