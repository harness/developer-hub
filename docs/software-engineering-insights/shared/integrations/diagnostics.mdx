import systemStatus from '@site/docs/software-engineering-insights/propelo-sei/setup-sei/static/system-status.png';
import satelliteStatus from '@site/docs/software-engineering-insights/propelo-sei/setup-sei/static/diagnostics-satellite-status.png';
import integrationStatus from '@site/docs/software-engineering-insights/propelo-sei/setup-sei/static/integration-status.png';
import jiraIntegration from '@site/docs/software-engineering-insights/propelo-sei/setup-sei/static/diagnostics-jira-integration.png';
import diagnosticsProjects from '@site/docs/software-engineering-insights/propelo-sei/setup-sei/static/diagnostics-projects.png';
import projectDetails from '@site/docs/software-engineering-insights/propelo-sei/setup-sei/static/diagnostics-project-details.png';
import diagnosticSprints from '@site/docs/software-engineering-insights/propelo-sei/setup-sei/static/diagnostics-sprints.png';
import sprintDetails from '@site/docs/software-engineering-insights/propelo-sei/setup-sei/static/diagnostics-sprint-details.png';
import scmIntegrations from '@site/docs/software-engineering-insights/propelo-sei/setup-sei/static/diagnostics-scm-integrations.png';
import scmRepos from '@site/docs/software-engineering-insights/propelo-sei/setup-sei/static/diagnostics-scm-repos.png';
import reposDetails from '@site/docs/software-engineering-insights/propelo-sei/setup-sei/static/diagnostics-repos-details.png';
import prDetails from '@site/docs/software-engineering-insights/propelo-sei/setup-sei/static/diagnostics-pr-details.png';
import runSpotCheck from '@site/docs/software-engineering-insights/propelo-sei/setup-sei/static/run-spot-check.png';
import spotCheckJira from '@site/docs/software-engineering-insights/propelo-sei/setup-sei/static/spot-check-jira.png';
import spotCheckPR from '@site/docs/software-engineering-insights/propelo-sei/setup-sei/static/spot-check-pr.png';
...
<img src={systemStatus} alt="System Status" width="1000" />
...
* **Solution**: Confirm the token validity and if the token has expired, update the integration configuration by re-authenticating with the third-party platform. Ensure the integration is configured with correct credentials.
...
<img src={integrationStatus} alt="Integration Status" width="1000" />
...
| NEEDS ATTENTION | Some failed ingestion jobs in the past week | Partial data loss may be occurring | Review [error logs](#ingestion-jobs) and recent changes |
...
<img src={jiraIntegration} alt="Jira Integration" width="1000" />
...
<img src={diagnosticsProjects} alt="Diagnostic Projects" width="1000" />
...
<img src={projectDetails} alt="Project Details" width="1000" />
...
<img src={diagnosticSprints} alt="Diagnostic Sprint" width="1000" />
...
<img src={sprintDetails} alt="Sprint Details" width="1000" />
...
<img src={scmIntegrations} alt="SCM Integrations" width="1000" />
...
<img src={scmRepos} alt="SCM Repositories" width="1000" />
...
<img src={reposDetails} alt="Repository Details" width="1000" />
...
<img src={prDetails} alt="PR Details" width="1000" />
...
<div style={{ display: 'flex', justifyContent: 'center', marginBottom: '1rem' }}>
  <img src={runSpotCheck} alt="Run Spot Check Overview" style={{ width: '48%' }} />
</div>

<div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
  <img src={spotCheckJira} alt="Spot Check Jira" style={{ width: '48%' }} />
  <img src={spotCheckPR} alt="Spot Check PR" style={{ width: '48%' }} />
</div>
