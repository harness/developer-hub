...
10. Click on **Download YAML File** and save the `satellite.yml` file. Update it by following the instructions [here](/docs/software-engineering-insights/propelo-sei/setup-sei/sei-ingestion-satellite/satellite-overview).
