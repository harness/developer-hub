...
To integrate with Gitlab Enterprise, use the [SEI Gitlab Enterprise integration](/docs/software-engineering-insights/sei-integrations/sei-integration-gitlab-enterprise).
