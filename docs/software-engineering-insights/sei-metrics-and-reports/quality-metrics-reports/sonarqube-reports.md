...
SonarQube is an open-source platform for continuous inspection of code quality. To analyze your SonarQube data in SEI, set up a [SonarQube SEI integration](../../sei-integrations/sei-integration-sonarqube.md), and then add SonarQube reports to your [Insights](../../sei-insights.md).
