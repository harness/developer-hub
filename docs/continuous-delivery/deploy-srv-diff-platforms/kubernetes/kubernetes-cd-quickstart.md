...
6. In **Delegates Setup**, click **Install new Delegate**. The Delegate wizard appears.
   ...
   [![](../../onboard-cd/cd-quickstarts/static/kubernetes-cd-quickstart-83.png)](../../onboard-cd/cd-quickstarts/static/kubernetes-cd-quickstart-83.png)

7. Click **Kubernetes**, and then click **Continue**.

   ![](../../onboard-cd/cd-quickstarts/static/kubernetes-cd-quickstart-85.png)
...
13. In the terminal connected to your cluster, run this command:
   ...
   ![](../../onboard-cd/cd-quickstarts/static/kubernetes-cd-quickstart-86.png)
...
Next, try Harness [Continuous Integration](../../onboard-cd/cd-quickstarts/docs/continuous-integration) to build a codebase, upload it to a repo, and run unit and integrations tests: [CI Pipeline Quickstart](../../../continuous-integration/ci-quickstarts/ci-pipeline-quickstart.md).
