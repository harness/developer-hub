...
You can enter the expression in subsequent steps such as the [Shell Script step](../../x-platform-cd-features/executions/cd-general-steps/using-shell-scripts.md) or [Approval](https://developer.harness.io/docs/category/approvals/) steps.
