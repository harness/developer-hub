...
7. In **Advanced** configure the following options.
   ...
   - **Failure Strategy** - Define the failure strategies to control the behavior of your pipeline when there is an error in execution. For more information, go to [failure strategy references](/docs/continuous-delivery/x-platform-cd-features/executions/step-failure-strategy-settings) and [define a failure strategy](/docs/continuous-delivery/x-platform-cd-features/executions/step-and-stage-failure-strategy).
     ...
     | **App Resize** | <table> <thead> <tr> <th>Error type</th> <th>**Rollback Stage**</th> <th>**Manual Intervention**</th> <th>**Ignore Failure**</th> <th>**Retry**</th> <th>**Mark As Success**</th> <th>**Abort**</th> <th>**Mark As Failure**</th> </tr> </thead> <tbody> <tr> <td>**Delegate Provisioning Errors**</td> <td>Support coming soon</td> <td>Rollback support required</td> <td>Rollback support required</td> <td>Rollback support required</td> <td>Rollback support required</td> <td>Rollback support required</td> <td>Rollback support required</td> </tr> <tr> <td>**Delegate Restart**</td> <td>Support coming soon</td> <td>Rollback support required</td> <td>Rollback support required</td> <td>Rollback support required</td> <td>Rollback support required</td> <td>Rollback support required</td> <td>Rollback support required</td> </tr> <tr> <td>**Timeout Errors**</td> <td>Support coming soon</td> <td>Rollback support required</td> <td>Rollback support required</td> <td>Rollback support required</td> <td>Rollback support required</td> <td>Rollback support required</td> <td>Rollback support required</td> </tr> <tr> <td>**Execution-time Inputs Timeout Errors**</td> <td>Support coming soon</td> <td>Rollback support required</td> <td>Rollback support required</td> <td>Rollback support required</td> <td>Rollback support required</td> <td>Rollback support required</td> <td>Rollback support required</td> </tr> </tbody> </table> |
