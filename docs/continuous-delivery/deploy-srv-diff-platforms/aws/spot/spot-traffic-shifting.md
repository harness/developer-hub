...
You can have multiple **AWS Load Balancer Configuration** based on your use-case and can choose if you want to use traffic shifting step for the ELB listener or not.
