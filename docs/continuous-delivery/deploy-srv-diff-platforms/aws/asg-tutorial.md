...
Currently, User Data is behind the feature flags `CDS_ASG_V2`, `CDS_BASIC_ASG`, `CD_NG_DYNAMIC_PROVISIONING_ENV_V2`. Contact [Harness Support](mailto:support@harness.io) to enable the feature.
...
Currently, **ASG Name**, **Same as already running Instances**, **Fixed**, and multiple load balancer support is behind the feature flags `CDS_ASG_V2`, `CDS_BASIC_ASG`, `CD_NG_DYNAMIC_PROVISIONING_ENV_V2`. Contact [Harness Support](mailto:support@harness.io) to enable the feature.
