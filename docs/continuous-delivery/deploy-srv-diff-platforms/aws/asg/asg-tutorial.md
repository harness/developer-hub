...
If deployment failure occurs, the stage or step [failure strategy](../../../../platform/8_Pipelines/define-a-failure-strategy-on-stages-and-steps.md) is initiated. Typically, this runs the Rolling Rollback step in the **Rollback** section of **Execution**.
...
If deployment failure occurs, the stage or step [failure strategy](../../../../platform/8_Pipelines/define-a-failure-strategy-on-stages-and-steps.md) is initiated. Typically, this runs the rollback steps in the **Rollback** section of **Execution**.
