...
For more info on stages, got to [Add a Stage](../../../platform/8_Pipelines/add-a-stage.md) and [CD Pipeline modeling overview](../../onboard-cd/cd-concepts/cd-pipeline-modeling-overview.md).
