...
1. Install a Harness Kubernetes Delegate in a cluster. For steps on installing a Delegate, go to [Install a delegate](/docs/platform/2_Delegates/install-delegates/install-a-delegate.md).
