...
* Select a Harness [secrets manager](/docs/platform/tecrets/tecrets-management/harness-secret-manager-overview) to use for encrypting/decrypting and saving the Terragrunt plan file.
