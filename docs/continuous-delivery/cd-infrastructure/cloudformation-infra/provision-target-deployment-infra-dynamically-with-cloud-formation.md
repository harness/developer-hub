...
1. Add or select the Harness [AWS Connector](../../../platform/7_Connectors/Cloud-Providers/references/aws-connector-settings-reference.md) that will be used for this step. The AWS Connector will include the credentials needed to perform the provisioning.
...
```
Ensure that the credentials include the `ec2:DescribeRegions` policy described in [AWS Connector](../../../platform/7_Connectors/Cloud-Providers/references/aws-connector-settings-reference.md).
...
Harness text secrets are supported. See [Add and Reference Text Secrets](../../../platform/6_Secrets/2-add-use-text-secrets.md).
