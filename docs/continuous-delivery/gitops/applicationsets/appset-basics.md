...
When upgrading between Argo CD versions, be aware of these important changes:

**Argo CD 2.10 to 2.14 Changes:**
...
When upgrading, always refer to the [official Argo CD upgrade documentation](https://argo-cd.readthedocs.io/en/latest/operator-manual/upgrading/overview/) for complete details.
:::
