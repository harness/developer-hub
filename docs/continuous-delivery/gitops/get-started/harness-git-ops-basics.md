...
Additionally, Harness offers a [Hosted GitOps](/docs/continuous-delivery/gitops/hosted-gitops/hosted-gitops) option that does not require you to deploy an Agent.
