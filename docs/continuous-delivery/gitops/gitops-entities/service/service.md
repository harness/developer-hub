...
|---|---|---|---|
| **Release Repo Manifest** | The config file that the PR pipeline should update (Kubernetes manifest, `kustomization.yaml`, or `values.yaml`) | [Update Release Repo](/docs/continuous-delivery/gitops/pr-pipelines/pr-pipelines-basics#update-release-repo) step | **Yes** - this is the primary manifest for GitOps services |
