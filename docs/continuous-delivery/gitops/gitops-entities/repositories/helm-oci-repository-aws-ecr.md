...
This topic assumes that you have already created an [OCI Helm repository](/docs/continuous-delivery/gitops/repositories/add-a-harness-git-ops-repository#add-a-repository).
