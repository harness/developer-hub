...
To create a cluster entity using IAM role in Amazon EKS, please refer to [Creating a GitOps Cluster with IAM role](/docs/continuous-delivery/gitops/create-cluster-with-iam.md).
