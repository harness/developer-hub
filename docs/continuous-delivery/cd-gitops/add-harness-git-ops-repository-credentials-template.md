...
A Harness GitOps Repository is used for Harness GitOps only. For other Harness features like CI, CD Pipelines, etc, use a standard [Git Connector](../../platform/7_Connectors/Code-Repositories/add-a-git-hub-connector.md).
...
6. In **Credentials**, select one of the following:
   * Specify Credentials for Repository
      ...
      - For steps on setting up the GitHub App, see [Use a GitHub App in a GitHub Connector](../../platform/7_Connectors/Code-Repositories/references/git-hub-app-support.md).
