...
redirect_from:
  - /docs/continuous-delivery/armory/general/github-issues-with-certificates-triggered-failure-to-be-able-to-execute-pipelines,-due-to-plugins-missing-unavailable
---
