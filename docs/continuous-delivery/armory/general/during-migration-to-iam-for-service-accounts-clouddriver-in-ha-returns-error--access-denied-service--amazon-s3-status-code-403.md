...
redirect_from:
  - /docs/continuous-delivery/armory/general/during-migration-to-iam-for-service-accounts,-clouddriver-in-ha-returns-error--access-denied-service--amazon-s3;-status-code-403
---
