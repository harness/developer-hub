...
redirect_from:
  - /docs/continuous-delivery/armory/general/killing-processes-where-parent-pipeline-triggered-a-large-infinite-loop-via-webhook,-keeps-triggering-child-pipelines
---
