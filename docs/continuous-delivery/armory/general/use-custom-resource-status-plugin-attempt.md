...
redirect_from:
  - /docs/continuous-delivery/armory/general/using-custom-resource-status-plugin-and-scale-agent-leads-to-an-attempt-was-made-to-call-a-method-that-does-not-exist-error
---
