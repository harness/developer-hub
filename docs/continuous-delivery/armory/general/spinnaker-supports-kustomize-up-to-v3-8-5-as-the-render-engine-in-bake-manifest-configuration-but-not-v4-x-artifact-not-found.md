...
redirect_from:
  - /docs/continuous-delivery/armory/general/spinnaker-supports-kustomize-up-to-v3.8.5-as-the-render-engine-in-bake-manifest-configuration,-but-not-v4.x-artifact-not-found
---
