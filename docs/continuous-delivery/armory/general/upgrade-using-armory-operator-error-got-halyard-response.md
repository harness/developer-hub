...
redirect_from:
  - /docs/continuous-delivery/armory/general/upgrade-using-armory-operator-is-not-working--got-halyard-response-status-405,-response--request-method-'post'-not-supported
---
