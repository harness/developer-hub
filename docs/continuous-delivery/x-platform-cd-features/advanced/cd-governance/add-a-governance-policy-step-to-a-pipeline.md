...
* If you are new to Harness Governance, see [Harness Governance overview](/docs/platform/policy-as-code/harness-governance-overview/) and [Harness Governance quickstart](/docs/platform/Policy-as-code/harness-governance-quickstart).
...
In this example, we'll use an existing policy set. For details on creating a policy set, see [Harness Governance quickstart](/docs/platform/Policy-as-code/harness-governance-quickstart).
...
New to policies and Policy Sets? See [Harness Governance quickstart](/docs/platform/Policy-as-code/harness-governance-quickstart).Let's look at an example of the Policy step.
