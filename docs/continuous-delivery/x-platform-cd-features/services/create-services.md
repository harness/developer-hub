...
If you are new to Harness, review [Harness key concepts](/docs/platform/get-started/key-concepts.md) and [create your first CD pipeline](/docs/continuous-delivery/get-started/cd-tutorials/manifest).
