...
4. In the **Manifest Details** dialog, enter a name for this manifest: CD\_Manifests.
...
7. Click **New**, select **New Folder**, enter a name for the folder (for example, Templates), and click **Save**.
8. With this new folder selected, click **New File**.
9. Enter the file name deployment.yaml, select **Manifest for File Usage**, and click **Create**.
   
   ![](./static/add-inline-manifests-using-file-store-11.png)
10. When Harness displays the blank deployment.yaml manifest, copy the contents of the sample deployment.yaml manifest, and paste it in the blank file. Click **Save**.
11. Create the namespace.yaml and service.yaml manifests by copying, pasting, and saving the manifests in File Store.
12. Click New, select **New Folder**, name the new folder (for example, Files) and click **Create**.
13. With the Templates folder selected, click **New** and select **New File**.
14. In **New File**, enter values.yaml as the manifest name, select **Manifest for File Usage**, and click **Create**.
15. When the blank values.yaml manifest appears, copy the contents of the values.yaml file, and paste it in the blank file. Click **Save**.
