...
We'll focus on **Artifacts** to demonstrate Custom Artifact, but you can find information on Manifests in [Kubernetes Services](../../cd-services/k8s-services/kubernetes-services.mdtes-services.md).
