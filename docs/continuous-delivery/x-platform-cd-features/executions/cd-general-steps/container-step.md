...
### Delegate selector
By default, the infrastructure connector delegate selector is considered for step execution unless overridden by a step, stage or pipeline level delegate selector.
