...
In some cases, you might want to use a [Harness text secret](/docs/platform/Security/add-use-text-secrets.md) in the **URL** setting. For example, `https://www.google.com/<+secrets.getValue("xyz")>`.
