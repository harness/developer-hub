...
For more information, go to [Connect to the Harness container image registry with a Docker connector](/docs/platform/connectors/artifact-repositories/connect-to-harness-container-image-registry-using-docker-connector/).
