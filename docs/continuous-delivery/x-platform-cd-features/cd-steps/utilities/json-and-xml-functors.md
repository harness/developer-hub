...
## General JSON and XML functors FAQs

### How do I use maps in Harness expressions?

You can convert map to JSON and use the `<+json.select()>` function to achieve this. 
...
Let's take an example that your secret value is json and you stored it as a secret in Harness. You should reference it with single quote like:
