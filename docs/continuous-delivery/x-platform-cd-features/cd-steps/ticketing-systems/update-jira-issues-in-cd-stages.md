...
Here are some important consideration when using an expression:
...
- Harness uses the **Jira Project** and **Issue Type** you in **Add Jira Fields** to fetch the list of fields. If you use a runtime expression for **Issye Key** and the Jira project and issue type you selected does not produce the issue key provided at runtime, your pipeline could fail to execute successfully. 
