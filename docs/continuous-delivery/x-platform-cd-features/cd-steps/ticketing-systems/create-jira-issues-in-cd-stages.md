...
For example, Harness supports [multi-select](https://support.atlassian.com/jira-cloud-administration/docs/custom-fields-types-in-company-managed-projects/#:~:text=Select%20[…]ultiple%20choices) fields to allow users to select multiple options from a drop-down list.
