...
* You must add a Harness [ServiceNow connector](/docs/platform/Connectors/connect-to-service-now) before or during the Create ServiceNow step setup.
...
5. In **ServiceNow Connector**, create or select the [ServiceNow connector](/docs/platform/Connectors/connect-to-service-now) to use.
