...
3. Select or create a Connector to this registry.
  ...
  For details on setting up each registry, go to [Connect to an Artifact Repo](../../../platform/7_Connectors/Artifact-Repositories/connect-to-an-artifact-repo.md).
...
5. In **Connector**, select or create an Azure Cloud Provider Connector that connects to your Application and Tenant Ids.
  ...
  For steps on setting up a new Azure Cloud Provider Connector, go to [Add a Microsoft Azure Cloud Connector](../../../platform/7_Connectors/Cloud-Providers/add-a-microsoft-azure-connector.md).
...
You can use [Harness secrets](../../../platform/6_Secrets/2-add-use-text-secrets.md) and Service or Workflow variables in the **Application settings** and **Connection strings** in the Harness Service.
