...
1. Click **Continue**.
2. In **Connect to the provider**, select **Connect through a Harness Delegate**, and then click **Continue**.
...
3. In **Delegates Setup**, click **Install new Delegate**. The Delegate wizard appears.
...
5. Enter a name for the Delegate, like **quickstart**, click the **Small** size.
6. Click **Continue**.
7. Click **Download YAML file**. The YAML file for the Kubernetes Delegate will download to your computer.
...
9.  In the same terminal, log into your Kubernetes cluster. In most platforms, you select the cluster, click **Connect**, and copy the access command.
    Next, install the Harness Delegate using the **harness-delegate.yaml** file you just downloaded.
10. In the terminal connected to your cluster, run this command:
