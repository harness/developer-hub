...
[Add Google Cloud Operations as a verification provider](https://docs.harness.io/article/g21fb5kfkg-connect-to-monitoring-and-logging-systems)
...
2. In **Select Feature**, select the feature to be used.
