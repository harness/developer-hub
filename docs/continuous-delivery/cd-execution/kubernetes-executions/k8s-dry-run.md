...
You can enter the expression is subsequent steps such as the [Shell Script step](../../cd-execution/cd-general-steps/using-shell-scripts.md) or [Approval](https://developer.harness.io/docs/category/approvals/) steps.
