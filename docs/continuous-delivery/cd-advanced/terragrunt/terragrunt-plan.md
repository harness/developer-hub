...
This topic describes how to run a Terragrunt plan using the Harness Terragrunt Plan step.

Typically, you run the Terragrunt Plan step to preview your Terragrunt provisioning. Next, you add a [Terragrunt Apply](terragrunt-apply.md) step to implement the plan. For more details, go to [Using Terragrunt steps together](#using-terragrunt-steps-together).
...
- **Apply**. Select this option if you will apply the plan with a subsequent [Terragrunt Apply](terragrunt-apply.md) step.
- **Destroy**. Select this option if you will destroy the plan with a subsequent [Terragrunt Destroy](terragrunt-destroy.md) step.
