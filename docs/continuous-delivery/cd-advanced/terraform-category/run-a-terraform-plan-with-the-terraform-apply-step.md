...
The name is very important. You can use the name in [expressions](https://docs.harness.io/article/lml71vhsim-harness-variables) to refer to settings in this step.
