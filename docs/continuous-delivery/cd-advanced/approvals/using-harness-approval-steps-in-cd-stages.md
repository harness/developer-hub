...
1. In **User Groups**, select the Harness User Groups that will approve the step. See [Add and Manage User Groups](../../../platform/3_User-Management/4-add-user-groups.md).
