...
* [Connect to Jira](../../../platform/5_Resources/Connectors/Ticketing-Systems/connect-to-jira.md)
...
5. In **Jira Connector**, create or select the [Jira Connector](../../../platform/5_Resources/Connectors/Ticketing-Systems/connect-to-jira.md) to use.
