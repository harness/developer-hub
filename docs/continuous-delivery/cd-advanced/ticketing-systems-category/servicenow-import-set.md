...
4. In **ServiceNow Connector**, select or create the [Harness ServiceNow Connector](../../../platform/5_Resources/Connectors/Ticketing-Systems/connect-to-service-now.md) to use.
