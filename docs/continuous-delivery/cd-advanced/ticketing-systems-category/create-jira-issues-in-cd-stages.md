...
* [Connect to Jira](../../../platform/7_Connectors/Ticketing-Systems/connect-to-jira.md): you can add a Harness Jira Connector before or during the Create Jira step setup.
...
In **Jira Connector**, create or select the [Jira Connector](../../../platform/7_Connectors/Ticketing-Systems/connect-to-jira.md) to use.
