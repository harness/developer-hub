...
![](../../../../release-notes/static/module_visibility.png)
...
![](../../../../release-notes/static/git-repository-pipe-22173.png)
...
![](../../../../release-notes/static/accurate_time_execution.png)
...
![](../../../../release-notes/static/health_source_connector.png)
...
![](../../../../release-notes/static/terminate-sync.png)
...
![](../../../../release-notes/static/approval1.png)

![](../../../../release-notes/static/approval.png)
...
- Triggers now map payload attributes with pipeline inputs.	(CDS-87039)
  ...
  - When a trigger is configured to use input sets, you can now pass input value overrides in the trigger's `inputYaml` field.
    ...
    <DocImage path={require('../../../../release-notes/static/78b4f649d9c4a9d0d858499e9508e846095f643d22b5f64dae60d6a30037b8cd.png')} width="60%" height="60%" title="Click to view full size image" />  
...
- You can now provide detailed feedback in the Harness AI chat in CD. (CDS-79769)
  ...
  <DocImage path={require('../../../../release-notes/static/73123e6efdd7d7dbc7c67b4a7df71bd42b1b20c8ba4cf409f87de0749da8dc92.png')} width="40%" height="40%" title="Click to view full size image" />
...
- The UI for running pipelines has been improved to better distinguish between a **Runtime Input** (which you specify in **Run Pipeline**) and an **Execution Time Input** (which you specify during the pipeline execution).
  ...
  - Many runtime inputs can be configured as execution time inputs. The **Pipeline Execution** UI also provides popover text with useful information about any required execution time inputs. (CDS-77710)
    ...
    ![](../../../../release-notes/static/cds-77710-set-runtime-input-as-execution-time-input.png)
...
- The Services Dashboard includes new support for Helm Chart deployments. (CDS-73310)
  ...
  - Tiles in the service overview (**Environments** tab) now show the Helm chart versions (if any) deployed in each environment.
    ...
    <DocImage path={require('../../../../release-notes/static/cds-73310-environments-and-groups-tiles-callouts.png')} width="40%" height="40%" title="Click to view full size image" />
  ...
  - The **Chart Versions** tab shows tiles for each Helm chart used to deploy the service (and a tile for any non-Helm deployments). Each tile shows the instances/artifact, environment, and latest time for each deployment.
    ...
    <DocImage path={require('../../../../release-notes/static/cds-77310-chart-tab-panels.png')} width="75%" height="75%" title="Click to view full size image" />
...
- Previously, the delegate selector was available in the Container step YAML only. This option is now available as an advanced option in the Container step UI. (CDS-78948, ZD-50674)
  ...
  ![](../../../../release-notes/static/cds-78948-delegate-selector-in-config-container-step-ui.png)
...
- Fixed an issue in the **Run Pipeline** UI when running chained pipelines. Previously, **Pipeline Variables** was in a new container, which implied that **Pipeline Variables** was a new stage. (CDS-74138)
  ...
  ![](../../../../release-notes/static/cds-74138-00-before.png)
  ...
  ![](../../../../release-notes/static/cds-74138-01-after.png)
...
- Added tooltip and banner to provide more information about webhook payloads. (CDS-53874)
  ...
  <DocImage path={require('../../../../release-notes/static/payload-input.png')} width="60%" height="60%" title="Click to view full size image" />
...
- Harness variables now have a **Required** setting. (CDS-69710)
  ...
  <DocImage path={require('../../../../release-notes/static/0bf162c7149b298e69fb52a15588e994357d3b0cf283c9146b6a0f0dac0deccd.png')} width="60%" height="60%" title="Click to view full size image" />

  When enabled, a variable with no value returns an error at pipeline runtime.

  <DocImage path={require('../../../../release-notes/static/153beccc9216340c35b3e2ca53ad81a35ec15e8b4621cd0402f0adc8372acc45.png')} width="60%" height="60%" title="Click to view full size image" />
...
- Select a Git branch when executing a pipeline that uses Git Experience. (CDS-68007, ZD-42205, ZD-42453)
  ...
  <DocImage path={require('../../../../release-notes/static/47ce888b8bd290e2d68db294eae373c08dc6185f1e66f6aad00b65f136dda1df.png')} width="60%" height="60%" title="Click to view full size image" />
...
- Scheduled automatic approvals have been added to manual approval steps. (CDS-69415)
  ...
  <DocImage path={require('../../../../release-notes/static/058d3e80cc8f95965e51010541d0c28f77865e484f8a84beea205b49172c658d.png')} width="60%" height="60%" title="Click to view full size image" />
...
- Edit Git details for pipelines stored using Harness Git Experience. (CDS-69130)
  ...
  <DocImage path={require('../../../../release-notes/static/d3ae175d36c932027045989f3c6d5b8b35ff3f50d7dec64195f1e1a264b4f577.png')} width="60%" height="60%" title="Click to view full size image" />

  <DocImage path={require('../../../../release-notes/static/87cae6dd20947c866629d225293d41ad83be7848061537e28efd2def8e14ea48.png')} width="60%" height="60%" title="Click to view full size image" />
...
- Step group templates can now be used in custom and deploy stages. (CDS-68210, ZD-43059)
  ...
  <DocImage path={require('../../../../release-notes/static/64a3aee31250b15c98b4978994ca1ff14e720b2d739c8feec72fdee12d6220a7.png')} width="60%" height="60%" title="Click to view full size image" />
...
- New default Git connector for Git Experience (CDS-66921)
  ...
  <DocImage path={require('../../../../release-notes/static/abb924b38a23ab57c26b3703d7c38e096eb60005625a6dfcd42793d503553a6e.png')} width="60%" height="60%" title="Click to view full size image" />
...
- Approval step notifications. (CDS-31886, ZD-43905)
  ...
  ![picture 87](../../../../release-notes/static/fa61423c00604c9a2d1dcf3cd2e8c040d71992791e34abf983eb5befe8640159.png)
...
- Selecting stages in Triggers was resetting to all stages in the YAML editor. (CDS-69725)
  ...
  ![picture 88](../../../../release-notes/static/ee0f296b5c9ed5249f409415b8a1dbb6b901ceed5e3b7118ee1ad40a6f93b77d.png)
...
- Deployment template connector variable expressions were not resolving. (CDS-68880)
  ...
  <DocImage path={require('../../../../release-notes/static/0e40fbf0db025ce3330a7b4e7352a8203acb51d5a06653b1b010a279e2f42cc5.png')} width="60%" height="60%" title="Click to view full size image" />
...
- When you run a pipeline, you can leave the pipeline, stage, service, and environment variable values empty in the **Run Pipeline** form. These fields are not validated in the UI any longer. (CDS-64656, ZD-43232)
  ...
  ![](../../../../release-notes/static/run-pipeline-form.png)
...
- You can set webhook triggers to run specific pipeline stages using the [Allow selective stage(s) executions?](/docs/platform/pipelines/run-specific-stage-in-pipeline/) option. (CDS-56775, CDS-56774)
  ...
  2. In **Stage Execution Settings>** **Allow selective stages(s) executions?**, select **Yes**. This setting is selected by default.
     ...
     ![](../../../../release-notes/static/selective-stage-execution.png)

  3. When you create a trigger, in **Configuration**, select the stages you want to execute.

     ![](../../../../release-notes/static/select-stage-to-execute.png)
...
- Repository format is now supported for Artifactory artifact source templates. (CDS-59092)
  ...
  <DocImage path={require('../../../../release-notes/static/61a6e0b480e05303bfc5926bec326c1555eff5ae087014c0b6a7e00a1fa94ec2.png')} width="60%" height="60%" title="Click to view full size image" />
...
- SHA support for Artifactory (CDS-58629), ECR (CDS-58304), GCR (CDS-56531), Nexus 3 Docker (CDS-56530), ACR (CDS-56529), Github Packages (CDS-41930)
  ...
  <DocImage path={require('../../../../release-notes/static/726cd79347c2dabba5bd47f2264f91b0b2618f872663c90048453719e87ff634.png')} width="60%" height="60%" title="Click to view full size image" />
...
- You can now use any path to [Helm charts within the Helm repository](/docs/continuous-delivery/deploy-srv-diff-platforms/helm/deploy-helm-charts). (CDS-57667, ZD-41758)
  ...
  <DocImage path={require('../../../../release-notes/static/70e9b1aa646408c07a6fef1ca8b6e0dfa2eef53e5f7eea3e88ac28b5a4d3e1c4.png')} width="60%" height="60%" title="Click to view full size image" />
...
- You can now see which deployment freeze failed a pipeline in the pipeline's execution history. (CDS-53781)
  ...
  <DocImage path={require('../../../../release-notes/static/eca1e7dd02fa705e9158c78f44ab49676270e4a477cc260e817c06da91bdf631.png')} width="60%" height="60%" title="Click to view full size image" />
...
- Bamboo is now supported in On Artifact triggers. (CDS-51742)
  ...
  <DocImage path={require('../../../../release-notes/static/d5512549a2cb085680c609e42aef000fec60a5dc8ac6f20ee48ec31282f6f61e.png')} width="30%" height="30%" title="Click to view full size image" />
...
- The [Shell Script step](/docs/continuous-delivery/x-platform-cd-features/cd-steps/utilities/shell-script-step) input and output variables are now optional. (CDS-57766, CDS-56448)
  ...
  ![picture 66](../../../../release-notes/static/ecc637c511be5850e704bf1db61db5cbda37d8a10ad37eb3490a05570a0b5ece.png)
...
- Tanzu Application Services (TAS) deployments now support additional artifact sources: Azure Artifacts, Bamboo, and GCS. (CDS-57681)
  ...
  ![picture 67](../../../../release-notes/static/162273825052b81df3a86e5b649c38bdcf12f9175bd60cb7db872d223c2635c5.png)
...
- The **Retry** timeout failure strategy is now supported in [TAS steps](/docs/continuous-delivery/deploy-srv-diff-platforms/tanzu/tanzu-app-services-quickstart) App Setup, App Resize, and Swap Routes. (CDS-55117)
  ...
  <DocImage path={require('../../../../release-notes/static/e467e7de04d6d257e1871fad7181b65a39b7712b68826b84b7c79d849b411f04.png')} width="60%" height="60%" title="Click to view full size image" />
...
- Helm Chart Version fetch is added to **Manifest Details** form. (CDS-53220)
  ...
  ![picture 72](../../../../release-notes/static/f01d849d1372a8d1c67dcd7532d2a3d58562fb72453328008eb617ae5df0b127.png)
...
- You can now trigger a pipeline when there are changes to an artifact in Bamboo. (CDS-51742)
  ...
  <DocImage path={require('../../../../release-notes/static/6a9869b8714c6ef7316fcdc98fd5bda65f0758f5ed84a4991c4d7f3007dc5372.png')} width="60%" height="60%" title="Click to view full size image" />

- ACR in Azure GovCloud is supported in the Docker Registry connector. (CDS-57777)

  You can now use `.io` and `.us` domains.

  ![picture 73](../../../../release-notes/static/40962ce702cb34f682116d48237a0b3a99d68d840ef0f6e39e4b260b79fba3dc.png)
...
- The Jenkins step was not exporting `GIT_SHA` variable as an output. (CDS-58256, ZD-42196)
  ...
  ![picture 70](../../../../release-notes/static/1b5a85ed162b70c2c13e84e1b2b5e19f1a6f1e5f4367168cd920100afde0a93a.png)
...
- The GitOps Clusters step was missing null checks. (CDS-58049)
  ...
  <DocImage path={require('../../../../release-notes/static/73cdc440ba09f067a25838780163b73f1afb34dc16e3fb4c625b6a84d0c295cf.png')} width="60%" height="60%" title="Click to view full size image" />
...
- Unclear error message in Triggers webhook registration. (CDS-53600)
  ...
  ![picture 75](../../../../release-notes/static/e5e13558c63d546b0e9a597695b9320efe86c6306d8a08fdb052abb7e7e07b7d.png)
...
- You can now select specific services and environments at an account or organization level when creating a deployment freeze window. (CDS-54222, CDS-53783)
  ...
  ![](../../../../release-notes/static/freeze-deployments-src-env.png)
...
- A **RouteMapping** step is enabled for [Tanzu Application Services (TAS) deployments](/docs/continuous-delivery/deploy-srv-diff-platforms/tanzu/tanzu-app-services-quickstart) to enable map and unmap routes. (CDS-50535)
  ...
  ![](../../../../release-notes/static/route-mapping-tas.png)
  ...
  ![](../../../../release-notes/static/route-mapping.png)
...
- You can now see what pipelines are using an Infrastructure Definition. (CDS-46777)
  ...
  ![](../../../../release-notes/static/referenced-by-tab.png)
...
- You can now view the ServiceNow Active Directory Federation Services (ADFS) and Jira Personal Access Token (PAT) in the **Credentials** section of the **Connectors** page. (CDS-55670)
  ...
  ![](../../../../release-notes/static/connector-credentials.png)
...
- Automatic suggestions did not appear for the expressions during infra provisioning in Pipeline Studio. (CDS-54266)
  ...
  ![](../../../../release-notes/static/auto-suggestion.png)
...
![update issue type](../../../../release-notes/static/e7593d80236125833f145babe470114b8fa5edb75633c507c20e176dd3c40ed2.png)
...
![Jira connector PAT](../../../../release-notes/static/5a617c9bac51ba7712f2cd2342446969c6bb8a5497a83ea7fba543cc75f50cd1.png)
...
- The **Resize Strategy** field in the **Canary App Setup** step of a [Tanzu Application Services (TAS, formerly PCF) deployment](/docs/continuous-delivery/deploy-srv-diff-platforms/tanzu/tanzu-app-services-quickstart) can be added as runtime input when using the canary deployment strategy. (CDS-53201)
  ...
  ![](../../../../release-notes/static/canary-app-set-up-resize.png)
...
- When selecting a **Custom Remote** source for a Helm chart, the Helm command **Pull**, **Fetch**, **Add**, and **Update** flags were shown. (CDS-53927)
  ...
  | Before                                                                                 | Now                                                                                   |
  | -------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------- |
  | ![before](../../../../release-notes/static/1a78090c877ce6e18edae5b79260ec1be819671a8214720724b04f1f734df665.png) | ![after](../../../../release-notes/static/20ec5c09ae229939a2dce0848fb741453f58750c60ecd1f291c1070b14ddb15e.png) |
...
- The Harness Approval step was not splitting expression values when commas were used. (CDS-53778)
  ...
  ![user groups](../../../../release-notes/static/271ffd42a5b4ee35db7b4e3697d51b76bff8a021bfa10bdd5f55343e47d172f5.png)
...
- Error messages for Kubernetes dry run failures needed improvement. (CDS-53379)
  ...
  ![error message](../../../../release-notes/static/3b844b27de9cd72be3fd0502931c388b2993c7e4089dc7376a3b34eddc8467f2.png)
...
- The **Manual Intervention** tab was not displayed for the ServiceNow Create or Update steps. (CDS-53467, CD-50877, ZD-38687)
  ...
  ![Manual Intervention tab](../../../../release-notes/static/aaff20d556d48292426c819a4e8542f31f202204a10fbf6c1b6b9fe4f8447831.png)
...
- The error message for unsupported connector types in the Kubernetes **Infrastructure Definition** was not clear. (CDS-53458)
  ...
  ![incorrect Harness connector type message](../../../../release-notes/static/f1c6d8873ddc32da338ba1f86ea630338a8567cfc41b37eda9a519945313cc84.png)
...
- The environment's **Service Overrides** were not operating additively. (CDS-53373)
  ...
  ![Service Overrides settings](../../../../release-notes/static/88805f0c3a1feca13b5437edbd6c7574e8f540a6e9ffe07f760a450546c93c41.png)
...
- The Tanzu Application Service (TAS) App Resize step needs to show a warning when configured with **Desired Instances Old Version** equal to `0`. (CDS-53361)
  ...
  ![App Resize](../../../../release-notes/static/5a007ce529293a42a9c99a485349039c18a802f4c9026858aab16b247e4e55f5.png)
...
- Invalid characters in [Shell Script step](/docs/continuous-delivery/x-platform-cd-features/cd-steps/utilities/shell-script-step/) output variables were allowed. (CDS-52946, ZD-39734)
  ...
  ![error message](../../../../release-notes/static/d6d28c0b22adf5712e98d0e121de846e652b66e7477245e32d1ce33a7559d18d.png)
...
- Prevent errors by making **Infrastructure Type** immutable. (CDS-52937)
  ...
  ![Infrastructure Definition](../../../../release-notes/static/6c79c55a410bdffab32baff365b512d2c90fcbcf6ee36a621326400f7c730098.png)
...
- Harness should not allow a minimum interval less than 5 minutes for [cron triggers](/docs/platform/triggers/schedule-pipelines-using-cron-triggers/). (CDS-50422)
  ...
  ![run every](../../../../release-notes/static/10779e92a0cbde217cc84ec52480ea75afb66c0d356aa509e4c941ba9407c503.png)
...
- Kubernetes Dry Run step added. (CDS-43839)
  ...
  ![Dry Run step](../../../../release-notes/static/bb64e94a2baf0858bbefe20ecede63ff1e4de692c15882c4f131df7e17c9906b.png)
...
- Improve the error message for when regex is used for the Artifactory connector. (CDS-48340)
  ...
  ![picture 44](../../../../release-notes/static/30462d87d71128c2d3b4026b5bdd69c83db1a9163d0321165f0eaeba145ead44.png)
...
- The stage template YAML should be validated if it has both `service` and `services` nodes together. (CDS-50122)
  ...
  ![picture 45](../../../../release-notes/static/7cd69654456b73a540ae1b63e20e18c8d7a4b3da2a477bee23a9ab54390935e4.png)
...
- Variable values are not visible in pipeline **Input** and **Output** tabs for the GitOps **Update Release Repo** and **Merge PR** steps. (CDS-50152)
  ...
  ![picture 46](../../../../release-notes/static/8e8505663a06ebf516784c0eb7316e5ca680a119515af7ae027259ec271df198.png)
...
- The warning message should be different when the pipeline executor is not allowed to approve/reject a pipeline. (CDS-50503)
  ...
  ![picture 47](../../../../release-notes/static/3eab70ec71e953d8d0d3401a3176bfb0b646489c306b54866fbcd3f9144db1fb.png)
...
- When an existing Azure Artifacts feed is updated to one that doesn’t contain any package type, the UI is not refreshing the **Package Type** field. (CDS-50708)
  ...
  ![picture 49](../../../../release-notes/static/470a4828ff0a95dc8bab6dddb746b2ae0156bffe8043a62afd752af8841cd398.png)
...
- The **Clear All** option in the filter on the **Deployments** page is not working for the **Deployment Type** option. (CDS-50924)
  ...
  ![Deployment Type](../../../../release-notes/static/adc95dc9af6b3beecc06149fc8045fd66f6ad514a37d2583addea35354643801.png)
...
- Deployed service logs don't show fetch details for a Jenkins artifact source. (CDS-51566)
  ...
  ![jenkins](../../../../release-notes/static/9fbfbbcac81b31e7fab75875393d7cb3e4369069f84750f18eb316543102f4ab.png)
...
- In the **Delegates Setup** section of a GitLab connector, the delegate selection radio buttons were not working. (CDS-51793)
  ...
  ![Delegates Setup](../../../../release-notes/static/98e09021f3650f11fd83635440cc761a74e480d0562a0150ab39715e19097bc5.png)
...
- Active Directory Federation Services (ADFS) is now supported for ServiceNow authentication. (CDS-49406, CDS-49229)
  ...
  ![ADFS](../../../../release-notes/static/9460e1a9c71864311b8a7d0ef1e1508bb6616649161bcf2cf932c9f4442a51d6.png)
...
- NPM/Maven/NuGet repository format support for Nexus artifacts with Tanzu Application Services (TAS). (CDS-50551)
  ...
  ![Nexus artifacts](../../../../release-notes/static/44009d0aa38851738ebed25ff3dabeb232bc729f904e219bb14d8cdd0178a283.png)
...
- Harness UI is no longer trying to populate the **Chart Version** setting for OCI Helm charts when using the AWS ECR repository. (CDS-49513)
  ...
  ![picture 35](../../../../release-notes/static/e26a39e9055f3202fb7158fcd65ab91805888cefa75124cbfcfe79ff6c9192ed.png)
...
- Improving validations for pipeline templates. (CDS-48962, ZD-38804, ZD-39478)
  ...
  ![48962](../../../../release-notes/static/5f0db5eded426ea187e51dc1a234bb10eee3257d817cb0ec272deb3f7dfac2c0.png)
...
- Users can no longer change **Deployment Type** for services. (CDS-48299)
  ...
  ![48299](../../../../release-notes/static/cd918d222ff863717a8307978f57deac90df4ada0544f193d9e51b55e91184c0.png)
...
- Users are able to select the **Loading** option when using the Azure Container Registry as an artifact source. (CDS-50599)
  ...
  ![Loading](../../../../release-notes/static/321f95d7ed33a9b49edcda9eea76ae8ecec352bce47c2da4050b7697a22ba560.png)
...
- Unable to see the Harness file store at the projects level. (CDS-50139)
  ...
  ![file store](../../../../release-notes/static/e6e71ed5ce6113726c8385b19408341220d153944a0683dbc76614e7a6aeed9d.png)
...
- Different artifacts with the same build Id are not considered in services listed in the **Environments** dashboard. (CDS-49189)
  ...
  | ------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------ |
  | ![picture 28](../../../../release-notes/static/12cf46c32d1fc632084fabb8de410303ad7f5cbc0217cbba5a8206174ed29ee4.png) | ![picture 29](../../../../release-notes/static/e6864f470d938ae81cec899bc895ddf5447de432ec024179233086e475066813.png) |
...
- The pipeline variable was not resolved in the **Image Path** setting for a Docker artifact source until the pipeline was saved. (CDS-48981)
  ...
  ![picture 43](../../../../release-notes/static/71120e82c81def7d301c5a40596ea3c31e1ed990e019c363a5dd6edaf155824d.png)
...
- Improved error message when API calls fail while listing Helm **Chart Version** in **Run Pipeline**. (CDS-48436)
  ...
  ![picture 21](../../../../release-notes/static/8ca12a2c84cf95499024fd11b11c055bc13ec9de4e0e767ae6f8422aeb596d91.png)
...
- Multiline message support for Jira Create and Update step Description settings. (CDS-49666)
  ...
  | Before                                                                                     | Now                                                                                        |
  | ------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------ |
  | ![picture 16](../../../../release-notes/static/28a372d797e51c4de68c37d72d4ba53e7f91598b56efcd699cd74c6e7f868ff0.png) | ![picture 20](../../../../release-notes/static/867064976ce3cc9fd0fb3bcfdfd11a0c1bc243b322f7d48a48dc0c3be56a3d20.png) |
...
- Nexus3 artifact source using the Maven **Repository Format** cannot filter the builds by **Classifier** and **Extension**. (CDS-49020)
  ...
  ![picture 30](../../../../release-notes/static/2c2c05135634045cec1c06d9a5b1f24da68d0bc3d9d4cee3de78fc4304074aba.png)
...
- Approval step Slack and email notifications using identifiers instead of names. (CDS-29134)
  ...
  ![picture 33](../../../../release-notes/static/fd00397b44a5d04ebd9d4c4e1c2a9493281147a26db13775759308d5e68ea511.png)

  Slack example:

  ![picture 34](../../../../release-notes/static/1bcafae790e255b341562a3e60ea2d937bfaac72605bf0eb41b789563540762e.png)
...
- A [failure strategy](/docs/platform/pipelines/failure-handling/define-a-failure-strategy-on-stages-and-steps) is now mandatory for all Deploy stages. (CDS-48951)
  ...
  ![failure strategy](../../../../release-notes/static/3c690f9ba44e7cac1e6ccb605068b676ddd02f247f37c2d9b2524f30437c97ff.png)
...
- Absolute paths for Native Helm charts [Custom Remote Manifest](/docs/continuous-delivery/deploy-srv-diff-platforms/kubernetes/cd-kubernetes-category/add-a-custom-remote-script-and-manifests) are now supported. (CDS-47647, RN-37501)
  ...
  ![Custom Remote Manifest](../../../../release-notes/static/b401a79386824c0b00a74ad4d9ec4576db712982f9371c8e80e0913d5e4aa14a.png)
...
- [Deployment freeze](/docs/continuous-delivery/manage-deployments/deployment-freeze) notification was not working for **Does not repeat** in **Recurrence**. (CDS-49667)
  ...
  ![Deployment freeze](../../../../release-notes/static/e804489bad159e4b70346eee0151a0b16f6e9a87f0257c9b1d2faaf6d2924d8c.png)
...
- Incorrect validation error message on the **Step Parameters** tab of the **Manual Approval** dialog. (CDS-49404)
  ...
  ![Manual Approval](../../../../release-notes/static/0ca0f627a25f82c07038f9430bc37c9f7660aac6f5beaea3883efc2fcbf61a2f.png)
...
- Unable to change the branch for a remote template in the template studio. (CDS-49159)
  ...
  ![remote template](../../../../release-notes/static/746afe2da521f0b80cae4fd566e7f251ea2caffedd3244216728d6e5259e838d.png)
...
- When a user configures a manifest detail and adds a file, they cannot delete that file. They can only move things around. (CDS-48591)
  ...
  ![valuesYAML](../../../../release-notes/static/8412e36bf2432c85520b4eb719a0f41636ded7a827e28f888c1df0ee0574d9db.png)
...
- The **Submit** button is disabled after creating a Github connector, but works fine when only selecting a connector. (CDS-48497)
  ...
  ![Continue](../../../../release-notes/static/c4dc3bbb40c46e0ffd5b15d3cb38c4efaad154d0ab0453aad3408fd41ff10aca.png)
...
- Artifactory with `tagRegex: <+input>` fails to fetch imagePath. (CDS-48438)
  ...
  ![tagRegex](../../../../release-notes/static/1dfac296e95a55c0a7c8ea9bc54c2996a9e82832fc9db90e0789e7a1ab94a423.png)
...
- Template always shows an unsaved changes message even after repeated save attempts. (CDS-48422)
  ...
  ![stage template](../../../../release-notes/static/ab0ebd2fe7e4f06d25a19ad1e62969c9a7ff6fafcf2ab753e732b155a0b7b6ce.png)
...
- Artifact source template: Tags does not have a **Configure** option. (CDS-48310)
  ...
  **Configure** option is not visible for the **Tags** setting. This issue has been fixed and you can see the **Configure** option.
  ...
  ![Configure](../../../../release-notes/static/785eb004b9b55e9bd72c9df586fdf9d4b41560dc749b4d15582b79980d5d18c4.png)
