...
description: Reference for the Shift AWS Agent Core Traffic step.
sidebar_position: 2
keywords:
  - shift aws agent core traffic
...
<div style={{textAlign: 'center'}}>
  <DocImage path={require('./static/step-shift-aws.png')} width="50%" height="50%" alt="Shift AWS Agent Core Traffic step parameters showing image, target revision ID, and weight" title="Click to view full size" />
</div>
