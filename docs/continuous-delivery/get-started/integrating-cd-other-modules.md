...
The [Harness Chaos Engineering (HCE) integration with Harness CD](/docs/chaos-engineering/integrations/hce-and-ce/chaos-cd) allows chaos experiments to be executed as part of a Harness CD pipeline.
