...
For more details, go to [Harness YAML Quickstart](/docs/platform/pipelines/harness-yaml-quickstart) and [YAML Reference: Pipelines](../../platform/8_Pipelines/w_pipeline-steps-reference/yaml-reference-cd-pipeline).
