...
Details documentation for creation of monitored service template is available [here](/docs/service-reliability-management/use-service-reliability-management/monitored-service-template/monitored-service-template-quickstart).
