...
There are other ways to set up a Monitored Service. Whichever way you choose, the process is the same. To learn more see: [Monitored Service](docs/platform/monitored-service.md)
