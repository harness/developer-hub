...
Harness will automatically add the **Verify** step. For example, here is a stage where Canary strategy and the **Enable Verification** option were selected.[![](../cd-execution/cv-category/static/verify-deployments-with-new-relic-00.png)](../cd-execution/cv-category/static/verify-deployments-with-new-relic-00.png)
* **Add the Verify step to an existing Execution setup:** You can also add the Verify step to the Execution section of a CD stage in a Pipeline you previously created. Simply click **Add Step** after the deployment step, and then select **Verify**.[![](../cd-execution/cv-category/static/verify-deployments-with-new-relic-02.png)](../cd-execution/cv-category/static/verify-deployments-with-new-relic-02.png)
...
![](../cd-execution/cv-category/static/verify-deployments-with-new-relic-04.png)
...
1. In **Health Sources**, click **Add**. The **Add New Health Source** settings appear.
   ...
   ![](../cd-execution/cv-category/static/verify-deployments-with-new-relic-05.png)
...
5. In **Connector** settings, you can either choose an existing connector or click **New Connector.**
    ...
    ![](../cd-execution/cv-category/static/verify-deployments-with-new-relic-06.png)
...
7. In **Select Feature**, select the NewRelic feature to be used.
    ...
    ![](../cd-execution/cv-category/static/verify-deployments-with-new-relic-07.png)
...
![](../cd-execution/cv-category/static/verify-deployments-with-new-relic-08.png)
