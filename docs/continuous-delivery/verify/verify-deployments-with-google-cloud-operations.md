...
Harness will automatically add the **Verify** step. For example, here is a stage where Canary strategy and the **Enable Verification** option were selected.[![](../cd-execution/cv-category/static/verify-deployments-with-google-cloud-operations-119.png)](../cd-execution/cv-category/static/verify-deployments-with-google-cloud-operations-119.png)
* **Add the Verify step to an existing Execution setup:** You can also add the Verify step to the Execution section of a CD stage in a Pipeline you previously created. Simply click **Add Step** after the deployment step, and then select **Verify**.[![](../cd-execution/cv-category/static/verify-deployments-with-google-cloud-operations-121.png)](../cd-execution/cv-category/static/verify-deployments-with-google-cloud-operations-121.png)
...
![](../cd-execution/cv-category/static/verify-deployments-with-google-cloud-operations-123.png)
...
1. In **Select health source type**, select Google Cloud Operations.
   ...
   ![](../cd-execution/cv-category/static/verify-deployments-with-google-cloud-operations-124.png)
...
4. In **Connector** settings, you can either choose an existing connector Gcp connector or click **New Connector.**
   ![](../cd-execution/cv-category/static/verify-deployments-with-google-cloud-operations-125.png)

5. Click **Apply Selected**. The Connector is added to the Health Source.
6. In **Select Feature**, select the feature to be used.

![](../cd-execution/cv-category/static/verify-deployments-with-google-cloud-operations-126.png)
...
2. Click one or more dashboards from the displayed results. If you don't have any preexisting dashboards or don't want to select the ones in the displayed result, click **Manually input query.**
   ![](../cd-execution/cv-category/static/verify-deployments-with-google-cloud-operations-127.png)
...
4. Select a query from the options displayed on the left side of setting panel. The specification of the selected query auto-populates in the fields under **Query Specifications**.
   ![](../cd-execution/cv-category/static/verify-deployments-with-google-cloud-operations-128.png)
...
![](../cd-execution/cv-category/static/verify-deployments-with-google-cloud-operations-129.png)
...
![](../cd-execution/cv-category/static/verify-deployments-with-google-cloud-operations-130.png)
...
![](../cd-execution/cv-category/static/verify-deployments-with-google-cloud-operations-131.png)
