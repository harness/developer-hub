...
| CDS_ENABLE_RAW_MODE | Enable this feature to configure Harness Pipelines to treat blank fields as empty strings during data preprocessing by setting the appropriate parameter in your pipeline configuration. To learn more, refer [Handling empty strings](/docs/platform/pipelines/input-data-preprocessing/) |