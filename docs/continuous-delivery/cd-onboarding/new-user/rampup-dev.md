...
For more information, go to [Using manual Harness approval stages](/docs/platform/approvals/adding-harness-approval-stages), and the [Approvals tutorial](https://developer.harness.io/docs/platform/approvals/approvals-tutorial), and [Notifications settings](/docs/platform/notifications/notifications-overview).
...
Harness integrates with Slack, Webhook, MS Teams, PagerDuty, and Emails. For more information, go to [Notifications settings](/docs/platform/notifications/notifications-overview).
