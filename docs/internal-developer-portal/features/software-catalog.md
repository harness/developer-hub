...
Start by generating a Harness API Key as described in [Add and manage API keys](/docs/platform/Resource-Development/APIs/add-and-manage-api-keys). Then, by using your Harness account ID and the API Key, you can make requests to the IDP catalog APIs as follows:
