...
This plugin exports a UI tab that you can use as a new tab for a service or for any other layout page. It also exports a UI card that you can add to the **Overview** section of a catalog layout. Go to **Configure** - **Layout**, select **Service** in the dropdown menu, and then add the following YAML code in a new section:
