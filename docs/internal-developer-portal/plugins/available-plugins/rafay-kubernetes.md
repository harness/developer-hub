...
This plugin exports new cards under overview tab for a service or for any other layout page. These are auto-ingested, and you can view them under **Configure** → **Layout**, select **Service** in the dropdown menu. 
