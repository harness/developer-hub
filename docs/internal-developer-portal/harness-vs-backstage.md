...
| Custom home page                                                       | Yes                        | Partial         | [Homepage Customizations](https://developer.harness.io/docs/internal-developer-portal/layout-and-appearance/home-page-customization)                                                                                                                                                                                                                                                                                                                                                      |
| Custom side bar                                                        | Yes                        | Yes             | [Sidebar Customizations](https://developer.harness.io/docs/internal-developer-portal/layout-and-appearance/sidenav)                                                                                                                                                                                                                                                                                                                                                                       |
...
Harness IDP Workflows extends the Backstage Scaffolder concept, retaining a familiar UI while leveraging [Harness Pipelines](https://developer.harness.io/docs/internal-developer-portal/flows/workflowyaml) as the backend. Use the [Entity Conversion API](https://apidocs.harness.io/tag/Entities#operation/convert-entity) to convert Backstage template YAMLs to Harness IDP Workflow YAMLs, enabling you to recreate and enhance your existing workflows.
