...
<RedirectIfStandalone label="IDP 1.0" targetPage="/docs/internal-developer-portal/flows/manage-workflow-2o" />
...
## Workflows in Software Catalog {#workflows-in-software-catalog}
...
### Unregister Workflow {#unregister-workflow}
