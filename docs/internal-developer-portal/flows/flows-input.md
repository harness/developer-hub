...
4. **Display Step**
   The step section includes a `debug:log` action to display the collected information based on the provided input.
...
There's a little of extra magic that you get out of the box when using the
