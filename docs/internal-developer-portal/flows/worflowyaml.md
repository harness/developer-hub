...
- The user does **not** need direct access to the underlying pipeline(s); however, the API key must have the necessary permissions.
...
Here, ```secretId``` refers to the identifier of the **Harness API Key**.
