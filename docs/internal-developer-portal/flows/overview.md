...
### [Get started with workflows](/docs/internal-developer-portal/get-started)
Ready to start using Workflows? Follow our [**Quickstart Guide**](/docs/internal-developer-portal/get-started) and **create your first Workflow** in just a few minutes.
...
### Understand workflow yaml](/docs/internal-developer-portal/flows/workflowyaml) 
...
Learn more about the [**Workflow YAML syntax**](/docs/internal-developer-portal/flows/workflowyaml).
...
- Learn how to build inputs with the [**CustomField component**](/docs/internal-developer-portal/flows/create-workflow/custom-field) for text, dropdown, button, and JSON fields.
...
For more details on what **Harness IDP** adds on top of Backstage software templates, refer to the **[docs here](/docs/internal-developer-portal/harness-vs-backstage.md)**. 
