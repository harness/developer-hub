...
|---------------|-------|----------------------|------------------------|
| **[Environment Blueprint](/docs/internal-developer-portal/environment-management/blueprints/env-blueprint-yaml)** | Account, Org, or Project Level | <ul><li>**VIEW**: View environment blueprints</li><li>**CREATE**: Create new blueprints</li><li>**EDIT**: Edit existing blueprints</li><li>**DELETE**: Delete environment blueprints</li></ul> | <ul><li>All Environment Blueprints</li><li>Specific Environment Blueprints</li></ul> |
| **[Environment](/docs/internal-developer-portal/environment-management/environments.md)** | Project Level | <ul><li>**VIEW**: View environments</li><li>**CREATE**: Create new environments</li><li>**EDIT**: Edit existing environments</li><li>**DELETE**: Delete environments</li></ul> | <ul><li>All Environments</li><li>Specific Environments</li></ul> |
