...
Every Catalog Layout is uniquely designed for a particular **Kind** and **Type** of application. For example, the most common catalog layout is for a microservice and is often represented as `Kind: Component` and `spec.type: service`. You can learn more about the [available kinds in the Catalog YAML docs](/docs/internal-developer-portal/catalog/catalog-yaml.md) and its [System Model](/docs/internal-developer-portal/catalog/data-model/data-model.md) to understand the different use-cases.
