...
sidebar_position: 2
sidebar_label: Catalog Ingestion API
keywords:
...
Entity Refs are case-insensitive. [Read More](/docs/internal-developer-portal/catalog/tutorials/entity-ref) on the Entity Reference. 
...
![](./catalog-ingestion/static/inspect-entity.png)

![](./catalog-ingestion/static/raw-yaml.png)
