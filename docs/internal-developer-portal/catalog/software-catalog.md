...
For information about how to register a software component, go to [register a new software component](/docs/internal-developer-portal/get-started). For YAML reference documentation, go to [the descriptor format](/docs/internal-developer-portal/tutorials/register-component-in-catalog#start-with-basic-entity-information).
