---
title: Use Catalog Ingestion API
...
sidebar_position: 7
sidebar_label: Use Catalog Ingestion API
redirect_from:
...
![](../integrate-tools/catalog-ingestion/static/create-check.gif)
...
![](../integrate-tools/catalog-ingestion/static/navigate-component.png)
...
Check out [other examples of the Catalog Ingestion API](/docs/internal-developer-portal/catalog/integrate-tools/catalog-ingestion-api).
