...
<RedirectIfStandalone label="IDP 2.0" targetPage="/docs/internal-developer-portal/catalog/data-model/data-model" />
...
Let us dive deeper into how entities and scopes come together in the Harness-native data model.
...
For more details on how to use this entity, refer to the [detailed docs](/docs/internal-developer-portal/catalog/catalog-yaml#kind-component).
...
For more details on how to use this entity, refer to the [detailed docs](/docs/internal-developer-portal/catalog/catalog-yaml#kind-api).
...
For more details on how to use this entity, refer to the [detailed docs](/docs/internal-developer-portal/catalog/catalog-yaml#kind-resource).
...
For more details on how to use this entity, refer to the [detailed docs](/docs/internal-developer-portal/flows/overview.md).
...
For more details on how to use this entity, refer to the [detailed docs](/docs/internal-developer-portal/catalog/data-model/system-entity.md).
...
Harness includes some [built-in user groups](/docs/platform/role-based-access-control/add-user-groups#built-in-user-groups), and you can [create user groups manually](/docs/platform/role-based-access-control/add-user-groups#create-user-groups-manually), through [inheritance](/docs/platform/role-based-access-control/add-user-groups#create-groups-by-inheritance), or via [automated provisioning](/docs/platform/role-based-access-control/add-user-groups#use-automated-provisioning). You can create user groups at all scopes.
...
With IDP 2.0, you can create resources at any scope: **Account**, **Org**, or **Project**. Here is how resources and scopes link together in IDP 2.0:
...
A relation involving an API entity, usually linked to a Component.
...
A relation involving an API entity, usually from a Component.
