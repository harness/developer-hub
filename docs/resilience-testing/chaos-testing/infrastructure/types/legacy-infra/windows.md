...
3. Any other status will be associated with logs which you can troubleshoot using our [troubleshooting guide](../../../../resources/troubleshooting)
...
1. Go to **Environments** and create a new environment (see Experiments documentation) or select an environment that already exists.
...
Go to [Upgrade Infrastructure for Windows](../../upgrade-infra#upgrade-windows-infrastructure) to upgrade to the latest version of your Windows infrastructure.
...
Harness CE allows you to create [HTTP](../../../probes) probe for Windows.