...
:::tip
To learn more about SCC, go to [SCC documentation](../../../../security/security-templates/openshift-scc).
:::

## Step 3: Get manifest to install chaos infrastructure

After [connecting to a chaos infrastructure](./kubernetes), select the installation mode (cluster scope or namespace scope).
