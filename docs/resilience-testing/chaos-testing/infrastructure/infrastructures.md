...
Go to [enable or disable an infrastructure](./types) and [upgrade it](./upgrade-infra) to get a hands-on experience.
...
Go to [flow of control](/docs/chaos-engineering/faults/chaos-faults/kubernetes#flow-of-control-in-kubernetes-based-faults) to understand the flow of control of Kubernetes faults.
