...
Your GKE Autopilot cluster is now ready for chaos engineering. To create and run your first experiment, follow the [Create Experiments](./experiments) guide and choose from any of the supported experiments listed below.
...
3. **Add Monitoring**: Configure [probes](./probes) to validate your application's resilience during experiments
