...
[Install a Harness Delegate or a dedicated chaos infrastructure](../../infrastructure) before creating a condition because a condition is applied to an infrastructure.
...
1. Instead of selecting the required parameters, you can generate conditions with the help of Harness AI. The AI assistant shows up when you are configuring a condition. You can choose one of the suggestions provided by Harness AI by clicking on it or writing something along the same lines as the suggestions.
