...
- **Kubernetes infrastructure:** A [Kubernetes Chaos Infrastructure](/docs/resilience-testing/chaos-testing/infrastructure/types/legacy-infra/kubernetes) (v1.85.3 or later) with load testing enabled. Load testing is enabled by default on Kubernetes infrastructure.
