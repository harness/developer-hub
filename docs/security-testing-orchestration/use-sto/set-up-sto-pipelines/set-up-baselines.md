...
Every target needs a baseline to enable the full suite of STO features. Here's why:
  ...
  - When your target has a baseline defined, the [Security Tests tab](/docs/security-testing-orchestration/view-security-test-results/view-scan-results) divides your issues into two lists:
