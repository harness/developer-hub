...
## When to add customer certificates to a pipeline for STO
...
## Important notes for adding customer certificates to a pipeline for STO
...
## Workflow for adding customer certificates to a pipeline for STO
...
### Example workflow for adding customer certificates to a pipeline for STO
...
### YAML pipeline example for adding customer certificates to a pipeline for STO
