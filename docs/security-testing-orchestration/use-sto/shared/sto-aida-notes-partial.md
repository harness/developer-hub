Before you can use Harness AIDA, you must do the following:
  ...
  2. Review the [End-User License Agreement](https://www.harness.io/legal/aida-terms). This is a legal agreement between you and Harness that governs your use of AIDA.
