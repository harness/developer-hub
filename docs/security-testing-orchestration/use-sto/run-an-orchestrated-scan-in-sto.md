...
In the following example workflow, you will clone the base pipeline created in [Set up Harness for STO](../onboard-sto/20-set-up-harness-for-sto.md) and configure it to scan a Docker image using Aqua Trivy.
