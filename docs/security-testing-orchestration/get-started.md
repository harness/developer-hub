...
redirect_from:
  ...
  - /docs/security-testing-orchestration/get-started/onboarding-guide
  - /docs/security-testing-orchestration/get-started/your-first-sto-pipeline
---

This guide helps you to use the Harness Security Testing Orchestration (STO) module to perform code security scanning in a Harness pipeline. You'll set up a pipeline with one scanner, run scans, analyze the results, and learn about the key features of STO.
...
- You need to have a [Security Testing Developer or AppSec role](/docs/security-testing-orchestration/rbac) assigned to your user profile.
- You also need a GitHub account and a [GitHub connector](/docs/platform/connectors/code-repositories/ref-source-repo-provider/git-hub-connector-settings-reference) in your project.
...
import add_stage from './get-started/static/your-first-pipeline/add-security-tests-stage.png'
...
Every STO scan has a specific [target name and variant](/docs/security-testing-orchestration/key-concepts/targets-and-baselines).
...
import set_up_harness_26 from './get-started/static/your-first-pipeline/configure-bandit-step.png'
...
2. Configure the step as follows:
   ...
   1. Scan Mode = **Orchestration**
      ...
      Indicates that this is an [orchestrated scan](/docs/security-testing-orchestration/key-concepts/sto-workflows-overview) that runs the scan and ingests the results in one step.
   ...
   3. Variant — Select **Runtime input** as the value type.
      ...
      Every STO scan has a [target variant](/docs/security-testing-orchestration/key-concepts/targets-and-baselines) that specifies the branch, tag, or other variant to scan.
...
![](./get-started/static/your-first-pipeline/sto-standalone-workflows-12.png)
...
import set_baseline from './get-started/static/your-first-pipeline/set-baseline.png'
...
![](./get-started/static/your-first-pipeline/sto-integrated-workflows-40-compare-results.png)
...
![](./get-started/static/your-first-pipeline/sto-standalone-workflows-15.png)
...
3. Examine the **Occurrences** list for this issue. (You might need to scroll down in the pane.) Here you can find additional details about each individual occurrence of the issue. Note that, to eliminate this vulnerability from the repo, you need to fix multiple occurrences:
   ...
   ![](./get-started/static/your-first-pipeline/sto-standalone-workflows-16-indiv-issue-details.png)
...
![](./get-started/static/your-first-pipeline/sto-integrated-workflows-10-snyk-with-remediation-steps.png)
...
3. Select **Apply Changes**, save the updated pipeline, and run the pipeline again with the **DEMO-001** branch.
   ...
   ![](./get-started/static/your-first-pipeline/failed-on-severity-critical.png)
...
import account_user_settings from './get-started/static/your-first-pipeline/go-to-account-user-settings.png'
import return_to_project from './get-started/static/your-first-pipeline/switch-from-account-to-project.png'
import confirm_appsec_role from './get-started/static/your-first-pipeline/confirm-appsec-role.png'
import request_exemption from './get-started/static/your-first-pipeline/request-exemption.png'
import request_exemption_details from './get-started/static/your-first-pipeline/request-exemption-details.png'
import approve_exemption_requests from './get-started/static/your-first-pipeline/approve-exemption-requests.png'
import exempted_button_in_security_tests from './get-started/static/your-first-pipeline/exempted-button-in-security-tests.png'
import cancel_exemption_requests from './get-started/static/your-first-pipeline/cancel-exemption-requests.png'
