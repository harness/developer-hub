...
* **Govern:** use governance policies and real-time security dashboards for ensuring critical security issues never make it to production. You can apply [Harness existing OPA policy governance](../../platfor/../platform/Governance/14_Policy-as-code/harness-governance-overview.md) to enforce your security testing practices.
