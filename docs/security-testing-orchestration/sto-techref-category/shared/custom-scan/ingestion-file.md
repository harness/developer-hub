This setting applies to Custom Scan steps when the `policy_type` is [`ingestionOnly`](/docs/security-testing-orchestration/key-concepts/ingest-scan-results-into-an-sto-pipeline).
