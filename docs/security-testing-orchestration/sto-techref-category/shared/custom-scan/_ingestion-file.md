This setting applies to Custom Scan steps when the `policy_type` is [`ingestionOnly`](/docs/security-testing-orchestration/orchestrate-and-ingest/ingest-scan-results-into-an-sto-pipeline).
