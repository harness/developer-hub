...
For a complete workflow description and example, go to [Run an Orchestration Scan in an STO Pipeline](/docs/security-testing-orchestration/key-concepts/run-an-orchestrated-scan-in-sto).
