...
The identifier for the [target](/docs/security-testing-orchestration/key-concepts/targets-and-baselines) such `jsmith/myalphaservice`. Descriptive target names make it much easier to navigate your scan data in the STO UI.
