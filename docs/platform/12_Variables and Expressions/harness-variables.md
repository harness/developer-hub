...
To run the step on all hosts, you use the Repeat [Looping Strategy](/article/eh4azj73m4-looping-strategies-matrix-repeat-and-parallelism) and identify all the hosts for the stage as the target:
