...
Make sure you have: 
* A Harness pipeline with a [CD stage](/docs/continuous-delivery/onboard-cd/cd-concepts/cd-pipeline-basics).
* A [Harness service with an artifact source](/docs/continuous-delivery/onboard-cd/cd-concepts/services-and-environments-overview).
