...
In **Git Connector**, select or create a Git Connector to the repo for your Project. For steps, see [Code Repo Connectors](../5_Resources/Connectors/Code-Repositories/connect-to-code-repo.md).
