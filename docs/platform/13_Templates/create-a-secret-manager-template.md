...
To access an SSH-based Custom Secrets Manager, create an SSH credential first. See [Add SSH Keys](../Secrets/4-add-use-ssh-secrets.md) for the procedure to create SSH credentials.  
