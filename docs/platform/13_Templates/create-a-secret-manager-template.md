...
* [Harness Secrets Management Overview](../7_Connectors/Secret-Managers/1-harness-secret-manager-overview.md)
...
To access an SSH-based Custom Secrets Manager, create an SSH credential first. See [Add SSH Keys](../6_Secrets/4-add-use-ssh-secrets.md) for the procedure to create SSH credentials.  
