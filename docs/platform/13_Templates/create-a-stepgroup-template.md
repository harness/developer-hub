...
### Create a remote template
  ...
  1. In **Git Connector**, select or create a Git Connector to the repo for your project.​ For more information, go to [Code Repo Connectors](../5_Resources/Connectors/Code-Repositories/connect-to-code-repo.md).
