...
* When you use templates in your pipelines, you cannot add, edit, or delete pipeline variables in the UI. You can edit the pipeline's YAML to modify pipeline variables.
