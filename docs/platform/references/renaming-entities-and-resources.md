...
For information on Organizations and Projects, see [Organizations and Projects Overview](/docs/platform/get-started/key-concepts#organizations-and-projects).For example, here are two GitHub Connectors with the same names and Ids but in different Harness Orgs:
...
* [Organizations and Projects Overview](/docs/platform/get-started/key-concepts#organizations-and-projects)
