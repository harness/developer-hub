...
3. In **Name**, enter a name for the SAML provider. Names are restricted to alphanumeric characters, `_`, `-`, `.`, and spaces.
4. If you want a friendly name to be displayed on the login screen, enter the name in **Friendly Name**. **Friendly Names** are restricted to alphanumeric characters, `_`, `-`, `.`, and spaces.
5. Select **Continue**.
