                  ...
                  infrastructure:  
                      ...
                      infrastructureDefinition:  
                          ...
                          spec:  
                              ...
                              releaseName: <+input>
```
In `infrastructureDefinition`, you can see that we are using a [Kubernetes Cluster Connector](../7_Connectors/Cloud-providers/add-a-kubernetes-cluster-connector.md) for a platform-agnostic direct connection to the target cluster.
