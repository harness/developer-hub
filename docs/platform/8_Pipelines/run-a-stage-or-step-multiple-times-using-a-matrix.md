...
* [CD Pipeline Basics](/docs/continuous-delivery/get-started/key-concepts) and [CI pipeline basics](../../continuous-integration/ci-quickstarts/ci-pipeline-basics.md)
