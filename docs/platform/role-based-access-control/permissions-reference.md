...
| Account Settings | Available at the account [scope](./rbac-in-harness.md#permissions-hierarchy-scopes) only.<br/><ul><li>View (`core_account_view`)</li><li>Edit (`core_account_edit`)</li></ul> | Active |
| Default Settings | <ul><li>Create/Edit (`core_setting_edit`)</li></ul> | Active |
