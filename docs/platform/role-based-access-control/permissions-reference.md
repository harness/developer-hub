...
| Service Accounts | <ul><li>View (`core_serviceaccount_view`)</li><li>Create/Edit (`core_serviceaccount_edit`)</li><li>Delete (`core_serviceaccount_delete`)</li><li>Manage: Create, edit, and delete API keys and tokens for service accounts (`core_serviceaccount_manageapikey`)</li></ul> | Active |
...
| Streaming Destination | Available at the account [scope](./rbac-in-harness.md#permissions-hierarchy-scopes) only.<br/><ul><li>View (`core_streamingDestination_view`)</li><li>Create/Edit (`core_streamingDestination_edit`)</li><li>Delete (`core_streamingDestination_delete`)</li></ul> | Active |
...
| Users | <ul><li>View (`core_user_view`)</li><li>Manage: Edit and delete users (`core_user_manager`)</li><li>Invite: Add users by inviting them to Harness (`core_user_invite`)</li></ul> | Active |
...
| Account | <ul><li>Edit (`core_account_edit`)</li><li>View (`core_account_view`)</li></ul> | Active |
| Audit | <ul><li>View (`core_audit_view`)</li></ul> | Active |
| Certificate | <ul><li>Delete (`core_certificate_delete`)</li><li>Edit (`core_certificate_edit`)</li><li>View (`core_certificate_view`)</li></ul> | Active |
| Deployment Freeze | <ul><li>Global (`core_deploymentfreeze_global`)</li><li>Manage (`core_deploymentfreeze_manage`)</li></ul> | Active |
| License | <ul><li>Edit (`core_license_edit`)</li><li>View (`core_license_view`)</li></ul> | Active |
| Service Account | <ul><li>List (`core_serviceaccount_list`)</li></ul> | Active |
| SMTP | <ul><li>Delete (`core_smtp_delete`)</li><li>Edit (`core_smtp_edit`)</li><li>View (`core_smtp_view`)</li></ul> | Active |
| User | <ul><li>Impersonate (`core_user_impersonate`)</li><li>Manage (`core_user_manage`)</li></ul> | Active |

## Artifact Registry

| Resource | Permissions | Status |
| --- | --- | --- |
| Art Registry | <ul><li>Delete: `artifact_artregistry_delete`</li><li>Delete Artifact: `artifact_artregistry_deleteartifact`</li><li>Download Artifact: `artifact_artregistry_downloadartifact`</li><li>Edit: `artifact_artregistry_edit`</li><li>Upload Artifact: `artifact_artregistry_uploadartifact`</li><li>View: `artifact_artregistry_view`</li></ul> | Active |
...
| Chaos Experiment | <li>Execute Pipeline (`chaos_chaosexperiment_executepipeline`)</li> | Active |
| Chaos Image Registry | <li>Edit (`chaos_chaosimageregistry_edit`)</li><li>View (`chaos_chaosimageregistry_view`)</li> | Active |
| Chaos Probe | <li>Delete (`chaos_chaosprobe_delete`)</li><li>Edit (`chaos_chaosprobe_edit`)</li><li>View (`chaos_chaosprobe_view`)</li> | Active |
| Chaos Security Governance | <li>Delete (`chaos_chaossecuritygovernance_delete`)</li><li>Edit (`chaos_chaossecuritygovernance_edit`)</li><li>View (`chaos_chaossecuritygovernance_view`)</li> | Active |
...
| Data Scope (CCM_DATA_SCOPE) | <ul><li>View (`ccm_dataScope_view`)</li></ul> | Active |
| Anomalies | <li>View (`ccm_anomalies_view`)</li> | Active |
| Cloud Asset Governance Enforcement | <li>Delete (`ccm_cloudAssetGovernanceEnforcement_delete`)</li><li>Edit (`ccm_cloudAssetGovernanceEnforcement_edit`)</li><li>View (`ccm_cloudAssetGovernanceEnforcement_view`)</li> | Active |
| Cloud Asset Governance Rule Set | <li>Delete (`ccm_cloudAssetGovernanceRuleSet_delete`)</li><li>Edit (`ccm_cloudAssetGovernanceRuleSet_edit`)</li><li>View (`ccm_cloudAssetGovernanceRuleSet_view`)</li> | Active |
| Cloud Asset Governance Rule | <li>Delete (`ccm_cloudAssetGovernanceRule_delete`)</li><li>Edit (`ccm_cloudAssetGovernanceRule_edit`)</li><li>Execute (`ccm_cloudAssetGovernanceRule_execute`)</li><li>View (`ccm_cloudAssetGovernanceRule_view`)</li> | Active |
| Commitment Orchestrator | <li>Edit (`ccm_commitmentOrchestrator_edit`)</li><li>View (`ccm_commitmentOrchestrator_view`)</li> | Active |
| Recommendations | <li>Manage (`ccm_recommendations_manage`)</li><li>View (`ccm_recommendations_view`)</li> | Active |

### Code Repository

| Resource | Permissions | Status |
| --- | --- | --- |
| Repository | <ul><li>Create (`code_repo_create`)</li><li>View (`code_repo_view`)</li><li>Create/Edit (Create repositories and edit repository settings, such as descriptions, webhooks, and rules) (`code_repo_edit`)</li><li>Delete (`code_repo_delete`)</li><li>Push (Repository contributor permissions, such as committing, pushing, creating/deleting branches, creating/deleting tags) (`code_repo_push`)</li><li>Report commit check : Report a Status Check Result on a Commit (`code_repo_reportCommitCheck`)</li><li>Review PR: Review Pull Requests in a Code Repository (`code_repo_review`)</li></ul> | Active |

### Feature Flags

| Resource | Permissions | Status |
| --- | --- | --- |
| Feature flags | <ul><li>Create (`ff_featureflag_create`)</li><li>View (`ff_featureflag_view`)</li><li>Toggle: Turn Feature Flags on/off (`ff_featureflag_toggle`)</li><li>Create/Edit Flag (`ff_featureflag_edit`)</li> <li>Edit Rule (`ff_featureflag_rulesEdit`)</li> <li>Edit Configuration (`ff_featureflag_configEdit`)</li><li>Delete (`ff_featureflag_delete`)</li></ul> | Active |
...
| Environment | <li>Edit (`ff_environment_edit`)</li><li>Target Group Edit (`ff_environment_targetGroupEdit`)</li><li>View (`ff_environment_view`)</li> | Active |
| Proxy API Key | <li>Create (`ff_proxyapikey_create`)</li><li>Delete (`ff_proxyapikey_delete`)</li><li>Edit (`ff_proxyapikey_edit`)</li><li>Rotate (`ff_proxyapikey_rotate`)</li><li>View (`ff_proxyapikey_view`)</li> | Active |
| Target | <li>View (`ff_target_view`)</li> | Active |
...
| Certificates | <ul><li>View GitOps Certificate (`gitops_cert_view`)</li><li>Create/Edit GitOps Certificate (`gitops_cert_edit`)</li><li>Delete GitOps Certificate(`gitops_cert_delete`)</li></ul> | Active |
...
| Registry | <li>Delete (`iac_registry_delete`)</li><li>Edit (`iac_registry_edit`)</li><li>View (`iac_registry_view`)</li> | Active |
...
| Resource | Permissions | Status |
| --- | --- | --- |
| Code Coverage | <ul><li>View (`sec_codecoverage_view`)</li></ul> | Active |
| Code Scan | <ul><li>View (`sec_codescan_view`)</li></ul> | Active |
| Coverage | <ul><li>View (`sec_coverage_view`)</li></ul> | Active |
...
| Catalog                 | <ul><li>Delete (`idp_catalog_delete`)</li><li>Edit (`idp_catalog_edit`)</li><li>View (`idp_catalog_view`)</li></ul> | Active |
| Workflow                | <ul><li>Delete (`idp_workflow_delete`)</li><li>Edit (`idp_workflow_edit`)</li><li>Execute (`idp_workflow_execute`)</li><li>View (`idp_workflow_view`)</li></ul> | Active |
