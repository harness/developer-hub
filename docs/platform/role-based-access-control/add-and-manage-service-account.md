...
For step-by-step instructions to add Roles and Resource Groups, see [Manage Roles](./add-manage-roles) and [Add and Manage Resource Groups](./add-resource-groups).
