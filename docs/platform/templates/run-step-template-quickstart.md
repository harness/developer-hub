...
To demonstrate how to create, configure, and use step templates, this topic adds a CD Run step template to a [CD pipeline](/docs/continuous-delivery/get-started/tutorials/cd-gitops-tutorials. You can also create templates for [CI Run steps](/docs/continuous-integration/use-ci/run-step-settings) or any other step type in Harness.
