...
* When you create a pipeline from a template, you cannot add, edit, or delete pipeline variables in the UI. You can edit the pipeline's YAML to modify pipeline variables.
