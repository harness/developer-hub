...
```
* [The restriction to only allow Harness Built-in Secret Manager](/release-notes/platform/#important-feature-change-notice) to be utilized in templates is to further tighten security and to allow you to be advised of self-referential loops within your secret logic.  
