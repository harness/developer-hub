...
* Windows users may encounter difficulties extracting `logs.zip` with the built-in extraction tool. To avoid this, we recommend using a third-party tool such as 7-Zip or similar.
