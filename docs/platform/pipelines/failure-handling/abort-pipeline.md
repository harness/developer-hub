...
In order to run the Abort operation on any of the levels listed below, you need to have the Abort permission on the Pipeline. This can be configured using [RBAC](docs/platform/role-based-access-control/rbac-in-harness/).
