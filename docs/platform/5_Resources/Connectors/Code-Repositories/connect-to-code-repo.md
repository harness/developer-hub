...
For more details on the settings to create this connector, see [Git Connector Settings Reference](../../../7_Connectors/ref-source-repo-provider/git-connector-settings-reference.md).
