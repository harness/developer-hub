...
:::note
For details on settings and permissions, see [Google Cloud Platform (GCP) Connector Settings Reference](../../../7_Connectors/ref-cloud-providers/gcs-connector-settings-reference.md).

:::

Google Cloud Metrics and Google Cloud Logs are supported with GCP connector. See [Add a GCP Connector](../../../7_Connectors/connect-to-a-cloud-provider.md#step-add-a-gcp-connector).
