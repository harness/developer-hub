...
You can use the GCP connector to connect to Kubernetes clusters in GCP. You can also use the [platform-agnostic Kubernetes Cluster connector](../../../7_Connectors/ref-cloud-providers/kubernetes-cluster-connector-settings-reference.md).
...
* **Assign IAM roles to the GCP service account or Harness delegate that you will attach to the connector.**
  ...
  * For a list of roles and policies, go to [Google Cloud Platform (GCP) Connector Settings Reference](../../../7_Connectors/ref-cloud-providers/gcs-connector-settings-reference.md).
...
2. Select **New Connector**, and then select **GCP** under **Cloud Providers**.
   ...
   ![](../../../7_Connectors/static/connect-to-google-cloud-platform-gcp-07.png)
...
* **See also:**
  * [Google Cloud Platform (GCP) Connector Settings Reference](../../../7_Connectors/ref-cloud-providers/gcs-connector-settings-reference.md)
...
For a list of roles and policies, go to the [Google Cloud Platform (GCP) Connector Settings Reference](../../../7_Connectors/ref-cloud-providers/gcs-connector-settings-reference.md).
