...
Use the Azure Repos connector to [connect to Azure SCM repos](../../../7_Connectors/connect-to-a-azure-repo.md)
...
If you connect to an ACR repo via the platform-agnostic [Docker Connector](../../../7_Connectors/ref-cloud-providers/docker-registry-connector-settings-reference.md), the limit is 100.
...
For more information, go to the **Deployments (CD)** section of the [Kubernetes cluster connector settings reference](../../../7_Connectors/ref-cloud-providers/kubernetes-cluster-connector-settings-reference.md).
