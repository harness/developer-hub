...
| artifact.source.registryUrl                                           | Dependents on the artifact source type. Check the output of the Service step.                                                                                                                                                                                    |
| artifact.source.repositoryName                                        | Dependents on the artifact source type. Check the output of the Service step.                                                                                                                                                                                                                |
