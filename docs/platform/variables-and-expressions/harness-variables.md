...
| artifact.source.registryUrl                                           | Dependents on artifact source type. Please check the output of service step.                                                                                                                                                                                    |
| artifact.source.repositoryName                                        | Dependents on artifact source type. Please check the output of service step.                                                                                                                                                                                                                |
