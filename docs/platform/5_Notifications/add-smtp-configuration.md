...
Configuring your SMTP server is required only if you are using [Harness Self-Managed Enterprise Edition](/docs/self-managed-enterprise-edition/introduction/getting-started), or if you wish to use your own SMTP server instead of the Harness SaaS default SMTP option.
