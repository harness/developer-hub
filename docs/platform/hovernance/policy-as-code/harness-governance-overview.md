...
:::note
Looking for the quickstart? See [Harness Policy As Code Quickstart](/docs/platform/hovernance/policy-as-code/harness-governance-quickstart).
...
![](../../hovernance/policy-as-code/static/harness-governance-overview-07.png)

For an example of how to use the policy editor, see [Harness Policy As Code Quickstart](/docs/platform/hovernance/policy-as-code/harness-governance-quickstart).
...
![](../../hovernance/policy-as-code/static/harness-governance-overview-08.png)
...
![](../../hovernance/policy-as-code/static/harness-governance-overview-09.png)
#### Testing Terminal
...
![](../../hovernance/policy-as-code/static/harness-governance-overview-10.png)
...
![](../../hovernance/policy-as-code/static/harness-governance-overview-11.png)
...
![](../../hovernance/policy-as-code/static/harness-governance-overview-12.png)
...
The Policy step in a Pipeline also enables evaluating policies during Pipeline execution. See [Add a Governance Policy Step to a Pipeline](/docs/platform/hovernance/policy-as-code/add-a-governance-policy-step-to-a-pipeline).
...
See [Use Harness Policy As Code for Feature Flags](/docs/platform/hovernance/policy-as-code/using-harness-policy-engine-for-feature-flags.md).

#### Custom

You can define a policy with the entity type Custom.

The Custom entity type provides flexibility to enforce policy evaluations against any input payload during Pipeline execution. This is done using the Policy step. See [Add a Governance Policy Step to a Pipeline](/docs/platform/hovernance/policy-as-code/add-a-governance-policy-step-to-a-pipeline).
...
![](../../hovernance/policy-as-code/static/harness-governance-overview-13.png)
