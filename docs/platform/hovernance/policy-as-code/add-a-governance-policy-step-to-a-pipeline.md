...
* **Account, Org, and** **Project-specific:** you can create the policy and apply it to all Pipelines in your Account, Org, and Project. The policy is evaluated on Pipeline-level events like On Run and On Save. Go to [Harness Governance Quickstart](/docs/platform/hovernance/policy-as-code/harness-governance-quickstart).
...
* If you are new to Harness Governance, go to [Harness Governance Overview](/docs/platform/hovernance/policy-as-code/harness-governance-overview) and [Harness Governance Quickstart](/docs/platform/hovernance/policy-as-code/harness-governance-quickstart).
...
![](../../hovernance/policy-as-code/static/add-a-governance-policy-step-to-a-pipeline-00.png)
...
In this example, we'll use an existing policy set. For details on creating a policy set, go to [Harness Governance Quickstart](/docs/platform/hovernance/policy-as-code/harness-governance-quickstart).

![](../../hovernance/policy-as-code/static/add-a-governance-policy-step-to-a-pipeline-01.png)
...
![](../../hovernance/policy-as-code/static/add-a-governance-policy-step-to-a-pipeline-02.png)

Also, select how you want the Pipeline to handle policy evaluation failures:

![](../../hovernance/policy-as-code/static/add-a-governance-policy-step-to-a-pipeline-03.png)
...
![](../../hovernance/policy-as-code/static/add-a-governance-policy-step-to-a-pipeline-04.png)
...
![](../../hovernance/policy-as-code/static/add-a-governance-policy-step-to-a-pipeline-05.png)
...
![](../../hovernance/policy-as-code/static/add-a-governance-policy-step-to-a-pipeline-06.png)  
