...
For more information, go to [Harness Policy As Code quickstart](/docs/platform/hovernance/Policy-as-code/harness-governance-quickstart).
...
For information about how to add a policy step to a stage, go to [Add a policy step to a pipeline](/docs/platform/hovernance/policy-as-code/add-a-governance-policy-step-to-a-pipeline).
