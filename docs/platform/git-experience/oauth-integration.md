...
For [GitLab](https://docs.gitlab.com/ee/integration/oauth_provider.html#adding-an-application), users need to ensure that their Vanity URL is added to the OAuth application's redirect URI list. Customers must provide their subdomain to have the Vanity URL whitelisted. Contact [Harness Support](mailto:support@harness.io) to complete this process.
