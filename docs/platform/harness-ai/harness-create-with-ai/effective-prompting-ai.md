...
description: Write effective prompts for Harness AI to generate pipelines, services, environments, and other resources.
keywords:
  - harness ai
  - prompting
  - natural language
...
tags:
  ...
  - Prompting
sidebar_position: 14
slug: /platform/harness-ai/harness-create-with-ai/effective-prompting-ai
redirect_from:
  - /docs/platform/harness-aida/effective-prompting-ai
  - /docs/platform/harness-ai/effective-prompting-ai
---
...
- [Understand why prompt specificity matters](#understand-why-prompt-specificity-matters).
- [Apply core prompting guidelines](#apply-core-prompting-guidelines) (action words, inputs, scope).
- [Write effective prompts for pipelines](#write-effective-prompts-for-pipelines), services, environments, secrets, connectors, templates, and cost perspectives.
- [Use advanced techniques](#use-advanced-techniques) (runtime inputs, deployment strategies, chaining stages, iterative refinement).
...
- **Harness account access**: Permissions to create resources (pipelines, services, environments, connectors, secrets) at the **Account**, **Organization**, or **Project** level. Go to <a href="/docs/platform/role-based-access-control/rbac-in-harness" target="_blank">RBAC in Harness</a> for more information on roles and permissions.
...
- **Provide inputs**: List parameters such as `IMAGE_TAG`, `REPLICA_COUNT`, or environment variables.
- **Focus on one resource**: Prompts that focus on a single resource are more reliable.
...
- **Use organizational terms**: If you already tag resources (for example, `env=dev`, `team=payments`), include these tags in your prompts.
- **Chain prompts**: Start broad and refine (for example, "Create cost perspective by team" → "Add filters for production-only workloads").
...
- <a href="/docs/platform/harness-ai/harness-create-with-ai/harness-ai-chat-guide" target="_blank">Harness AI Chat use cases</a>: Explore example prompts across DevOps, security, cost management, and reliability.
