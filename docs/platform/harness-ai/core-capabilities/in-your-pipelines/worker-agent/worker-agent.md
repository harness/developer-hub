...
- **Model Connector**: An Anthropic or OpenAI Model Connector configured with a default model. Go to <a href="/docs/platform/harness-ai/connect-with-ai/" target="_blank">Model Connectors</a> to review supported providers, models, and setup options.
