...
| **Code Repository** | <a href="/docs/platform/harness-ai/core-capabilities/in-code/code-search" target="_blank">Semantic Code Search</a> | Natural language code search that understands semantic meaning across your entire codebase. | Generally available |
