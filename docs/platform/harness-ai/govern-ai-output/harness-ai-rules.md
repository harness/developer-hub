...
- [How rules guide Harness AI output](#rule-behavior).
- [How Account, Organization, Project, and personal rules apply](#rule-scopes).
- [Which software development lifecycle (SDLC) areas rules can target](#rule-categories).
- [How to create, review, and enable rules](#create-a-rule).
- [How to write rules for pipelines, builds, security, cost, and code](#example-rule-set).
...
- **Harness AI access**: Harness AI must be active for your account. For more information on enabling Harness AI, see <a href="/docs/platform/harness-ai/overview#enable-ai" target="_blank">Overview of Harness AI</a>.
- **Policy context**: Rules guide AI output before save. For more information on enforcing Open Policy Agent (OPA) policies after a resource is saved or run, see <a href="/docs/platform/governance/policy-as-code/harness-governance-overview" target="_blank">Harness Policy As Code overview</a>.
...
Rule override controls are part of upcoming rule management capabilities. For more information, see [Manage rule access](#manage-rule-access).
...
<div style={{textAlign: 'center'}}>
   <DocImage path={require('./static/ai-settings-rules.png')} width="80%" height="40%" alt="Harness AI Settings Rules tab with rule level selector and New rule button" title="Click to view full size image" />
</div>
<p align="center"><em>Use the Rules tab to choose a scope and add a new rule.</em></p>

<div style={{textAlign: 'center'}}>
   <DocImage path={require('./static/ai-add-new-rule.png')} width="80%" height="40%" alt="Harness AI Add New Rule panel with rule level and rule content fields" title="Click to view full size image" />
</div>
...
- <a href="/docs/platform/harness-ai/harness-create-with-ai/effective-prompting-ai" target="_blank">Effective Prompting with Harness AI</a>: Write prompts that produce better output.
- <a href="/docs/platform/harness-ai/core-capabilities/in-harness-ui/devops-agent" target="_blank">Harness AI DevOps Agent</a>: Create and update pipelines with AI.
- <a href="/docs/platform/governance/policy-as-code/harness-governance-overview" target="_blank">Harness Policy As Code overview</a>: Enforce resource and pipeline policy gates.
