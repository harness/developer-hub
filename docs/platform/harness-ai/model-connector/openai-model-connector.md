...
The OpenAI Model Connector defines OpenAI as the LLM provider and default model for your <a href="/docs/platform/harness-ai/core-capabilities/in-your-pipelines/harness-agents" target="_blank">Worker Agents</a>.
