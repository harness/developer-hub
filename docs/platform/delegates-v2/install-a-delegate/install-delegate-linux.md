...
description: Learn how to install and configure Delegate 3.x on a Linux machine
sidebar_position: 2
slug: /platform/delegates-v3/install-a-delegate/install-delegate-linux
redirect_from:
    - /docs/platform/delegates-v2/install-a-delegate/install-delegate-linux
---
...
```bash
curl -L "https://app.harness.io/public/shared/delegates/3.5.0/delegate-linux-arm64" -o delegate
chmod +x delegate
```
...
```bash
curl -L "https://app.harness.io/public/shared/delegates/3.5.0/delegate-linux-amd64" -o delegate
chmod +x delegate
```
