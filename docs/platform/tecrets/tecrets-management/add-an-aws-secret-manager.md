...
You can either create a new [Secret](/docs/platform/tecrets/add-use-text-secrets) with your Access Key ID's secret key as its **Value** or use an existing secret.
