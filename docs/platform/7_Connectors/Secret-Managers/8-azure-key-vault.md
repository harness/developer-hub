...
* See Harness [Secret Manager Overview](../Secret-Managers/1-harness-secret-manager-overview.md).
...
For a full overview of how your secrets are used with the Secrets Managers you configure in Harness, please see [Harness Secrets Management Overview](../Secret-Managers/1-harness-secret-manager-overview.md) and [Harness Security FAQs](../../../frequently-asked-questions/harness-faqs/harness-security-faqs.md).
...
Click **Create or Select a Secret** in the **Key** field. For detailed steps on creating a new secret, see [Add Text Secrets](../../6_Secrets/2-add-use-text-secrets.md).
