...
In the secret settings dialog, you can create/select a [Secret](../../6_Secrets/2-add-use-text-secrets.md) and enter your AWS Access Key as it's value.
...
You can create a new [Secret](../../6_Secrets/2-add-use-text-secrets.md) with your Access Key ID's secret key as the **Secret Value**, or use an existing secret.

#### AWS ARN

Click **Create or Select a Secret**.

As explained above, you can create a new [Secret](../../6_Secrets/2-add-use-text-secrets.md) with your ARN as the **Secret Value**, or use an existing secret.
