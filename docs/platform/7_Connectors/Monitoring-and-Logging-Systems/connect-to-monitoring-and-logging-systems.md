...
5. In the **Credentials** tab, enter the following, and then select **Next**:
      ...
      -  The URL should look like: `https://stream.<realm>signalfx.com` or `https://api.<realm>.signalfx.com`
   See [Splunk Realms](https://dev.splunk.com/observability/docs/realms_in_endpoints/)
   
      - In **API Token**, select **Create or Select a Secret**.
      - We need a token generated by from Splunk Observability with Authorization scope API ![](../static/connect-to-monitoring-and-logging-systems-34.png)
...
11. After successful verification, select **Finish**.
    ...
    ![](../static/connect-to-monitoring-and-logging-systems-35.png)
