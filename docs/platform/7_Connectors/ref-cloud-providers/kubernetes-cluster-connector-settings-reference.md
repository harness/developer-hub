...
* Install a Harness Kubernetes Delegate in your EKS cluster.You must be logged in as an admin user you run the `kubectl apply -f harness-delegate.yaml` command.
