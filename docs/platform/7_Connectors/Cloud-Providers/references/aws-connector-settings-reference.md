...
If you want to connect Harness to Elastic Kubernetes Service (Amazon EKS), use the platform-agnostic [Kubernetes cluster connector](../references/kubernetes-cluster-connector-settings-reference.md).
