...
Also note, Harness does not yet support JSON secrets. For example, if you create a JSON secret like the one below defined in vault, we cannot refererence `/path/secret_key#my_key.password`.
