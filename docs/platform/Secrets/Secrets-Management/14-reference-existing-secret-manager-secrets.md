...
Also note that we do not yet support JSON secrets. For example if you a JSON secret like below defined in vault, we can not refer `/path/secret_key#my_key.password`
```
{
