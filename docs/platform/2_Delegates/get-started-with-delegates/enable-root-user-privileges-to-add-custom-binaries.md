...
For detailed information on the contents of Docker Delegate images, see [Support for Docker Delegate Images](/docs/platform/2_Delegates/get-started-with-delegates/support-for-delegate-docker-images.md).
