...
Harness captures delegate agent metrics for delegates of immutable image types. The delegate is instrumented for the collection of the following delegate agent metrics:
