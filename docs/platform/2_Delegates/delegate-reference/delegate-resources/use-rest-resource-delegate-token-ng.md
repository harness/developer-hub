...
Confirm the revocation of the delegate token by sending a second request to retrieve delegate tokens. For information on how to delete a delegate see [Delete a delegate](/docs/platrform/2_Delegates/delegate-guide/delete-a-delegate.md).
