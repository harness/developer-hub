...
- If you are using a self-hosted Git server, check if your server is able to make https requests to the Harness Git webhooks URL `https://app.harness.io/gateway/ng/api/webhook`.
