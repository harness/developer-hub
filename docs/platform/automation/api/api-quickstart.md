...
A Harness [project](/docs/platform/get-started/key-concepts.md#organizations-and-projects) is a group of Harness modules and their pipelines and other resources.
