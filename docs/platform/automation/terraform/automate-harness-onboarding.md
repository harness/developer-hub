...
In Harness, you can create an [environment](/docs/continuous-delivery/x-platform-cd-features/environments/environment-overview) at the project, organization, and account scope.
...
In Harness, you can create an [Infrastructure Definition](/docs/continuous-delivery/x-platform-cd-features/environments/environment-overview#infrastructure-definitions) at the project, organization and account scope.
