...
You can read more about the provider [here](https://registry.terraform.io/providers/harness/harness/latest/docs) or view our quick-start guide [here](/docs/platform/terraform/harness-terraform-provider/).
...
[Read more about environments on our developer hub](/docs/continuous-delivery/docs/continuous-delivery/get-started/services-and-environments-overview/)
...
[Read more about services on our developer hub](/docs/continuous-delivery/docs/continuous-delivery/get-started/services-and-environments-overview/)
