...
- Make sure you have an active API key and a corresponding token. For more information, go to [Add and manage API keys](/docs/platform/Resource-Development/APIs/add-and-manage-api-keys).
