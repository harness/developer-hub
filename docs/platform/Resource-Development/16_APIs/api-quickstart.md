...
You can also use service account tokens instead of PAT. For more information, go to [Add and Manage Service Accounts](/docs/platform/role-based-access-control/add-and-manage-service-account).
