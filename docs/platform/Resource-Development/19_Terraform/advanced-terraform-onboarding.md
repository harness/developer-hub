...
[Read more about k8s connectors on our developer hub](https://developer.harness.io/docs/platform/connectors/Cloud-Providers/add-a-kubernetes-cluster-connector/)
