...
description: Learn how to securely store delegate tokens as Kubernetes secrets instead of ConfigMaps for enhanced security.
sidebar_label: Delegate Tokens as Kubernetes Secrets
sidebar_position: 5
---
