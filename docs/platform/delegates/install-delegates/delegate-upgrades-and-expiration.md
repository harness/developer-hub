...
:::info
The automatic upgrade feature is enabled by default for the Kubernetes manifest and Helm installation options and disabled by default for Terraform. However, the automatic upgrade feature is not supported for the Docker installation option.
:::
