...
Delegates expire six months (24 weeks) after installation. Delegate expiration does not mean the delegate stops working. You may experience issues because the backend has moved too far ahead, and the delegate is no longer forward compatible. 
