...
### Override delegate image version
  ...
  #### Create a delegate override
    ...
    **API Parameters**
    ...
    | `tags`                 | No           | Delegate name or [Tag](/docs/platform/delegates/manage-delegates/select-delegates-with-selectors#delegate-tags) assigned when creating the delegate assigned | Used to update delegates with specific name or tags                     |
