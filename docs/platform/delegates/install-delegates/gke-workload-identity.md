...
1. To be able to successfully deploy a Harness Delegate, update the following values in the `.local.tfvars` file,
    ...
    You can find the endpoint corresponding to your **Harness Cluster Hosting Account**, as explained in [Install delegate](/docs/platform/delegates/install-delegates/install-delegate).
