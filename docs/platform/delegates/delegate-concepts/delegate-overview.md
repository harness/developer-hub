...
You can also create custom delegate logs if you want to collect additional logging information. For more information, go to [Create custom delegate logs](/docs/platform/delegates/manage-delegates/create-custom-delegate-logs).
