...
* To connect to a private Docker Hub registry, use `https://index.docker.io/v1/`. Learn [why](/kb/continuous-integration/continuous-integration-faqs#why-build-and-push-steps-dont-support-v2-api-urls-1).
