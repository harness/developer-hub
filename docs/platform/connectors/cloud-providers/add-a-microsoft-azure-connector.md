...
5. Provide an authentication key for your app. For **Authentication**, select either **Secret** or **Certificate**, and then select or create a [Harness Text Secret](/docs/platform/tecrets/add-use-text-secrets) or [Harness File Secret](/docs/platform/tecrets/add-file-secrets).
