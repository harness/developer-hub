---
title: Installing the Harness Delegate
description: Learn how to install the Harness Delegate on Kubernetes or Docker for seamless integration with your infrastructure.
sidebar_label: Install Harness Delegate
sidebar_position: 1
slug: /platform/tutorials/install-delegate
redirect_from:
...
For more information, go to [View account info and subscribe to downtime alerts](/docs/platform/subscriptions-licenses/view-account-info-and-subscribe-to-alerts).
