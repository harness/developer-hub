...
The majority of the documentation on the Harness Developer Hub (HDH) applies to Harness NextGen. FirstGen Docs will be removed from HDH April 2025.l other sections applies only to NextGen features.
