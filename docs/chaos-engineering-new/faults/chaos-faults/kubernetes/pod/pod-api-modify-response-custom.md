...
<tr>
      ...
      <tr>
        ...
        <td> These CA certificates must also be added to the target application's root certificate. For more information, go to <a href="/docs/chaos-engineering/use-harness-ce/chaos-faults/kubernetes/pod/pod-api-modify-response-custom#using-self-signed-certificates">CA certificates.</a></td>
        </tr>
     <tr>
        ...
        <td> The corresponding CA certificates should be loaded as root certificates inside the target application. For more information, go to <a href="/docs/chaos-engineering/use-harness-ce/chaos-faults/kubernetes/pod/pod-api-modify-response-custom#using-self-signed-certificates">server certificates.</a></td>
      </tr>
      <tr>
...
[embedmd]: # "./static/manifests/pod-api-modify-response-custom/target-service-port.yaml yaml"
...
[embedmd]: # "./static/manifests/pod-api-modify-response-custom/modify-response.yaml yaml"
      ...
      spec:
        components:
          env:
            ...
            - name: HEADERS_MAP
              value: '{"X-HCE-Test-Header": "X-HCE-Test-Value"}'
...
[embedmd]: # "./static/manifests/pod-api-modify-response-custom/path-filter.yaml yaml"
...
[embedmd]: # "./static/manifests/pod-api-modify-response-custom/destination-ports.yaml yaml"
...
[embedmd]:# (./static/manifests/pod-api-modify-response-custom/advanced-fault-tunables.yaml yaml)
```yaml
...
[embedmd]:# (./static/manifests/pod-api-modify-response-custom/advanced-filters.yaml yaml)
```yaml
# it injects the api modify header fault
apiVersion: litmuschaos.io/v1alpha1
kind: ChaosEngine
...
[embedmd]: # "./static/manifests/pod-api-modify-response-custom/container-runtime-and-socket-path.yaml yaml"
