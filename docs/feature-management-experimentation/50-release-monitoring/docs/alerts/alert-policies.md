...
To learn where to set up a metric alert policy in FME/Split UI go to [Create an alert policy](../alerts/automated-alerts-and-notifications/set-up-metric-alerting.md#create-an-alert-policy).
:::
