...
import baseline0 from '@site/docs/feature-management-experimentation/50-release-monitoring/docs/monitoring/view-metrics-impact/static/view-metric-results-baseline0.png';
