import createAlertPolicy from '@site/docs/feature-management-experimentation/release-monitoring/static/metrics/create-alert-policy.png';
import alertPolicy from '@site/docs/feature-management-experimentation/release-monitoring/static/metrics/create-new-policy.png';
import metricAlert from '@site/docs/feature-management-experimentation/release-monitoring/static/metrics/generate-results-button.png';
