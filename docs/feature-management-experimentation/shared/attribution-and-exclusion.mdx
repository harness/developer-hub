import attributeEvents from '@site/docs/feature-management-experimentation/release-monitoring/static/attribute-events.png';
import attributeEventsRules from '@site/docs/feature-management-experimentation/release-monitoring/static/attribute-event-rule.png';
