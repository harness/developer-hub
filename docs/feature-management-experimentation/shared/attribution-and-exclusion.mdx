import attributeEvents from '@site/docs/feature-management-experimentation/50-release-monitoring/static/attribute-events.png';
import attributeEventsRules from '@site/docs/feature-management-experimentation/50-release-monitoring/static/attribute-event-rule.png';
...
<img src={attributeEvents} width="1000" />
...
<img src={attributeEventsRules} width="1000" />
