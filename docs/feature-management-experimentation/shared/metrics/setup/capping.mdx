import metricCap from '@site/docs/feature-management-experimentation/release-monitoring/static/metrics/metric-cap.png';
...
All raw events, regardless of the cap, are received and logged by Harness FME in the **Data Hub**.
...
<img src={metricCap} alt="Metric Cap" width="600" />
