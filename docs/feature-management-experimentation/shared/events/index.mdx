...
For more information about sending event data to Harness FME, see the [Setup](/docs/feature-management-experimentation/50-release-monitoring/events/setup) documentation.
