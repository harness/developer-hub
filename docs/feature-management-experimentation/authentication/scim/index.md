...
If your organization is using Harness FME, authentication practices and the UI may differ. For more information, see [SCIM for Split Admins](/docs/feature-management-experimentation/split-to-harness/sso-for-admins#configure-scim) and [Account Migrated to Harness](/docs/feature-management-experimentation/split-to-harness/migrated-account#next-steps).
:::
