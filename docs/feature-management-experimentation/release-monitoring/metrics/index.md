...
For more information, see the [Metric Categorization](/docs/feature-management-experimentation/release-monitoring/metrics/categories/index.md) documentation.
