...
## Install the Harness FME VSCode extension

To install the Harness FME VSCode extension:
...
## Configure the VSCode extension in Harness FME

To connect Visual Studio Code to your Harness account:
...
1. Locate the Visual Studio Code integration and click **Add**.
1. Save the integration and navigate back to the newly created integration. The token displays. Copy the token to authenticate the extension.
1. Open your Visual Studio editor and download the [Split extension](https://marketplace.visualstudio.com/items?itemName=SplitSoftware.splitio).
1. Once you have the extension installed, click the **Split** icon in the sidebar. The **Authenticate** button appears along with a field to enter your Harness authentication token.
1. Enter the authentication token you copied in the field and click the **Authenticate** button.
1. Paste the token into the `Extension` field at the top of the VSCode extension. All your feature flags within your Harness projects now display within the extension.
...
### Switch between Harness FME projects
...
### Sort feature flags in your Harness FME project
