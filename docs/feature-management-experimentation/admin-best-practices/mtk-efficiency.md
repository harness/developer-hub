...
Harness FME tracks usage for our customers based upon what are called MTKs. MTK stands for **Monthly Tracked Keys**. For more information, see [Usage data](/docs/feature-management-experimentation/account-usage#usage-data). When counting anonymous users, the MTK count may be inflated due to any of the circumstances described below.
