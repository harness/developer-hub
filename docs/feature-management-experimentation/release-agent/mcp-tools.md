...
sidebar_position: 2
sidebar_label: Harness FME MCP Tools
---
...
To configure additional MCP-compatible AI tools like Windsurf, Cursor, or VS Code, see the [Harness MCP Server documentation](/docs/platform/harness-aida/harness-mcp-server/#configuration), which includes detailed setup instructions for all supported platforms.
