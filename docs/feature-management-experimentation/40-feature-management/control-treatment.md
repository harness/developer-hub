...
SemVer (Semantic Version) targeting rules are supported by FME SDKs and customer-deployed components. See [Target with custom attributes](/docs/feature-management-experimentation/feature-management/target-with-custom-attributes#supported-sdks-and-customer-deployed-components-for-semver-matcher) to see minimum FME SDK and customer-deployed component versions for SemVer support.
