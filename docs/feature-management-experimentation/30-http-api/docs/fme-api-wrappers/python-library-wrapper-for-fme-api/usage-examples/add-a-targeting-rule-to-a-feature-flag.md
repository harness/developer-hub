...
<p>
  <button hidden style={{borderRadius:'8px', border:'1px', fontFamily:'Courier New', fontWeight:'800', textAlign:'left'}}> help.split.io link: https://help.split.io/hc/en-us/articles/360030918611-Python-Admin-API-sample-Adding-targeting-rule-to-an-existing-feature-flag </button>
</p>
