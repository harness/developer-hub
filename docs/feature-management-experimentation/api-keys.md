...
2. Specifying a **scope** for the API key: This limits the reach of the API key across [environments](/docs/feature-management-experimentation/environments), a [project](/docs/feature-management-experimentation/projects), or the whole account.
