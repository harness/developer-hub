...
## Manual Exposures (Version <props.addedInVersion />+)
...
Added in version <props.addedInVersion />, you can now query your gates/experiments
without triggering an exposure as well as manually logging your exposures.
