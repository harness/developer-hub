...
description: Tutorial to set up release monitoring with FME
sidebar_label: Set up release monitoring
sidebar_position: 8
---
...
This tutorial walks you through setting up a Instant Feature Impact Detection (IFID). You will see how to measure key success metrics and recieve alerts for significant impact on these metrics from your feature variations.

This tutorial covers the steps to combine a progressive rollout with RUM measurements, and has a focus on alerting.
