...
A key is a [user ID](./user-ids.md) used for a feature flag evaluation. FME counts the number of unique user IDs you evaluate in a month. This number is called **Monthly Tracked Keys (MTKs)**.
