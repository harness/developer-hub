...
```bash title="Shell"
pip install 'splitio_client[cpphash]==10.6.0'
```
...
```bash title="Shell"
pip install 'splitio_client[cpphash,asyncio]==10.6.0'
```
...
```bash
pip install 'splitio_client[redis,cpphash]==10.6.0'
```
...
```bash
pip install 'splitio_client[redis,cpphash,asyncio]==10.6.0'
```
