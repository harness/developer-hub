...
splitClient.Treatment("test", "flag_name", attributes, splitClient.WithEvaluationOptions(&opts))
splitClient.Treatments("test", []string{"flag_name1", "flag_name2"}, attributes, splitClient.WithEvaluationOptions(&opts))
```
