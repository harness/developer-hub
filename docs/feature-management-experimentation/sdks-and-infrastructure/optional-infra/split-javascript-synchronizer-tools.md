...
<!-- Split JavaScript sync tools library -->
...
Unlike the [Split Go Synchronizer](/docs/feature-management-experimentation/sdks-and-infrastructure/optional-infra/split-synchronizer), the JavaScript Synchronizer executes as an script in a compatible JavaScript runtime environment like Node.js.
