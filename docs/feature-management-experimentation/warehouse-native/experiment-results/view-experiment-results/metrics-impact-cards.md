...
Your metrics cards show different states depending on your user selections, the traffic distribution, the data available, and whether a baseline is selected in the feature flag definition. 
