...
sidebar_position: 20
redirect_from:
  - /docs/feature-management-experimentation/management-and-administration/account-settings/
...
For more information about Split’s permissions controls, using owners, and creating groups, see [Groups](/docs/feature-management-experimentation/groups).
