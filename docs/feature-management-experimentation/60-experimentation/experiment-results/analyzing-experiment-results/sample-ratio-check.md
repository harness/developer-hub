...
#### Excluded Users
In some cases, users may be excluded from the analysis due to seeing multiple treatments or rules, see [this article](/docs/feature-management-experimentation/experimentation/experiment-results/analyzing-experiment-results/attribution-and-exclusion/) for more information on attribution and exclusion. If a treatment causes more users to be excluded this can cause a Sample Ratio Mismatch, introduce a bias into your samples and invalidate the results.
...
### What significance threshold does Harness FME use for its sample ratio check?
