...
<p>
  <button style={{borderRadius:'8px', border:'1px', fontFamily:'Courier New', fontWeight:'800', textAlign:'left'}}> help.split.io link: https://help.split.io/hc/en-us/articles/22622277712781-Browser-Suite </button>
</p>
...
[Impressions](https://help.split.io/hc/en-us/articles/360020585192-Impressions) are generated by the Suite each time a `getTreatment` method is called. These impressions are periodically sent back to Split's servers for feature monitoring and experimentation.
