...
All Enforcements generated by the Agent are marked as "Draft Enforcements" and every draft enforcement can be edited by the user to customize them according to the user's needs. The user can run the enforcement or choose to dismiss it.
