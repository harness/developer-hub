...
* Make sure that you have added a **Kubernetes Cluster** in **Cloud Providers Connector.** See [Add a Kubernetes Cluster Connector]((../../../platform/7_Connectors/Cloud-Providers/add-a-kubernetes-cluster-connector.md)).
