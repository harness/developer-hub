...
16. **API Key**: Enter a valid NG API key. Choose **No Expiration** in the Expiration dropdown list while creating this API key. Go to [Create an API Key](https://developer.harness.io//docs/platform/Resource-Development/16_APIs/api-quickstart.md) for more information.
