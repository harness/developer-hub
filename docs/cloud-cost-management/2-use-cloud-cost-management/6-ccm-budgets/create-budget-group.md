...
5. Click **Continue**.
6. In the **Specify Amount** field, the sum of the budgets selected in the previous step is displayed by default. You can edit this value.
7. Select **Cascading** if you wish to split the budget group amount across individual budgets. Select one of the following options:
...
9. Set alerts for your budget group. Harness sends alerts when the actual cost or forecasted cost exceeds the percentage of budget that you specify.
   ...
   2. Enter the percentage of budget beyond which an alert will be triggered.
...
4. You could exclude existing budgets and include new ones with the same parameters.
5. If you have selected **Cascading**, depending on the cascading type the budget group amount is redistributed: 
