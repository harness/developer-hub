...
<details>
<summary><strong>Does Harness support visibility and/or optimization in AWS China?</strong></summary>

No, Harness does not currently support AWS China regions.
</details>

<details>
<summary><strong>Upon setting up a new cloud-provider connector, does Harness ingest the entire historical data available at source?</strong></summary>
...
<details>
<summary><strong>For GCP connector, due to security concerns, can the customer connect only a subset of their GCP billing-export by sharing BigQuery View defined on top of the original billing-export table?</strong></summary>
...
<details>
<summary><strong>Are there any concerns/known issues using only k8 connectors, i.e. not using any cloud connectors? Their primary use case is internal showback and monitoring impacts of k8 infrastructure changes. This setup was working for them, but again looking to eliminate variables that could be causing inconsistencies.</strong></summary>
...
<details>
<summary><strong>Do I need a delegate to get started connecting to GCP?</strong></summary>
...
<details>
<summary><strong>Do I need to add Kubernetes cloud provider connectors for each Kubernetes cluster?</strong></summary>
...
<details>
<summary><strong>When dealing with multiple datasets in one GCP project, how can we add all datasets to the connector?</strong></summary>
...
<details>
<summary><strong>Can I setup an Azure Connector for a subscription without specifying billing details?</strong></summary>
...
<details>
<summary><strong>Does GCP support historical data ingestion from a source located in non US region?</strong></summary>
...
<details>
<summary><strong>We have added a AWS connector and the permissions are in place but we are facing error saying it can't read the objects in the CUR bucket.</strong></summary>
...
<details>
<summary><strong>The verification for the Azure connector fails with "Authorization permission mismatch"</strong></summary>
...
<details>
<summary><strong>What are the recommended resource allocations for different delegate cluster sizes?</strong></summary>
...
<details>
<summary><strong>Can the order of perspectives in the list be customized for alerting purposes?</strong></summary>
...
<details>
<summary><strong>What are the AWS cost types supported by Perspectives?</strong></summary>
...
<details>
<summary><strong>How many Perspectives am I allowed to generate within an account?</strong></summary>
...
<details>
<summary><strong>How is cost allocation determined? Is it based on actual usage, requests, limits, or the higher of requests or actual usage?</strong></summary>
...
<details>
<summary><strong>Is storage included in the cost calculation, particularly in the context of Kubernetes, specifically AKS?</strong></summary>
...
<details>
<summary><strong>What permission we need to display AWS account name instead of account id in UI ?</strong></summary>
...
<details>
<summary><strong>What does "unattributed cost category" mean, and why is it important?</strong></summary>
...
<details>
<summary><strong>How can I address unattributed costs in my reporting and analysis?</strong></summary>
...
<details>
<summary><strong>What is the potential connection between unattributed costs and Kubernetes clusters?</strong></summary>
...
<details>
<summary><strong>Does Perspective support drill-down functionality for cloud data?</strong></summary>
...
<details>
<summary><strong>What is the rationale for the divergence in labels between cloud and cluster data, as illustrated in case of ECS tags, for instance?</strong></summary>
...
<details>
<summary><strong>We need a solution for including future usable GPU instance types without manually updating the rules regularly. What can we do?</strong></summary>
...
<details>
<summary><strong>Are there any limitations or considerations when using the LIKE operator for future instance types?</strong></summary>
...
<details>
<summary><strong>We see some no cluster name fields in our perspective, how can we remove them?</strong></summary>
...
<details>
<summary><strong>Perspective creation governed by RBAC?</strong></summary>
...
<details>
<summary><strong>If a resource (cost) aligns with rules in different cost category buckets, what happens? Does it go into the highest-priority bucket from the list of buckets for the first match?</strong></summary>
...
<details>
<summary><strong>When creating a custom field, can I filter the entire dashboard on the custom field?</strong></summary>
...
<details>
<summary><strong>Do we have support for hourly granularity in the Unified Table?</strong></summary>
...
<details>
<summary><strong>How long does it take for Recommendations data to appear on the dashboards?</strong></summary>
...
<details>
<summary><strong>How long does it take for anomaly data to appear on the dashboards?</strong></summary>
...
<details>
<summary><strong>Is there support for cost categories in the dashboards?</strong></summary>

We have the support to leverage the unified view to attribute costs across clouds and cluster costs.
</details>

<details>
<summary><strong>Do we support AutoStopping savings for visualizing in the dashboards?</strong></summary>
...
<details>
<summary><strong>Do we have support for asset governance in the dashboards?</strong></summary>

No. Asset governance data is not exposed for dashboards yet.
</details>

<details>
<summary><strong>Is memory metrics available in our dashboards for virtual machines hosted on AWS, GCP, and Azure?</strong></summary>
...
<details>
<summary><strong>Is "total cost" in dashboards the same as "unblended cost" in perspectives?</strong></summary>

Yes.
</details>

<details>
<summary><strong>Can we bring in recommendations in BI or is it only at the perspective level?</strong></summary>
...
<details>
<summary><strong>When we are filtering on date in an AWS dashboard, is the date we are using on the line items the usage start/end date or the billing date?</strong></summary>

It is usage start/end date and If there is both start and end, Usage dates is used.
</details>

<details>
<summary><strong>When looking at the BI Dashboards for AWS RDS, we get a data fails to load message on all the different widgets what could be the reason.</strong></summary>
...
<details>
<summary><strong>Why am I seeing 100% for Azure Cost Trend?</strong></summary>
...
<details>
<summary><strong>Why is my dashboard data only going back a month?</strong></summary>

The Reporting Timeframe needs to be a filter, otherwise it defaulted to 30 days.
</details>

<details>
<summary><strong>When is perspective and dashboard data ingested from AWS?</strong></summary>

The data for AWS is ingested at 7PM Pacific time once a day.
</details>

<details>
<summary><strong>Why does the AWS validation return "error processing data"?</strong></summary>
...
<details>
<summary><strong>In an AWS dashboard, what does the dimension "AWS Usage Amount" mean?</strong></summary>
...
<details>
<summary><strong>What is the data update frequency for our K8s visibility?</strong></summary>
...
<details>
<summary><strong>Is cost allocated based on actual use or Requests/Limits?</strong></summary>
...
<details>
<summary><strong>Is Storage cost included in the total cluster cost?</strong></summary>
...
<details>
<summary><strong>Is it possible to split cost? how to split the cost to multiple teams.</strong></summary>
...
<details>
<summary><strong>Can we allow specific cloud account owner to view their own account cost only.</strong></summary>
...
<details>
<summary><strong>If we configure an autostopping rule with multiple instances, but a single routing rule. does the proxy load balance between the instances?</strong></summary>
...
<details>
<summary><strong>We are using Istio as a service mesh, is it possible to autostop the services and turn on the services when services are getting connected through the mesh and not through the kubernetes ingress ?</strong></summary>
...
<details>
<summary><strong>How can I troubleshoot the "Failed to ADD rule to ALB" error when creating an AutoStopping rule?</strong></summary>
...
<details>
<summary><strong>Do we provide support for ECS autostopping when using Network Load Balancers (NLBs) instead of Application Load Balancers (ALBs)?</strong></summary>
...
<details>
<summary><strong>What is the expected behavior of resources managed by an Autostopping rule in Dry Run Mode?</strong></summary>
...
<details>
<summary><strong>I am unable to add additional RDS instances to an auto-stopping rule, when adding other rule it overrides the existing one.</strong></summary>
...
<details>
<summary><strong>Why am I not able to see savings for my Kubernetes AutoStopping rules?</strong></summary>
...
<details>
<summary><strong>How to rotate certificate on Autostopping Proxy?</strong></summary>
...
<details>
<summary><strong>How are we calculating savings for Kubernetes workloads under AutoStopping rules?</strong></summary>
...
<details>
<summary><strong>Why is the configured Fixed Schedule not working for an AutoStopping rule?</strong></summary>
...
<details>
<summary><strong>What happens when disabling an Autostopping rule?</strong></summary>

While disabling the Autostopping rule, the ALB rules created by Harness will be removed.
</details>

<details>
<summary><strong>What happens when re-enabling an Autostopping rule?</strong></summary>
...
<details>
<summary><strong>What happens when an Autostopping rule is warming up?</strong></summary>
...
<details>
<summary><strong>How to set all paths to trigger on power for Autostopping rule?</strong></summary>

Set a wildcard(`*`) on the Path Match in Autostopping rule creation.
</details>

<details>
<summary><strong>How do we onboard and access RDS instance/cluster to Autostopping?</strong></summary>
...
<details>
<summary><strong>We see the error "Failed to obtain VM with name xxxx of resource group" in autostopping rule logs. What does this mean?</strong></summary>
...
<details>
<summary><strong>How do you clone autostopping rules?</strong></summary>
...
<details>
<summary><strong>Why is an RDS instance taking some time to start after being auto-stopped?</strong></summary>
...
<details>
<summary><strong>How are recommendation savings calculated for each type of recommendation?</strong></summary>
...
<details>
<summary><strong>We have found that some AWS EC2 instances are still visible in recommendations list even they are stopped before 2-3 days ago. is it the usual behavior for stopped ec2s?</strong></summary>
...
<details>
<summary><strong>Why doesn't the Workload Recommendation API change the percentile and recommendations based on changes in the time duration?</strong></summary>
...
<details>
<summary><strong>Why there are very small amount of Workload and Nodepool Recommendation data available for a cluster?</strong></summary>
...
<details>
<summary><strong>Why is the CPU utilization data not displaying for EC2 recommendations?</strong></summary>
...
<details>
<summary><strong>Why my service is not coming up when I tried applying Workload Recommendations? It's giving the impression that our recommendations are indicating too low and wrong resources.</strong></summary>
...
<details>
<summary><strong>Why RDS instance resize recommendation not showing in results?</strong></summary>
...
<details>
<summary><strong>Do we support showing GCP VM recommendations?</strong></summary>
...
<details>
<summary><strong>We are not able to see recommendations section in some perspectives ?</strong></summary>
...
<details>
<summary><strong>When I create a JIRA ticket from a recommendation, will that recommendation automatically come in the applied recommendations tab once the JIRA status of the ticket is set to done ?</strong></summary>
...
<details>
<summary><strong>Do we provide the facility to add custom policies to generate Asset Governance Recommendation ?</strong></summary>
...
<details>
<summary><strong>Do we support any method to retrieve Kafka recommendations ?</strong></summary>
...
<details>
<summary><strong>Do we support showing RDS recommendations ?</strong></summary>
...
<details>
<summary><strong>Can I generate recommendation related to some resources based on expected demands in the future to rightsize up/down effectively ?</strong></summary>
...
<details>
<summary><strong>Can I save my applied node preferences in the recommendations ?</strong></summary>
...
<details>
<summary><strong>Is the JIRA ticket automatically created from the suggested recommendations?</strong></summary>
...
<details>
<summary><strong>What happens to recommendations after license expiry ?</strong></summary>
...
<details>
<summary><strong>Can we fine tune EC2 recommendations ?</strong></summary>
...
<details>
<summary><strong>Can we apply "preferred instance families" across all recommendations ?</strong></summary>
...
<details>
<summary><strong>Do we surface asset governance recommendations at the perspective level?</strong></summary>
...
<details>
<summary><strong>When is the Tune Recommendation section visible?</strong></summary>
...
<details>
<summary><strong>Is there support for GCVE costs and for sole tenant nodes.</strong></summary>
...
<details>
<summary><strong>If someone acts on a recommendation but doesn't apply it in Harness, what happens to that recommendation in the next sync cycle?</strong></summary>
...
<details>
<summary><strong>Does Harness allow users to access budgets created in CG within NG?</strong></summary>
...
<details>
<summary><strong>How can users utilize budgets on amortized costs?</strong></summary>
...
<details>
<summary><strong>Can users create budgets in Harness without including alerts?</strong></summary>
...
<details>
<summary><strong>Can users view the historical budget over time in Harness without the need to modify it every month?</strong></summary>
...
<details>
<summary><strong>What is FinOps in Harness?</strong></summary>
...
<details>
<summary><strong>Why is the total savings not displayed for one of my auto-saving rules for RDS in Harness?</strong></summary>
...
<details>
<summary><strong>What should I tag my instances with to be shut down by the stop-after-hours Rule?</strong></summary>
...
<details>
<summary><strong>How can I filter out the "No Cluster Name" entity at the cost category level?</strong></summary>
...
<details>
<summary><strong>How do we create an annual budget with a monthly breakdown?</strong></summary>
...
<details>
<summary><strong>When adding Cloud Governance to a previously created cloud cost connector, do we need to add the cloud-governance IAM permissions to the same role we previously created via the cloudFormation template?</strong></summary>
...
<details>
<summary><strong>Does Harness have an API to validate asset governance rule?</strong></summary>

Yes. You can use the [Validate rule endpoint](https://apidocs.harness.io/tag/Rule/#operation/ValidateRule).
</details>

<details>
<summary><strong>What is RDS resize down policy in asset governance?</strong></summary>
...
<details>
<summary><strong>Can I automate the resizing process?</strong></summary>
...
<details>
<summary><strong>Can the reader role alone be employed in Cloud Asset Governance for production purposes if no actions are intended, and the focus is solely on achieving potential cost savings and resource governance?</strong></summary>
...
<details>
<summary><strong>I created custom governance rules, but I haven't seen any recommendations generated for them?</strong></summary>
...
<details>
<summary><strong>Is it possible to visualize the Cloud Asset Governance data on Dashboards?</strong></summary>

No. Currently, Asset governance data is not yet available in dashboards.
</details>

<details>
<summary><strong>How is the recommendations and potential cost savings shown on the Asset Governance Overview page?</strong></summary>
...
<details>
<summary><strong>For Asset Governance, what are the minimum permissions required for Azure connectors?</strong></summary>
...
<details>
<summary><strong>Is it possible to get Asset Governance evaluation URL with the execution_id?</strong></summary>
...
<details>
<summary><strong>Why are my evaluations taking longer than 3 minutes to execute?</strong></summary>
...
<details>
<summary><strong>Can I create an Asset Governance rule to merge different labels into one AppID label for Azure?</strong></summary>
...
<details>
<summary><strong>In Azure, How can we list all the appServicePlans with cpu and memory less than 50% using the maximum filter.</strong></summary>
...
<details>
<summary><strong>Why am I receiving [azure.core.exceptions.HttpResponseError: (AuthorizationFailed)] when setting up tags in Azure?</strong></summary>
...
<details>
<summary><strong>How can I ensure the Tag Contributor role is effective for setting up tags in Azure?</strong></summary>
...
<details>
<summary><strong>How do I check for deny assignments or policies that might be causing the authorization error in Azure?</strong></summary>
...
<details>
<summary><strong>How are anomalies associated with specific perspectives and which notification channels are used for alerting?</strong></summary>
...
<details>
<summary><strong>What happens when an anomaly is associated with multiple perspectives?</strong></summary>
...
<details>
<summary><strong>How frequently do you run anomaly detection jobs ?</strong></summary>

Anomaly detection jobs are executed once per day.
</details>

<details>
<summary><strong>Do we consider seasonal factors while detecting anomalies ?</strong></summary>

Yes we do consider daily, weekly and monthly seasonalities while detecting anomalies.
</details>

<details>
<summary><strong>Do we support daily alerts for anomalies ?</strong></summary>

Yes we do support daily alerts for anomalies
</details>

<details>
<summary><strong>We didn't get the slack/email notifications for anomaly despite the fact that we have we have set up channels for them ?</strong></summary>
...
<details>
<summary><strong>How much time does it take for sending alerts to the customers for an anomaly ?</strong></summary>
...
<details>
<summary><strong>Do we support fetching anomalies on perspective made through labels ?</strong></summary>

No, currently we do not have support for retrieving anomalies based on perspective labels.
</details>

<details>
<summary><strong>Is there a way we can proactively feed data to anomaly detection for future events or holidays ?</strong></summary>

No, Harness doesn't support feeding data for future events or holidays.
</details>

<details>
<summary><strong>Anomaly drill down from the perspective screen does not seem to be filtering the anomaly list correctly ?</strong></summary>
...
<details>
<summary><strong>I see an anomaly at the AWS usage type level. Why is it that I'm not observing the same anomaly at the AWS service or AWS account level?</strong></summary>
...
<details>
<summary><strong>I am seeing a large number of anomalies being detected which do not seem like anomalies to me ?</strong></summary>
...
<details>
<summary><strong>Does Harness fetch anomalies for perspectives using cost category rules and groupings by cost categories?</strong></summary>
...
<details>
<summary><strong>How can I exclude specific instance types from instance resizing recommendations?</strong></summary>
...
<details>
<summary><strong>How to specify a preferred instance family globally?</strong></summary>

Currently, we don't support this feature.
</details>

<details>
<summary><strong>How to rename the report file name of the dashboard scheduled delivery?</strong></summary>
...
<details>
<summary><strong>Is it possible to share a dashboard with a person who doesn't have a Harness user?</strong></summary>
