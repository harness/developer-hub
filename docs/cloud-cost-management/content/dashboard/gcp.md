...
<RedirectIfStandalone label="GCP" targetPage="/docs/cloud-cost-management/use-ccm-cost-reporting/use-ccm-dashboards/overview" />

## View GCP Cost Dashboard

<DocImage path={require('../static/gcp.png')} width="100%" height="100%" title="Click to view full size image" />
