...
<RedirectIfStandalone label="Elasticache" targetPage="/docs/cloud-cost-management/use-ccm-cost-optimization/commitment-orch-docs/get-started" />
...
- **Active CACM Connectors**: You must have at least one active cloud connector set up for the cloud providers you want to categorize costs for: Set Up [CCM Connectors](/docs/cloud-cost-management/provider-integrations/cloud-providers/aws).
