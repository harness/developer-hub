...
For more information about Anomalies, go to [Detect Cloud Cost Anomalies](/docs/cloud-cost-management/use-ccm-cost-reporting/anomaly-detection/a-detect-cloud-cost-anomalies-with-ccm).
