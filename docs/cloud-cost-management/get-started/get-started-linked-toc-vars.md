---
title: Get Started - linked toc variations
description: Learn how to get started with CCM with your chosen cloud provider.
sidebar_position: 20
sidebar_label: Get Started - linked toc variations
---
...
<DynamicMarkdownSelector
  options={{
    ...
    NoHeadings: {
      path: "/cloud-cost-management/content/get-started/no-headings.md",
      logo: "/cloud-providers/azure-logo.svg",
      logoSize: 32
    },
    SmallHeadings: {
      path: "/cloud-cost-management/content/get-started/small-headings.md",
      logo: "/cloud-providers/azure-logo.svg",
      logoSize: 32
    }
  }}
