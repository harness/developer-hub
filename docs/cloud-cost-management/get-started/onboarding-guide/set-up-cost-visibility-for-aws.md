...
| **Commitment Orchestrator** (Optional)| This feature allows you to optimize your cloud spend and avoid unnecessary costs by optimally utilizing your existing Reserved Instances (RI). For more information, see [Commitment Orchestrator](../../4-use-ccm-cost-optimization/commitment-orchestrator/commitment-orch.md). <ul><li>Acquire or convert Reserved Instances (RIs)</li><li>Purchase Savings Plans</li></ul> |
