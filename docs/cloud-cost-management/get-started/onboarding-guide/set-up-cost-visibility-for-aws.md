...
| **Cloud Governance** <br/>(Optional) | • Asset Management (EC2, EBS, RDS, S3)<br/>• Automated Actions<br/><br/>*Helps optimize cloud spend and avoid unnecessary costs.* | *See Reference section below* | • [Asset Governance](../../5-use-ccm-cost-governance/asset-governance/1-asset-governance.md)<br/>• [Create Governance Rules](/docs/cloud-cost-management/use-ccm-cost-governance/asset-governance/asset-governance) |
