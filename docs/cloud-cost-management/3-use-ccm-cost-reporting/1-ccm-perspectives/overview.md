...
- **Faster Performance**: Significantly improved load times for Perspectives and Cost Categories
- **Original Tag Visibility**: See your cloud tag keys exactly as they appear in AWS, Azure, GCP, or Cluster environments
- **Seamless Integration**: Use Label V2 in filters, GROUP BY operations, and when creating rules for Perspectives and Cost Categories
