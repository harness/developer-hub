---
title: Standardize Currency
description: View your CCM application in your preferred currency across different cloud providers.
sidebar_position: 20
---

:::note
This feature requires the **CCM_CURRENCY_PREFERENCES** flag. Contact Harness Support to enable.
:::

Harness CCM lets you display all cloud spend data and dashboards in a single, preferred currency, making reports easier to understand and compare. Choose from currencies such as:

- ARS, AUD, BRL, CAD, CNY, EUR, GBP, INR, JPY, MXN, NOK, NZD, RUB, SGD, USD
