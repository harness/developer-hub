...
|---------|-------------|----------|
| <span style={{backgroundColor: '#28a745', color: 'white', padding: '2px 6px', borderRadius: '4px', fontSize: '0.8em', marginLeft: '8px'}}>LATEST</span> `0.5.0` | April 28,2026 | - Support for 0.9.0 <br/>- Karpenter dependency 1.8.2 |
| `0.4.2` | Mar 6, 2026 | - Support for 0.8.2 <br/>- Updated the Config CRD to support Bin Packingmax_evictions <br/>- Updated permissions for Node and Pod metrics calculation |
