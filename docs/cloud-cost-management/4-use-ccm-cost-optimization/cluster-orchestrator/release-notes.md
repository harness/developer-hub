...
|---------|-------------|----------|
| <span style={{backgroundColor: '#28a745', color: 'white', padding: '2px 6px', borderRadius: '4px', fontSize: '0.8em', marginLeft: '8px'}}>LATEST</span> `0.2.0` | Nov 26, 2025 | - Ability to install Harness VPA components and CRD (if feature flag is enabled) |
