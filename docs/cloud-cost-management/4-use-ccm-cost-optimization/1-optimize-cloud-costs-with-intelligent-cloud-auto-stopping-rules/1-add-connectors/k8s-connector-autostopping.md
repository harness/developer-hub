...
:::
* Make sure you are a member of the Harness Administrator Group. This is required to [create an API key](/docs/platform/automation/api/add-and-manage-api-keys).
