...
<DocImage path={require('./static/stepfive.png')} width="100%" height="100%" title="Click to view full size image" />
...
In orchestration preferences, you can also specify the orchestration mode. That means you can specify how you want the orchestra to execute the recommended actions. The orchestration mode can be either fully automated, conditionally, automated or manual.
