...
<DocImage path={require('./static/stepone-copy.png')} width="100%" height="100%" title="Click to view full size image" />
...
<DocImage path={require('./static/stepsix.png')} width="100%" height="100%" title="Click to view full size image" />
...
<DocImage path={require('./static/stepseven.png')} width="100%" height="100%" title="Click to view full size image" />
