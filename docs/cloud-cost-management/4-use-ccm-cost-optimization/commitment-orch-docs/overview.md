...
<DocImage path={require('./overview-static/ri-vs-sp.png')} width="70%" height="70%" title="Click to view full size image" />
...
<DocImage path={require('./overview-static/harness-co.png')} width="80%" height="80%" title="Click to view full size image" />
