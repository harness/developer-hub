...
Currently, this feature is behind the feature flag `AUDIT_TRAIL_WEB_INTERFACE`. Contact [Harness Support](mailto:support@harness.io) to enable the feature. Your Harness account [Audit Trail](/developer-hub/docs/platform/15_Audit-Trail/audit-trail.md) includes events for CCM changes.
