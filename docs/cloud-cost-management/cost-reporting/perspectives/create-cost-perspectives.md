...
* [Use Cost Categories](../ccm-cost-categories/1-ccm-cost-categories.md
...
* **Cost Categories**: You can create a perspective by filtering based on the cost categories you have created. To create cost categories, see [Use Cost Categories](../ccm-cost-categories/1-ccm-cost-categories.md
