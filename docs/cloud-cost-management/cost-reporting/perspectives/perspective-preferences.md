...
To know how to analyze your cluster perspective data, go to [Analyze cost for Kubernetes or AWS ECS](../root-cost-analysis/analyze-cost-for-k8s-ecs-using-perspectives.md
...
To know how to analyze the AWS perspective data, go to [Analyze cost for AWS](../root-cost-analysis/analyze-cost-for-aws.md
...
To know how to analyze the perspective data, go to [Analyze cost for GCP](../root-cost-analysis/analyze-cost-for-gcp-using-perspectives.md
