...
This topic provides settings for the **Build and Push to ACR** step, which you can use to [build and push artifacts to ACR](../../use-ci/build-and-upload-artifacts/build-and-push-to-acr.md).
