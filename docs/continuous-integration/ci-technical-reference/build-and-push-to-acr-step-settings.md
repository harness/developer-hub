...
For more information about Azure connectors, including details about required permissions, go to [Add a Microsoft Azure Cloud Provider connector](../../platform/7_Connectors/Cloud-providers/add-a-microsoft-azure-connector.md).
