...
For detailed instructions on setting up VPN connectivity (OpenVPN or WireGuard) in Harness Cloud builds, see [VPN for Harness Cloud](/docs/platform/references/private-network-connectivity/vpn-harness-cloud).
