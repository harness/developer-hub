...
For more information about using Harness Cloud in your CI pipelines, including the YAML specification, go to [Use Harness Cloud build infrastructure](../use-ci/set-up-build-infrastructure/use-harness-cloud-build-infrastructure.md).
