...
description: This tutorial shows you how to build a simple, two-stage CI pipeline in Harness.
...
![](./static/ci-pipeline-quickstart-30.png)

Click **Builds**. Your build appears.

![](./static/ci-pipeline-quickstart-31.png)
