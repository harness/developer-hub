...
4. Add **Paths** to cache.
   ...
   Note that on Windows platforms, you might need to specify the cache path from `C:`, such as `C:harnessnode_modules`.
    ...
    - stage:
        ...
        spec:
          caching:
            enabled: true
            paths:
              - /harness/node_modules ## On a Windows platform, the path would be 'C:harnessnode_modules'.
          cloneCodebase: true
...
```
