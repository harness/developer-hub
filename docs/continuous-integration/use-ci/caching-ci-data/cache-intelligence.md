...
Cache Intelligence fully supports **Bazel**, **Maven**, **Gradle**, **Yarn**, **Go**, **Node**,  **VB**, **F#**  and **MSBuild/dotnet (only for C#)** build tools, as long as default cache paths are used. 
