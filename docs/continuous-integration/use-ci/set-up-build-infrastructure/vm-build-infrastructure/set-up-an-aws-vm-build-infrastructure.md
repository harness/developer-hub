...
* Authentication requirements:
   ...
   + You can use IAM profiles instead of access and secret keys. You need to run the delegate VM with an IAM role that has CRUD permissions on EC2 (see AmazonEC2FullAccess Managed policy https://docs.aws.amazon.com/aws-managed-policy/latest/reference/AmazonEC2FullAccess.html). This role provides the runner with temporary security credentials to create VMs and manage the build pool.
