...
This topic describes how to use AWS VMs as Harness CI build infrastructure. To do this, you must create an Ubuntu VM and then installing a Harness Delegate and Drone VM Runner on it. The delegate creates VMs dynamically in response to CI build requests. You can also configure the delegate to hibernate AWS Linux and Windows VMs when they aren't needed.
