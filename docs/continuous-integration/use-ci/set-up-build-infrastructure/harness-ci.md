...
You can use either `X-API-KEY: $API_KEY` or `Authorization: Bearer $token` for authentication. For more information, go to [Add and manage API keys](/docs/platform/Resource-Development/APIs/add-and-manage-api-keys).
