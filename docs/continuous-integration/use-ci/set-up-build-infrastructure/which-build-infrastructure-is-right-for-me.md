...
| [Self-hosted Cloud provider VMs](#cloud-provider-virtual-machines) | <ul><li>Scalable.</li><li>Supports Linux, Windows, and macOS platforms.</li><li>When compared to the Kubernetes cluster build infrastructure option:<ul><li>More support/flexibility for running Docker commands.</li><li>Native support for Windows builds.</li></ul></li></ul> | <ul><li>Most difficult to configure and manage.</li></ul> | Users who want to manage their own VM pool and have more control over the VM specs.</ul> |
