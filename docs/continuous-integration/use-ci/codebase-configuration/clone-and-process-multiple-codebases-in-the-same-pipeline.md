...
When cloning additional codebases that use the same credentials as your default codebase, you can [use your default codebase connector's credentials in your Run step](/docs/continuous-integration/ci-articles-faqs/articles/use-git-credentials-from-codebase-connector-in-ci-pipelines-run-step).
