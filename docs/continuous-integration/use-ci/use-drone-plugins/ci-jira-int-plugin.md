...
```
The following YAML example describes a [Plugin step](../../ci-technical-reference/plugin-step-settings-reference.md) in a `CI` stage that updates the Jira **Build** field when there is a successful build.
