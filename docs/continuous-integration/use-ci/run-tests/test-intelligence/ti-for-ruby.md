...
Using TI doesn't require you to change your build and test processes. To enable TI for Ruby, you must add a Run Tests step and generate the initial call graph.
