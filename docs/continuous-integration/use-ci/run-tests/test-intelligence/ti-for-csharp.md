...
Using TI doesn't require you to change your build and test processes. To enable TI for C#, you must add a Run Tests step and generate the initial call graph.
