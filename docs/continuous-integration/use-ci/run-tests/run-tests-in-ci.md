...
* **Parallelism:** You can use parallelism with either the **Run** or **Run Tests** steps to speed up test times. For more information, go to [Use parallelism to improve test times](./speed-up-ci-test-pipelines-using-parallelism).
