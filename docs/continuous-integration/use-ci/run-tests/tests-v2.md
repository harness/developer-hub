...
You can _append_ additional settings to this value, but **do not override the default value**.
...
Go to the [CI Knowledge Base](/docs/continuous-integration/ci-articles-faqs/continuous-integration-faqs) for more questions and issues related to Test Intelligence, including:
...
- [Test Intelligence fails to find all classes on C# code.](/docs/continuous-integration/ci-articles-faqs/continuous-integration-faqs#why-some-of-my-c-classes-are-not-being-discovered-by-test-intelligence)
