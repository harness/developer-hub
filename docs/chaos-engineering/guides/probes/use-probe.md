...
- Go to [probe overview](/docs/chaos-engineering/guides/probes/) to understand about probes.
- Go to [chaos faults](/docs/chaos-engineering/faults/) to understand the application of resilience probes.
...
3. Based on the probe type you choose, the fields will vary. You can find details about every probe in their respective documentation (([Command](/docs/chaos-engineering/guides/probes/command-probes), [Datadog](/docs/chaos-engineering/guides/probes/datadog-probe), [Dynatrace](/docs/chaos-engineering/guides/probes/dynatrace-probe), [HTTP](/docs/chaos-engineering/guides/probes/http-probe), [Kubernetes](/docs/chaos-engineering/guides/probes/kubernetes-probe), [Prometheus](/docs/chaos-engineering/guides/probes/apm-probes/prometheus-probe), and [SLO](/docs/chaos-engineering/guides/probes/slo-probe))). After entering the details, click **Configure properties**. Enter further details and click **Configure details**.
