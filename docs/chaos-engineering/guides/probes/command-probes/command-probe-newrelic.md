...
* [Create a command probe](/docs/chaos-engineering/guides/probes/#create-a-resilience-probe)
* [Command probe with source parameter](/docs/chaos-engineering/guides/probes/command-probes/command-probe-usage#configure-command-probe-with-source-parameter)
