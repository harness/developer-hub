...
---
Pod IO latency simulate slow I/O operations by introducing delays in file system calls within a container and used for testing the resilience, performance, and scalability of the pod 
...
- Test the system performance during backup or recovery operations, it is possible to see how the system handles slow I/O performance and ensure that backups and recoveries are successful under all conditions.
- Simulate the slow file system calls under different loads, it is possible to identify the optimal capacity of the system to ensure that it can handle the expected load without experiencing performance issues.
  ...
  <h3>Optional tunables</h3>
    <table>
      ...
      <tr>
        ...
        <td> For more information, go to <a href="https://developer.harness.io/docs/chaos-engineering/chaos-faults/kubernetes/pod/pod-io-latency#io-latency">latency</a></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td> For more information, go to <a href="https://developer.harness.io/docs/chaos-engineering/chaos-faults/kubernetes/pod/pod-io-latency#advanced-fault-tunables">percentage</a> </td>
      </tr>
      <tr>
        <td> METHOD_TYPES </td>
        <td> It contains the file system call or methods </td>
        <td> For more information, go to <a href="https://developer.harness.io/docs/chaos-engineering/chaos-faults/kubernetes/pod/pod-io-latency#advanced-fault-tunables">percentage</a> </td>
      </tr>
      <tr>
        <td> CONTAINER_RUNTIME </td>
        <td> Container runtime interface for the cluster. </td>
        <td> Default: containerd. Supports docker, containerd and crio. For more information, go to <a href="https://developer.harness.io/docs/chaos-engineering/chaos-faults/kubernetes/pod/pod-io-latency#container-runtime-and-socket-path">container runtime </a> </td>
      </tr>
      <tr>
        <td> SOCKET_PATH </td>
        <td> Path of the containerd or crio or docker socket file. </td>
        <td> Defaults to <code>/run/containerd/containerd.sock</code>. For more information, go to <a href="https://developer.harness.io/docs/chaos-engineering/chaos-faults/kubernetes/pod/pod-io-latency#container-runtime-and-socket-path">socket path</a></td>
      </tr>
      <tr>
...
- `FILE_PATH`: The path for injecting faults can be specified as either a single file or a wildcard. ByDefault it will target all the paths
- `PERCENTAGE`: The likelihood of failure per operation, expressed as a percentage. Default is 100%
- `METHOD_TYPES`: It contains the file system call or methods. ByDefault it will target all the methods
