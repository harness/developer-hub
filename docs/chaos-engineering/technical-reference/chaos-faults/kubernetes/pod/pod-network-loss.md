  ...
  <h3>Optional tunables</h3>
    <table>
      ...
      <tr>
        ...
        <td> Default: 100 %. For more information, go to <a href="https://developer.harness.io/docs/chaos-engineering/chaos-faults/kubernetes/pod/pod-network-loss#network-packet-loss">network packet loss</a>. </td>
      </tr>
      <tr>
...
[embedmd]:# (./static/manifests/pod-network-loss/ignore-source-and-destination-ports.yaml yaml)
```yaml
