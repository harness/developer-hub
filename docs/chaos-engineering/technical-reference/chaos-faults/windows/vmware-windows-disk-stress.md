   ...
   <h3>Mandatory fields</h3>
    ...
    <table>
      ...
      <tr>
        ...
        <td> For example, <code>C:\\</code>. For more information, go to <a href="#disk-path"> dsk path.</a> </td>
      </tr>
      <tr>
        <td> PATH_OF_DISKSPD </td>
        <td> Path of the Diskspd binary in the VM. </td>
        <td> For example, <code>C:\\Program Files\\Diskspd\\</code>. For more information, go to <a href="#path-of-diskspd"> path of Diskspd.</a> </td>
      </tr>
      <tr>
