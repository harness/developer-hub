---
id: pod-jvm-memory-stress
title: Pod JVM memory stress
redirect_from:
- /docs/chaos-engineering/technical-reference/chaos-faults/spring-boot/spring-boot-memory-stress
---
...
<table>
  ...
  <tr>
    <td> MEMORY_TYPE </td>
    <td> The type of JVM memory region to stress. </td>
    <td> Default: <code>heap</code>. Choose between <b>heap</b> and <b>stack</b>. </td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td> Name of the target container subject to chaos. </td>
  ...
  <tr>
    <td> TARGET_PODS </td>
    <td> Comma-separated list of application pod names subject to pod JVM memory stress.</td>
...
[embedmd]:# (./static/manifests/pod-jvm-memory-stress/params.yaml yaml)
```yaml
apiVersion: litmuschaos.io/v1alpha1
kind: KubernetesChaosExperiment
metadata:
