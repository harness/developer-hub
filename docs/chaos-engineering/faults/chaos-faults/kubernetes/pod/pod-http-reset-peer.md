...
:::info note
Pod HTTP reset peer supports HTTP, HTTPS methods, and gRPC framework.
:::
...
### Optional tunables
  <table>
      ...
      <tr>
        ...
        <td> Default: containerd. Supports values: docker, containerd and crio. For more information, go to <a href="/docs/chaos-engineering/faults/chaos-faults/kubernetes/pod/pod-dns-error#container-runtime-and-socket-path">container runtime </a> </td>
      </tr>
      <tr>
        <td> SOCKET_PATH </td>
