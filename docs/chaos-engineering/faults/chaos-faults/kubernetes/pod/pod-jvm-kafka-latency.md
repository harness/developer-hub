...
<table>
 ...
 <tr>
    <td> LATENCY </td>
    <td> The latency (in milliseconds) to inject into Kafka operations. </td>
    <td> For example, 2000 (for 2 seconds). For more information, go to <a href= "#parameters">Parameters</a></td>
  </tr>
</table>
...
<table>
 ...
 <tr>
  ...
  <tr>
    ...
    <td> Name of the container subject to Kafka latency injection. </td>
  ...
  <tr>
    <td> TARGET_PODS </td>
    <td> Comma-separated list of application pod names subject to pod JVM Kafka latency.</td>
...
[embedmd]:# (./static/manifests/pod-jvm-kafka-latency/params.yaml yaml)
```yaml
