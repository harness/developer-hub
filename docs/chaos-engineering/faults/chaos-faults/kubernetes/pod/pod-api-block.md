...
### Optional tunables
  <table>
      ...
      <tr>
        ...
        <td> These CA certificates must also be added to the target application's root certificate. For more information, go to <a href="/docs/chaos-engineering/faults/chaos-faults/kubernetes/pod/pod-api-block#using-self-signed-certificates">CA certificates.</a></td>
      </tr>
      <tr>
        ...
        <td> The corresponding CA certificates should be loaded as root certificates inside the target application. For more information, go to <a href="/docs/chaos-engineering/faults/chaos-faults/kubernetes/pod/pod-api-block#using-self-signed-certificates">server certificates.</a></td>
      </tr>
      <tr>
...
- [Using self-signed certificate](/docs/chaos-engineering/faults/chaos-faults/kubernetes/pod/pod-api-block#using-self-signed-certificates)
- [Using trusted certificate](/docs/chaos-engineering/faults/chaos-faults/kubernetes/pod/pod-api-block#using-trusted-certificate)
