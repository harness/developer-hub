...
- /docs/chaos-engineering/faults/chaos-faults/vmware/vmware-disk-loss
---
...
### Mandatory tunables
   <table>
      ...
      <tr>
        ...
        <td> For example, <code>vm-5365</code>. For more information, go to <a href="/docs/chaos-engineering/faults/chaos-faults/vmware/vCenter/VMware-vm-power-off#stoppoweroff-the-vm-by-moid"> MOIDs of the VMware instance.</a></td>
      </tr>
      <tr>
