...
```
:::info note
- Refer to [AWS named profile for chaos](/docs/chaos-engineering/faults/chaos-faults/aws/security-configurations/aws-switch-profile) for how to use a different profile for AWS faults.
