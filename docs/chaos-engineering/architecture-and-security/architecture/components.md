...
## Kubernetes execution plane components

The Kubernetes execution plane consists of chaos infrastructure components like workflow controllers, subscribers, and event trackers, that are described below, and backend execution infrastructure components like [ChaosExperiment CR](/docs/chaos-engineering/architecture-and-security/architecture/components#1-chaos-experiment), [ChaosEngine CR](/docs/chaos-engineering/architecture-and-security/architecture/components#17-chaosengine-custom-resource-cr), etc.
...
## Linux execution plane components
