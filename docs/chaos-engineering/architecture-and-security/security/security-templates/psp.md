...
The [pod delete](/docs/chaos-engineering/technical-reference/chaos-faults/kubernetes/pod/pod-delete.md) experiment RBAC instrumented with the PSP is shown below:
