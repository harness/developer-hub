...
- [Chaos experiment auto-creation](#auto-create-experiments) for a given [application map](/docs/chaos-engineering/concepts/explore-concepts/app-maps) based on the workload specification and its lineage in terms of network traffic.
...
| **Dedicated Chaos Infrastructure**                                                                                             | **Harness Delegate-Driven Chaos Infrastructure**                                                                                                                                                                                                                                                                                                                                                                                                                  |
|--------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
