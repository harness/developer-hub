...
Go to [chaos faults](/docs/chaos-engineering/use-harness-ce/experiments/#chaos-fault) to learn about various [fault status](/docs/chaos-engineering/use-harness-ce/experiments/#fault-status), flow of control in a chaos experiment, and so on.
