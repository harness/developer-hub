...
The network experiments interrupt traffic for all the IPs/hosts by default. You can tune it using the `DESTINATION_IPS` and `DESTINATION_HOSTS` environment variables.
