...
Windows chaos faults disrupt the resources of an application running on a Windows virtual machine. To execute these faults, you need to [install a chaos infrastructure in the Windows VM](/docs/chaos-engineering/architecture-and-security/architecture/chaos-infrastructure/windows-chaos-infrastructure.md). 
