...
export const experiments: ExperimentDetails[] = [
  ...
  },
  {
    ...
    description:
      "Azure instance CPU hog disrupts the state of infrastructure resources by inducing stress on the Azure instance using the Azure Run Command.",
    tags: ["CPU hog"],
    category: "azure",
  },
  {
    ...
    description:
      "Azure instance I/O stress disrupts the state of infra resources by inducing stress on the Azure Instance using the Azure Run command.",
    tags: ["I/O stress"],
    category: "azure",
  },
  {
    ...
    description:
      "Azure instance memory hog disrupts the state of infrastructure resources by inducing stress on the Azure Instance using the Azure Run command.",
    tags: ["memory hog"],
    category: "azure",
  },
  {
