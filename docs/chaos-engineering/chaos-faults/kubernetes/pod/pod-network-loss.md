  ...
  <h3>Optional fields</h3>
    <table>
      ...
      <tr>
        ...
        <td> For more information, go to <a href="https://developer.harness.io/docs/chaos-engineering/chaos-faults/kubernetes/pod/pod-network-loss#network-interface">network interface.</a></td>
      </tr>
      <tr>
        <td> TARGET_CONTAINER </td>
        <td> Name of the container subject to network loss. Applicable for containerd and crio runtimes only.</td>
      ...
      <tr>
        ...
        <td> Default to 100 %. For more information, go to <a href="https://developer.harness.io/docs/chaos-engineering/chaos-faults/kubernetes/pod/pod-network-loss#network-packet-loss">network packet loss.</a> </td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td> Defaults to <code>/run/containerd/containerd.sock</code>. For more information, go to <a href="https://developer.harness.io/docs/chaos-engineering/chaos-faults/kubernetes/pod/pod-network-loss#container-runtime-and-socket-path">socket path.</a></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td> If the values are not provided, the fault induces network chaos for all IPs or destinations or <code>DESTINATION_IPS</code> if already defined. For more information, go to <a href="https://developer.harness.io/docs/chaos-engineering/chaos-faults/kubernetes/pod/pod-network-loss#destination-ips-and-destination-hosts">destination hosts.</a></td>
      </tr>      
      <tr>
...
It specifies the network packet loss (in percentage) that is injected into the target application. Tune it by using the `NETWORK_PACKET_LOSS_PERCENTAGE` environment variable. 

Use the following example to tune the network packet loss:
