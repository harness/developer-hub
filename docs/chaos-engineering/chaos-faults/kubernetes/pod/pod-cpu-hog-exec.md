...
Pod CPU hog exec is a Kubernetes pod-level chaos fault that consumes excess CPU resources of the application container. This fault:
- Applies stress on the target pods by simulating a lack of CPU for processes running on the Kubernetes application. This degrades the performance of the application. 
  ...
  <h3>Optional fields</h3>
    <table>
      ...
      <tr>
        ...
        <td> Defaults to 1. For more information, go to <a href="https://developer.harness.io/docs/chaos-engineering/chaos-faults/kubernetes/pod/pod-cpu-hog-exec#cpu-cores">CPU cores. </a> </td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td> Defaults to 0 (corresponds to 1 replica). For more information, go to <a href="https://developer.harness.io/docs/chaos-engineering/chaos-faults/kubernetes/pod/common-tunables-for-pod-faults#pod-affected-percentage">pods affected percentage. </a> </td>
      </tr>
      <tr>
        <td> CHAOS_INJECT_COMMAND </td>
        <td> Command to inject CPU chaos. </td>
        <td> Default to <code>md5sum /dev/zero</code>. For more information, go to <a href="https://developer.harness.io/docs/chaos-engineering/chaos-faults/kubernetes/pod/pod-cpu-hog-exec#chaos-inject-and-kill-commands">chaos inject command. </a></td>
      </tr>
      <tr>
...
Use the following example to tune the chaos inject and kill commands:
