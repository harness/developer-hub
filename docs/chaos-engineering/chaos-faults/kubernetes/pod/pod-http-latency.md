  ...
  <h3>Mandatory fields</h3>
    ...
    <tr>
      ...
      <tr>
        ...
        <td>Defaults to port 80. For more information, go to <a href="https://developer.harness.io/docs/chaos-engineering/chaos-faults/kubernetes/pod/pod-http-latency#target-service-port">target service port. </a> </td>
      </tr>
      <tr>
        <td> LATENCY </td>
        <td> Delay added to the requests (in milliseconds). </td>
        <td> Defaults to 2000. For more information, go to <a href="https://developer.harness.io/docs/chaos-engineering/chaos-faults/kubernetes/pod/pod-http-latency#latency">latency. </a></td>
      </tr>
    </table>
    ...
    <table>
      ...
      <tr>
        ...
        <td> Defaults to 20000. For more information, go to <a href="https://developer.harness.io/docs/chaos-engineering/chaos-faults/kubernetes/pod/pod-http-latency#proxy-port">proxy port. </a></td>
      </tr>
      <tr>
        <td> NETWORK_INTERFACE </td>
        <td> Network interface used for the proxy.</td>
        <td> Defaults to `eth0`. For more information, go to <a href="https://developer.harness.io/docs/chaos-engineering/chaos-faults/kubernetes/pod/pod-http-latency#network-interface">network interface. </a></td>
      </tr>
      <tr>
        <td> TOXICITY </td>
        <td> Percentage of HTTP requests that will be affected. </td>
        <td> Defaults to 100. For more information, go to <a href="https://developer.harness.io/docs/chaos-engineering/chaos-faults/kubernetes/pod/pod-http-latency#toxicity">toxicity. </a></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td> Defaults to <code>/run/containerd/containerd.sock</code>. For more information, go to <a href="https://developer.harness.io/docs/chaos-engineering/chaos-faults/kubernetes/pod/pod-http-latency#container-runtime-and-socket-path">socket path. </a></td>
      </tr>
      <tr>
...
Use the following example to tune the service port:
...
It specifies the delay to be added to the HTTP request. Tune it by using the `LATENCY` environment variable.

Use the following example to tune the latency:
...
It specifies the network interface that would be used for the proxy. Tune it by using the `NETWORK_INTERFACE` environment variable.
