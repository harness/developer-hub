...
[embedmd]: # "./static/manifests/linux-api-status-code/target-service-port.yaml yaml"
...
[embedmd]: # "./static/manifests/linux-api-status-code/path-filter.yaml yaml"
...
[embedmd]: # "./static/manifests/linux-api-status-code/destination-ports.yaml yaml"
...
[embedmd]: # "./static/manifests/linux-api-status-code/https-enabled.yaml yaml"
...
- **statusCode**: Status code received when the API is blocked.

The following YAML snippet illustrates the use of this input variable:

[embedmd]:# (./static/manifests/linux-api-status-code/advanced-fault-tunables.yaml yaml)
```yaml
...
[embedmd]:# (./static/manifests/linux-api-status-code/advanced-filters.yaml yaml)
```yaml
# it injects the api status code fault
apiVersion: litmuschaos.io/v1alpha1
kind: ChaosEngine
