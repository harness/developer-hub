...
redirect_from:
  - /docs/ai-dlc-insights/setup/integrations/beta-integrations/windsurf/
---
...
The Windsurf integration enables AI DLC Insights to track adoption and usage metrics for Windsurf coding assistants. 
