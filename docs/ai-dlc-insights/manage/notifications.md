---
title: Configure Harness AIDI Notification Settings
description: Learn how to set up and manage notification preferences for ingestion failures in Harness AIDI.
sidebar_label: Notification Settings
sidebar_position: 4
---

AI DLC Insights allows you to configure email notifications for key system events, such as data ingestion failures or satellite health issues. You can specify which team members should receive these alerts to ensure organizational awareness and resolution.
