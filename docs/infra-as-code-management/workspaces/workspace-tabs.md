...
:::info Learn more
For setup instructions and YAML examples, see [Configure Connectors and Variables](/docs/infra-as-code-management/configuration/connectors-and-variables/connectors-variables).
...
- **Submodules:** Use submodules from your repository's `modules/` folder. 
  Go to [Submodule Usage](/docs/infra-as-code-management/registry/module-registry/module-registry-overview#root%26submoduleusage) for more information.
