---
title: Manage Version Lifecycle
sidebar_label: Manage Version Lifecycle
...
:::note Two independent systems
Version lifecycle management (this page) and governance policies ([Govern Module Usage](/docs/infra-as-code-management/registry/module-registry/module-governance)) are separate mechanisms. Lifecycle controls which versions are considered current; governance controls which modules and versions are allowed. You can use either without the other.
:::
...
- **Registered module**: A module already registered in the IaCM Module Registry. Go to [Register a Module](/docs/infra-as-code-management/registry/module-registry) to add one.
...
<!-- SCREENSHOT: Module Registry version dropdown showing version badges. One version is labeled Supported (green badge), one is Update Required (yellow badge), and one is Deprecated (red badge), alongside the version numbers. -->
...
<Troubleshoot
  issue="A pipeline started failing after a new module version was published in Harness IaCM"
  mode="fallback-only"
...
<Troubleshoot
  issue="A deprecated module version is not being blocked in a Harness IaCM pipeline"
  mode="fallback-only"
...
<Troubleshoot
  issue="A module version shows an unexpected lifecycle tier in Harness IaCM"
  mode="fallback-only"
...
- Go to [Module Registry Overview](/docs/infra-as-code-management/registry/module-registry/module-registry-overview) to understand module structure, settings, and governance.
- Go to [Register a Module](/docs/infra-as-code-management/registry/module-registry) to register a module in Harness IaCM.
- Go to [Module Artifacts](/docs/infra-as-code-management/registry/module-registry/module-registry-artifacts) to learn how artifact storage and the onboarding pipeline work.
...
- Go to [Govern Module Usage](/docs/infra-as-code-management/registry/module-registry/module-governance) to understand OPA-based governance for module usage.
