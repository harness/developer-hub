...
This content is for Harness [FirstGen](../../../../getting-started/harness-first-gen-vs-harness-next-gen.md). Switch to [NextGen](../../../../continuous-delivery/cd-deployments-category/deployment-logs-and-limitations.md).This topic lists the deployment log size, export, and viewing limits.
