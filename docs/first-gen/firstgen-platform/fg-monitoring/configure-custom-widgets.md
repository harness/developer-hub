...
* [Before You Begin](configure-custom-widgets.md#before-you-begin)
* [Step: Add Custom Widgets](configure-custom-widgets.md#step-add-custom-widgets)
* [Step: Configure Custom Widgets](configure-custom-widgets.md#step-configure-custom-widgets)
* [Step: Configure Services Widget](configure-custom-widgets.md#step-configure-services-widget)
* [Step: Configure Workflows Widget](configure-custom-widgets.md#step-configure-workflows-widget)
* [View/Edit Widgets](configure-custom-widgets.md#view-edit-widgets)
* [Remove Widgets](configure-custom-widgets.md#remove-widgets)
* [Next Steps](configure-custom-widgets.md#next-steps)
