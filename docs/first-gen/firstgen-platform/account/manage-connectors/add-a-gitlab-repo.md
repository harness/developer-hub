...
In **Select Encrypted Password/Token**, select or create a new [Harness Encrypted Text secret](/article/ygyvp998mu-use-encrypted-text-secrets) for the credentials of your Gitlab user account.
...
![](https://files.helpdocs.io/kw8ldg1itf/articles/ay9hlwbgwa/1541457720695/image.png)### Step: Test and Save
