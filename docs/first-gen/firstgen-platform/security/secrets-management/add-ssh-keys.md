...
This content is for Harness [FirstGen](../../../../getting-started/harness-first-gen-vs-harness-next-gen.md). Switch to [NextGen](/docs/platform/secrets/add-use-ssh-secrets).You can add SSH keys for use in connecting to remote servers, such as an AWS EC2 instance.
