...
The event for creating the dummy secret this will show up on [Audit Trail](/docs/platform/hovernance/audit-trail/audit-trail.md) as if the user who initiated the creation of the Vault Secrets Manager created the secret. The path of the secret is as follows:
