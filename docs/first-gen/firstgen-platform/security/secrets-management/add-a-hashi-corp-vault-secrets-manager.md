...
This content is for Harness FirstGen. Switch to [NextGen](/docs/platform/secrets/secrets-management/add-hashicorp-vault).To store and use encrypted secrets (such as access keys), you can add a HashiCorp Vault Secrets Manager.
