...
6. Make sure to copy this secret and save it as an encrypted text secret. For detailed steps to create an encrypted text in Harness, go to [Use Encrypted text Secrets](/docs/first-gen/firstgen-platform/security/Secrets/2-add-use-text-secrets.md).
