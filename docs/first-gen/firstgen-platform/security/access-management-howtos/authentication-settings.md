...
:::note
This content is for Harness [FirstGen](../../../../getting-started/harness-first-gen-vs-harness-next-gen.md). Switch to [NextGen](../../../../platform/3_Authentication/1-authentication-overview.md).
...
* [Accessing Authentication Settings](#accessing-authentication-settings)
* [Enabling SSO Providers](#enabling-sso-providers)
...
* [Restricting Email Domains](#restricting-email-domains)
...
2. Click the More Options ⋮ menu beside the user you want to unlock, then click **Email Password Rest Link**.
   
   ![](./static/authentication-settings-219.png)

3. Select **Confirm** in the resulting dialog.
   
   ![](./static/authentication-settings-220.png)
...
2. Click the More Options ⋮ menu beside the user you want to unlock, then click **Unlock**.
   
   ![](./static/authentication-settings-225.png)

3. In the resulting dialog, confirm that you want to unlock this user.
   
   ![](./static/authentication-settings-226.png)



### Enforcing Two Factor Authentication

If you enable options in the page's bottom **Security Options** section, these options will govern all logins—whether through [SSO providers](#enabling-sso-providers) or through [Harness username/password](#enforcing-password-policies) combinations.
...
As with the [Password Policy](#enforcing-password-policies) settings, you can modify your domain selections by clicking the More Options ⋮ menu, then clicking **Edit** to reopen the dialog.
