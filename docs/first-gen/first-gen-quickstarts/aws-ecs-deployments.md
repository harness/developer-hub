...
2. Enter the name **ECS Tutorial**, and click **SUBMIT**. Your new Application appears.
   ...
   We won't cover all of the Application entities in this tutorial. We assume you've read  [Learn Harness' Key Concepts](/docs/first-gen/starthere-firstgen/harness-key-concepts.md).
