...
This content is for Harness [FirstGen](/article/1fjmm4by22). Switch to [NextGen](/article/m7nkbph0ac).Once you've added a Service to your Application, you can define Environments where your Service can be deployed.

* [Create a New Harness Environment](https://docs.harness.io/article/7qsyj7wvpq-3-azure-environment#create_a_new_harness_environment)
* [Add an Infrastructure Definition](https://docs.harness.io/article/7qsyj7wvpq-3-azure-environment#add_an_infrastructure_definition)
* [Next Step](https://docs.harness.io/article/7qsyj7wvpq-3-azure-environment#next_step)
...
* A Cloud Provider, such as the Kubernetes Cluster Cloud Provider that you added in [Cloud Providers Setup](https://docs.harness.io/article/z75kx7sur5-1-harness-account-setup#cloud_providers_setup).
...
[​Infrastructure Definitions](/article/v3l3wqovbe-infrastructure-definitions) specify the target deployment infrastructure for your Harness Services, and the specific infrastructure details for the deployment, like VPC settings. 
...
7. In **Namespace**, enter the name of the cluster namespace you want to use. As we noted in [Namespace Variable](https://docs.harness.io/article/jjd1wrre7g-2-service-and-artifact-source#namespace_variable), you can enter any value here and the Service will use it in its Namespace manifest to create the namespace at runtime.
