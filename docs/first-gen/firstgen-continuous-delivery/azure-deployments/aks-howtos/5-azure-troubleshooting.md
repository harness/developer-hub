...
This content is for Harness [FirstGen](/article/1fjmm4by22). Switch to [NextGen](/article/m7nkbph0ac).The following troubleshooting steps should help address common issues.
...
To fix this, set the `createImagePullSecret` setting set to `true`, as described in [Modify ImagePullSecret](https://docs.harness.io/article/jjd1wrre7g-2-service-and-artifact-source#modify_image_pull_secret):
...
* [Kubernetes Deployments](/category/n03qfofd5w-kubernetes-deployments)
