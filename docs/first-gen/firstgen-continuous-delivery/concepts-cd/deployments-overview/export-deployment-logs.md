...
This content is for Harness [FirstGen](/article/1fjmm4by22). Switch to [NextGen](/article/0slo2gklsy).Large enterprises are highly regulated and auditing the deployments happening in their environments is critical. These audits might take into account deployment information across years.

Harness provides advanced auditing in the Harness Manager, as described in [Audit Trail](/article/kihlcbcnll-audit-trail), and deployment information in the **Deployments** page and [dashboards](/article/c3s245o7z8-main-and-services-dashboards), but large enterprises want to save deployment information to their centralized archives for years to come.
...
* [Main and Services Dashboards](/article/c3s245o7z8-main-and-services-dashboards)
* [Audit Trail](/article/kihlcbcnll-audit-trail)
...
1. In **Deployments**, click the filter button to show the filter settings.![](https://files.helpdocs.io/kw8ldg1itf/articles/pe7vgjs6sv/1591385908381/image.png)
...
1. In the **Deployments** page, click the options button and click **Export Deployment Logs**.![](https://files.helpdocs.io/kw8ldg1itf/articles/pe7vgjs6sv/1591313079229/image.png)
2. In **Export Deployment Logs**, specify the Harness User Groups to notify when the log file is ready.![](https://files.helpdocs.io/kw8ldg1itf/articles/pe7vgjs6sv/1591313106673/image.png)The User Groups are notified using their email and/or Slack settings, as described in [Manage User Notifications](/article/kf828e347t-notification-groups).
3. Click **Submit**.
...
![](https://files.helpdocs.io/kw8ldg1itf/articles/pe7vgjs6sv/1591312072294/image.png)As you can see, the message has a **Download link**. Click that link to download the log archive.
...
```
The `clientMutationId` option is simply used here to demonstrate the case where multiple clients are making updates.Note the use of `userGroupIds` to indicate which Harness User Group to notify via its [Notification Settings](/article/kf828e347t-notification-groups). You can get the ID using the API queries `userGroup` or `userGroupByName` or from the Harness Manager URL when looking at the User Group.
...
![](https://files.helpdocs.io/kw8ldg1itf/articles/pe7vgjs6sv/1591390326545/image.png)The `downloadLink` field contains the link to your export log archive.
...
![](https://files.helpdocs.io/kw8ldg1itf/articles/pe7vgjs6sv/1591312492487/image.png)The folder name shows the deployment timestamp and unique ID.

Open a folder and you will see that each deployment step has a different log file.

![](https://files.helpdocs.io/kw8ldg1itf/articles/pe7vgjs6sv/1591312698611/image.png)These correspond to the deployment steps and subcommands displayed in the Harness **Deployments** page.

The README file contains a summary of all log files.

![](https://files.helpdocs.io/kw8ldg1itf/articles/pe7vgjs6sv/1591312795135/image.png)Open a log file and you will see the deployment information for the step subcommands.
