...
1. [Deployment Overview](https://docs.harness.io/article/d485c2vy7e-iis-net-deployment#deployment_overview)
2. [Delegate and Connectors for IIS](/article/1n0t9vo7e4-1-delegate-and-connectors-for-iis)
3. [Services for IIS (.NET)](/article/mm84gjllge-2-services-for-iis-net)
4. [IIS Environments in AWS and Azure](/article/itseg37bji-iis-environments)
5. [IIS Workflows and Pipelines](/article/z6ls3tgkqc-4-iis-workflows)
6. [Best Practices and Troubleshooting](/article/l639i8uqxs-5-best-practices-and-troubleshooting)
...
Before deploying the IIS website, application, or virtual directory to your Windows instances, there must be an existing [IIS Web Server Role](https://docs.microsoft.com/en-us/iis/web-hosting/web-server-for-shared-hosting/installing-the-web-server-role) on the instance. This ensures that the environment is ready for deployment. Harness IIS Website deployment requires the IIS Web Server Role. The Harness IIS Application and IIS Virtual Directory deployments require that an IIS Website exists. For more information, see [Installing IIS from the Command Line](/article/l639i8uqxs-5-best-practices-and-troubleshooting#installing_iis_from_the_command_line) below.For information about IIS sites, applications, and virtual directories, see [Understanding Sites, Applications, and Virtual Directories on IIS 7](https://docs.microsoft.com/en-us/iis/get-started/planning-your-iis-architecture/understanding-sites-applications-and-virtual-directories-on-iis).
...
7. **Continuous Verification:** Once your deployments are successful, you can add verification steps into the workflow using your verification provider. For more information, see [Continuous Verification](/article/myw4h9u05l-verification-providers-list).
8. **Refinements:** Add notification steps, failure strategy, and make your workflow a template for other users. For more information, see [Add a Workflow](/article/m220i1tnia-workflow-configuration).
...
* [Harness Requirements](/article/70zh6cbrhg-harness-requirements)
* [Delegate Installation](/article/h9tkwmkrm7-delegate-installation)
* [Harness Architecture](/article/de9t8iiynt-harness-architecture)
* [Configuration as Code](/article/htvzryeqjw-configuration-as-code)

### Next Step

* [1 - Delegate and Connectors for IIS](/article/1n0t9vo7e4-1-delegate-and-connectors-for-iis)
