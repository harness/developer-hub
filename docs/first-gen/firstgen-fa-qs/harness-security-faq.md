...
This content is for Harness [FirstGen](../../getting-started/harness-first-gen-vs-harness-next-gen.md). Switch to [NextGen](../../faqs/harness-security-faqs.md).This article addresses some frequently asked questions about Harness security features.
