...
HSF is delivered as part of an existing Professional Services package at no additional cost. If your organization is interested in getting started, reach out to your Harness account team. They will confirm your eligibility and coordinate the deployment process.
...
Once the above is confirmed, someone from the Professional Services team will guide you through the deployment. The process creates a dedicated Harness Platform Management organization in your account along with all the core pipelines, workspaces, repositories, and user groups HSF needs to operate. You can review exactly what gets created in [Created Resources](../use-hsf/created-resources.md).
