...
description: As new resources are created by various members of the team and sources, a standard process helps ensure resources are created and managed consistently. 
keywords:
  - naming convention standards
  - stack template naming
  - customer resource naming
tags:
  - hsf
  - best-practices
sidebar_position: 40
...
As new resources are created by various members of the team and sources, it is important to stick to a standard process to create and manage the resources. 
...
New Harness Templates should adhere to the following conventions:
...
### Customer-specific template library repositories
