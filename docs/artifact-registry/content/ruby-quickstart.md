...
This guide will help you **create a Ruby Artifact Registry** in Harness, **configure an upstream proxy**, and **manage Ruby packages**.

## Prerequisites
- Ensure you have the **Ruby CLI** (`gem`) installed on your local machine.
- Access to a Harness account with appropriate permissions to create registries and connectors.

---

## Create a Ruby Artifact Registry
<Tabs>
<TabItem value="interactive" label="Interactive Guide">
<DocVideo src="https://app.tango.us/app/embed/511932ac-8ac1-4db9-ab6a-3296e6974949?skipCover=false&defaultListView=false&skipBranding=false&makeViewOnly=true&hideAuthorAndDetails=true" title="Creating a New Ruby Artifact Registry" />
</TabItem>
<TabItem value="step" label="Step-by-Step">

1. Navigate to the Artifact Registry module in your Harness project.
2. Click on **New Artifact Registry**.
3. In the Registry Type dropdown, select **Ruby Registry**.
...
This registry will serve as your private Ruby registry within Harness.
:::

---

## Configure an Upstream Proxy (Optional)
An upstream proxy allows your registry to fetch Ruby packages from external sources if they are not available locally.
