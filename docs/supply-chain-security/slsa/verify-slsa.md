...
OPA policies used for SLSA Provenance verification are different from [SBOM policies](/docs/supply-chain-security/sbom-policies/create-sbom-policies) used for SBOM policy enforcement.
