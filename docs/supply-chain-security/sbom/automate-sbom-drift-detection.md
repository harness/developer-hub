...
Before you begin, make sure you understand [SBOM generation](/docs/supply-chain-security/sbom/generate-sbom) and [SBOM drift](/docs/supply-chain-security/sbom/sbom-drift).
