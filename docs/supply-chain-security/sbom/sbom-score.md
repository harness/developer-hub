...
Click on the [Artifacts](/docs/supply-chain-security/artifact-view.md) section in the left-hand panel which lists all the artifacts. Select any of the artifact,to access a detailed list of all associated digests of the artifact. In the SBOM column, you'll be able to view the corresponding score alongside the SBOM for that digest.
