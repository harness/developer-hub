...
1. [Add a Secrets Manager](../../platform/7_Connectors/Secret-Managers/5-add-secrets-manager.md). By default, Harness Self-Managed Enterprise Edition installations use the local Harness MongoDB for the default Harness Secrets Manager. This is not recommended.  
