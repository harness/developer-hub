...
See [Add and Manage User Groups](../../platform/3_User-Management/4-add-user-groups.md).
...
3. [Add a Secrets Manager](../../platform/Secrets/Secrets-Management/5-add-secrets-manager.md). By default, Harness Self-Managed Enterprise Edition installations use the local Harness MongoDB for the default Harness Secrets Manager. This is not recommended.  
