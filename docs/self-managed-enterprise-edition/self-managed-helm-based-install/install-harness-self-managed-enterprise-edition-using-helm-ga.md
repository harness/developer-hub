...
:::info note
You can also [install in air-gapped environment](docs/self-managed-enterprise-edition/self-managed-helm-based-install/install-in-an-air-gapped-environment/).
:::
