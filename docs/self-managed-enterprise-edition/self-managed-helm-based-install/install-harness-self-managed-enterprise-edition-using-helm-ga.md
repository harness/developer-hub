...
The account you use to install Harness Self-Managed Enterprise Edition must have the Account Admin role, at minimum. For more information on role-based permissions, go to [Role-based access control overview](/docs/platform/role-based-access-control/rbac-in-harness.md).
