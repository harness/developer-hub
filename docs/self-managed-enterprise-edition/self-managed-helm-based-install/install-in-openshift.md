...
:::info important
This feature is currently in beta. Harness has tested and verified OpenShift version 4.13.x. For more information about beta features, go to [Beta, Limited GA, and GA definitions](/docs/get-started/beta-preview-ga/).
