...
* [SLSA Build Level 1, Level 2 and Level 3.](/docs/software-supply-chain-assurance/slsa/overview)
...
Go to [SCS key concepts](/docs/software-supply-chain-assurance/get-started/key-concepts) to understand these features and how SCS integrates with the Harness Platform.
