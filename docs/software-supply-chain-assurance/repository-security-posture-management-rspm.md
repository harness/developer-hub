...
:::tip
To onboard the large number of GitHub repositories, you can use [Automate GitHub Onboarding via IDP workflows](/docs/software-supply-chain-assurance/automate-github-onboarding-via-idp-workflows.md) for a seamless process
:::
