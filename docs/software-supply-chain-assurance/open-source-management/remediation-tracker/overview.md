...
Set up a tracker and monitor it through to closure:

* [Create and Manage a Remediation tracker](/docs/software-supply-chain-assurance/open-source-management/remediation-tracker/create-remediation-tracker): Define the component and remediation condition, then review the impacted artifacts.
* [Track Remediation Progress](/docs/software-supply-chain-assurance/open-source-management/remediation-tracker/track-remediation-progress): Monitor pending and remediated environments until the tracker closes.