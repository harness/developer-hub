...
client and server keys serve different purposes. You can find more information about this difference https://developer.harness.io/docs/feature-flags/use-ff/ff-sdks/sdk-overview/client-side-and-server-side-sdks/#sdk-types
