...
You need to go to the Notify Section in the pipeline and select the pipeline end notofication type even for abort pipeline notifications. You can choose the type of notification slack, email etc. 
...
Currently you can't obfuscate htpsresponse body for an https step. 
...
### Is it possible ti change the company and account name in Harness
