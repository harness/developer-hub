...
:::tip
The FAQs below are based on Harness CE entities using [Harness Delegate](/docs/chaos-engineering/use-harness-ce/infrastructures/type/ddcr#what-is-ddcr).
:::
...
Go to [Harness Delegate](/docs/chaos-engineering/use-harness-ce/infrastructures/typs/ddcr#what-is-ddcr) for more information.
