...
- Go to [Failure strategies in Database DevOps](/docs/database-devops/use-database-devops/failure-strategies) to configure how your pipeline handles changeset failures.
