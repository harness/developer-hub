...
### Webhooks
The [webhook integration](../webhooks/overview.md) supports any monitoring system or custom application that can send HTTP requests. Common use cases include:
...
- Go to [Alert Integrations](./integrations/overview.md) to configure native monitoring tool integrations.
- Go to [Configure Webhooks](../webhooks/overview.md) for custom alert sources.
