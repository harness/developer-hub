...
8. Set up alert rules to route and filter incoming Octopus Deploy events

---

## Next Steps

- Go to [Configure Alert Rules](../../../alert-rules/overview.md) to route Octopus Deploy alerts.
