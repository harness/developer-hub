...
8. Set up alert rules to route and filter incoming Grafana Incident alerts

---

## Next Steps

- Go to [Configure Alert Rules](../../../alert-rules/overview.md) to route Grafana Incident alerts.
