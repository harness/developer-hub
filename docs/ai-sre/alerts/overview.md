...
Go to [Route Alerts](/docs/ai-sre/alerts/alert-rules/overview) to set up routing and automation.
...
- [Datadog](/docs/ai-sre/alerts/webhooks/templates/monitoring/datadog)
- [New Relic](/docs/ai-sre/alerts/webhooks/templates/monitoring/new-relic)
- [Dynatrace](/docs/ai-sre/alerts/webhooks/templates/monitoring/dynatrace)
- [Sentry](/docs/ai-sre/alerts/webhooks/templates/monitoring/sentry)

**Infrastructure monitoring:**
- [Prometheus (AlertManager)](/docs/ai-sre/alerts/webhooks/templates/monitoring/prometheus)
- [Grafana](/docs/ai-sre/alerts/webhooks/templates/monitoring/grafana)
- [AWS CloudWatch](/docs/ai-sre/alerts/webhooks/templates/cloud/aws-cloudwatch)

**Incident management:**
- [PagerDuty](/docs/ai-sre/alerts/webhooks/templates/monitoring/pagerduty)
- [Opsgenie](/docs/ai-sre/alerts/webhooks/templates/monitoring/opsgenie)
- [Grafana Incident](/docs/ai-sre/alerts/webhooks/templates/monitoring/grafana-incident)

**Security and compliance:**
- [Lacework](/docs/ai-sre/alerts/webhooks/templates/monitoring/lacework)

**Website monitoring:**
- [AlertSite](/docs/ai-sre/alerts/webhooks/templates/monitoring/alertsite)

**Alert correlation:**
- [BigPanda](/docs/ai-sre/alerts/webhooks/templates/monitoring/bigpanda)

**SLO monitoring:**
- [Harness SLO](/docs/ai-sre/alerts/webhooks/templates/monitoring/harness-slo)

Go to [Webhook Templates](/docs/ai-sre/alerts/webhooks/templates/overview) to browse all available templates.
...
Go to [Create a Webhook](/docs/ai-sre/alerts/webhooks/create-webhook) for custom webhook setup.
...
Go to [Route Alerts](/docs/ai-sre/alerts/alert-rules/overview) for routing configuration.
...
Go to [Create a Runbook](/docs/ai-sre/runbooks/create-runbook) to automate alert responses.
...
- [Webhook Templates](/docs/ai-sre/alerts/webhooks/templates/overview): Use pre-configured integrations for Datadog, PagerDuty, Prometheus, and other monitoring tools.
...
- [Create a Runbook](/docs/ai-sre/runbooks/create-runbook): Automate diagnostic and remediation steps.
- [Integrate External Tools](/docs/category/integrate-external-tools): Connect Slack, Jira, ServiceNow, and other tools.
- [AI SRE Best Practices](/docs/ai-sre/resources/ai-sre-best-practices): Optimize alert management.
