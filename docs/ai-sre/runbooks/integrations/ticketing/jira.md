...
4. Configure the action with dynamic field mapping. The fields shown depend on your Jira project and issue type configuration.
...
- Go to [Runbook Integrations Overview](/docs/ai-sre/runbooks/integrations/overview) to set up project-level Jira connectors for runbook actions.
