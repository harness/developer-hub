...
3. Configure authentication (Go to [Authentication Methods](#authentication-methods) below)
...
1. Go to **Project Settings** → **Third Party Integrations (AI SRE)** → **Zoom**
...
6. Verify in Harness:
   - Go to **Project Settings** → **Third Party Integrations (AI SRE)**
...
2. **AI Scribe Bot Not Joining Meetings / ZAK Token Errors**
   ...
   - **Solution**: Switch to Server-to-Server OAuth (Go to [Switching from API Key to OAuth](#switching-from-api-key-to-oauth))
