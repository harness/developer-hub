...
sidebar_position: 5
description: Learn how to integrate ServiceNow with Harness AI SRE Runbooks using the Connector-based approach and enable bidirectional synchronization.
---

# ServiceNow Integration for Runbooks

Harness AI SRE integrates with ServiceNow through a Connector-based approach, enabling automated incident management and tracking.
