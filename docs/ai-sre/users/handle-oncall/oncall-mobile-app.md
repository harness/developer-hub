...
2. On the Environment screen, select the correct environment (e.g., Prod, QA).
   - Tap the environment name, then Continue.
...
### Step 3: Organization and project setup
1. **Select Organization:** Choose from your available organizations.
2. **Select Project:** Select the project containing your AI SRE configuration.
3. **Confirm Selection:** These settings determine:
   - Which alerts and incidents you receive
...
- **Android users:** Go to the [Android notification setup guide](/docs/ai-sre/users/handle-oncall/notifications-android) to configure notifications.
- **iOS users:** Go to the [iOS notification setup guide](/docs/ai-sre/users/handle-oncall/notifications-ios) to configure notifications.
:::
...
For comprehensive notification setup including Do Not Disturb configuration:
- Go to the [Android notification setup guide](/docs/ai-sre/users/handle-oncall/notifications-android) to configure Android notifications.
- Go to the [iOS notification setup guide](/docs/ai-sre/users/handle-oncall/notifications-ios) to configure iOS notifications.
...
3. **Shift Handoff:** Coordinate with previous or next on-call responder
...
- **Vibration Patterns:** Unique patterns for critical versus standard alerts
...
- [Integration setup guides](/docs/category/integrations): Connect monitoring and communication tools.