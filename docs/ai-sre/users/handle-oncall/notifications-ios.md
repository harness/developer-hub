...
description: Configure iOS devices to receive On-Call notifications during Do Not Disturb
...
3. Tap **Edit** at the top and scroll down to **Ringtone**.
4. Enable the **Emergency Bypass** toggle, which allows calls and messages from Harness On-Call to make a noise regardless of your silent or Focus settings.
5. Go back to the contact card, tap **Text Tone**, and again enable **Emergency Bypass** to ensure that SMS messages also ring audibly.
...
5. Click the **Add** icon and select **Harness On-Call** from the list.
...
- Added Harness On-Call to your Do Not Disturb allowed apps list.
- Enabled Emergency Bypass for the Harness contact (for SMS and calls).

---

## Customize notification sounds

For push notifications, you can pick a custom notification sound from **Notifications > Sounds**. If you want the notification to make a sound for a long time, Harness provides notification sounds ranging from 1 second to 2 minutes long.

---

## Important notes

The following settings in iOS could interfere with push notifications:
