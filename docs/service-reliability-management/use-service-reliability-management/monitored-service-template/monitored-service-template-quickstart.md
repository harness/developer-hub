...
<!-- Author Note: Insert a diagram showing steps involved in creating and configuring template -->
...
To create a new service:
	...
	**Tag** (Optional)The new service is created.
...
You can either select an existing environment or create a new environment. To create a new environment:
	1. Click **+ Add New** in the drop-down list.  
...
Connectors contain the information necessary to integrate and work with your health source. The feature can be metrics or logs.
5. Click **Next**.
