...
Harness will automatically add the **Verify** step. For example, here is a stage where Canary strategy and the **Enable Verification** option were selected.[![](./verify-deployments-with-datadog-46.png)](./verify-deployments-with-datadog-46.png)
* **Add the Verify step to an existing Execution setup:** You can also add the Verify step to the Execution section of a CD stage in a Pipeline you previously created. Simply click **Add Step** after the deployment step, and then select **Verify**.[![](./verify-deployments-with-datadog-48.png)](./verify-deployments-with-datadog-48.png)
...
![](./verify-deployments-with-datadog-50.png)
...
![](./verify-deployments-with-datadog-51.png)
...
![](./verify-deployments-with-datadog-52.png)
...
![](./verify-deployments-with-datadog-53.png)
...
![](./verify-deployments-with-datadog-54.png)
...
![](./verify-deployments-with-datadog-55.png)
...
![](./verify-deployments-with-datadog-56.png)
...
![](./verify-deployments-with-datadog-57.png)
...
![](./verify-deployments-with-datadog-58.png)
