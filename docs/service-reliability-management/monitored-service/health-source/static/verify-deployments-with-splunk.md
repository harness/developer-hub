...
- **When selecting the stage deployment strategy:**  
  ...
  Harness will automatically add the **Verify** step. For example, here is a stage where Canary strategy and the **Enable Verification** option were selected.[![](./verify-deployments-with-splunk-33.png)](./verify-deployments-with-splunk-33.png)
- **Add the Verify step to an existing Execution setup:** You can also add the Verify step to the Execution section of a CD stage in a Pipeline you previously created. Simply click **Add Step** after the deployment step, and then select **Verify**.[![](./verify-deployments-with-splunk-35.png)](./verify-deployments-with-splunk-35.png)
...
![](./verify-deployments-with-splunk-37.png)
...
1. In **Health Sources**, click **Add**. The **Add New Health Source** settings appear.
   ...
   ![](./verify-deployments-with-splunk-38.png)
...
5. In **Connector** settings, you can either choose an existing connector or click **New Connector.**
   ![](./verify-deployments-with-splunk-39.png)

6. Click **Apply Selected**. The Connector is added to the Health Source.

   ![](./verify-deployments-with-splunk-40.png)
...
8. Click **Next**. The **Customize Health Source** settings appear.
   ...
   ![](./verify-deployments-with-splunk-41.png)
...
12. Click **Fetch Records** to retrieve the details. The results are displayed under **Records.**
    ![](./verify-deployments-with-splunk-42.png)
...
![](./verify-deployments-with-splunk-43.png)
...
1. In **Artifact Tag**, use a [Harness expression](/docs/platform/variables-and-expressions/harness-variables.md) to reference the artifact in the stage Service settings.
...
![](./verify-deployments-with-splunk-44.png)
...
![](./verify-deployments-with-splunk-45.png)
