...
- **When selecting the stage deployment strategy:**  
  ...
  Harness will automatically add the **Verify** step. For example, here is a stage where Canary strategy and the **Enable Verification** option were selected.![](./verify-deployments-with-the-verify-step-20.png)
- **Add the Verify step to an existing Execution setup:** You can also add the Verify step to the Execution section of a CD stage in a Pipeline you previously created. Simply click **Add Step** after the deployment step, and then select **Verify**.![](./verify-deployments-with-the-verify-step-21.png)
...
![](./verify-deployments-with-the-verify-step-22.png)
...
![](./verify-deployments-with-the-verify-step-23.png)
...
![](./verify-deployments-with-the-verify-step-24.png)
...
![](./verify-deployments-with-the-verify-step-27.png)
...
![](./verify-deployments-with-the-verify-step-28.png)
...
![](./verify-deployments-with-the-verify-step-29.png)
...
![](./verify-deployments-with-the-verify-step-30.png)
...
![](./verify-deployments-with-the-verify-step-31.png)
...
![](./verify-deployments-with-the-verify-step-32.png)
