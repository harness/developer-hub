      ...
      <div className={styles.topSection}>
        ...
        <div className={styles.spaceBetween}>
          <div className={styles.content}>
            <p>
              <a href="/docs/chaos-engineering/get-started/introduction">Harness Chaos Engineering (CE)</a> provides the end-to-end tooling required to achieve Continuous Resilience in your
