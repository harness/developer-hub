...
import { docsCards } from './data/applicationApiProtection';
export default function ApplicationApiProtection() {
      ...
      <div className={styles.topSection}>
        <div className={styles.spaceBetween}>
          <div className={styles.moduleTitle}>
            <img width={64} src={`${baseUrl}img/icon-arp.svg`} />
            <h1>Application & Api Protection</h1>
          </div>
        ...
        <div className={styles.spaceBetween}>
          <div className={styles.content}>
            <p>
              Application & Api Protectionis a cutting-edge Generative AI-powered platform that
            ...
            <p>
              <b> How Harness Application & Api ProtectionSoftware Testing: </b>
            </p>
            <ul>
              <li>
