      ...
      list: [
        {
          ...
          link: "/docs/cloud-development-environments/manage-gitspace/create-gitspaces",
        },
        {
          title: "Delete a Gitspace",
          module: MODULES.cde,
          description: "Learn how to delete an existing Gitspace",
          link: "/docs/cloud-development-environments/manage-gitspace/delete-gitspaces",
        },
        {
          title: "Start/Stop a Gitspace",
          module: MODULES.cde,
          description: "Learn how to start/stop an existing Gitspace",
          link: "/docs/cloud-development-environments/manage-gitspace/existing-gitspaces",
        },
      ],
    },
    {
      ...
      list: [
        ...
        },
        {
          ...
          link: "/docs/cloud-development-environments/develop-using-cde/port-forward",
        },
      ],
    }
  ];