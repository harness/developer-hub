...
import { docsCards } from './data/aiSreData';
import AiSreOnboardingIllustration from './illustrations/AiSreOnboardingIllustration';
export default function AISRE() {
      ...
      <div className={styles.topSection}>
        ...
        <div className={styles.spaceBetween}>
          <div className={styles.content} style={{ width: '100%' }}>
            <p>
            Harness AI SRE is a cutting-edge module that 
            revolutionizes incident management by focusing on proactive issue 
            prevention and accelerated resolution.</p><p>A key differentiator is its 
            ...
            </p><p>Harness AI SRE automates prioritization and response orchestration while 
            integrating seamlessly with existing tools like ServiceNow, Slack, and 
            monitoring systems.</p><p>Real-time visibility into service health, error 
