  ...
  return (
    <div className="container">
      <div className={styles.SectionName}>
        <h3>
        Create Artifact Registries, which are AI-native artifact repositories that work seamlessly with your DevOps workflows. 
        </h3>
      </div>
      <div className={styles.topSection}>
        <div className={styles.spaceBetween}>
          ...
          <div className={styles.btnContainer}>
            <Link href="/docs/artifact-registry">
              <button
                className={clsx(
                  "button button--lg",
                  styles.btn,
      ...
      <div className={styles.subSection}>
        ...
        */}
        <h3 id="all-tutorials">All AR Tutorials</h3>
        <TutorialCard FeatureList={ARList} />
      </div>
    </div>
    // </Layout>
  );
