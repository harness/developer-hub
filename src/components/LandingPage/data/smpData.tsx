...
export const SMPList: CardItem[] = [
  ...
  {
    title: "Configure a self-managed TimescaleDB server",
    module: MODULES.smp,
    icon: "img/logo.svg",
    description: (
      <>Learn how to use an external TimescaleDB server with Self-Managed Enterprise Edition installations.</>
    ),
    newDoc: false,
    type: [docType.Documentation],
    time: "5 min",
    link: "/tutorials/self-managed-enterprise-edition/use-an-database-timescale",
  },
];
