...
const getCertBadges = (url: string) => [
  {
    img: `${url}img/cert-dev-asp-badge.svg`,
    alt: "Harness Certified Expert - Developer",
    type: certType.developer,
  },
  {
    img: `${url}img/cert-adm-asp-badge.svg`,
    alt: "Harness Certified Expert - Administrator",
    type: certType.administrator,
  },
  {
    img: `${url}img/cert-arc-asp-badge.svg`,
...
export default function CertificationsTBH() {
  ...
  return (
    <div
      className={`${styles.certificationsASP} ${activePage === ActivePage.SelfPacedTraning
                ...
                <div className={styles.innerCard}>
                  <div className={styles.left}>
                    ...
                    <img
                      ...
                      alt="Harness Certified Expert - API & Application Discovery Developer"
                      className={styles.badge}
                    />
                    <span className={styles.productVersion}>
                      <strong>Product version: </strong> API & Application Discovery Paid
                      Plans
                    </span>
                  </div>
                  <div className={styles.right}>
                    ...
                    <div className={styles.desc}>
                      ...
                      posture with API & Application Discovery (Traceable) projects.
                    </div>
            ...
            <div className={styles.studyGuide}>
              ...
              >
                ...
                <div className={styles.innerCard}>
                  <div className={styles.left}>
                    <h2>
                      API & Application Discovery - Administrator (BETA COMING
                      SOON)
                    </h2>
                    <img
                      src={`${baseUrl}img/cert-adm-asp-badge.svg`}
                      alt="Harness Certified Expert - API & Application Discovery Administrator"
                      className={styles.badge}
                    />
                    <span className={styles.productVersion}>
                      <strong>Product version: </strong> API & Application Discovery Paid
                  ...
                  <div className={styles.btnContainer}>
                    ...
                    <h3>Coming Soon...</h3>
                    <div className={styles.desc}>
                      Assesses the fundamental skills to deploy and maintain API & Application Discovery
            ...
            <div className={styles.studyGuide}>
              ...
              >
                ...
                <div className={styles.innerCard}>
                  <div className={styles.left}>
                    <h2>
                     API & Application Discovery - Architect (BETA COMING
                      SOON)
                    </h2>
                    <img
                      src={`${baseUrl}img/cert-arc-asp-badge.svg`}
                      alt="Harness Certified Expert - API & Application Discovery Architect"
                      className={styles.badge}
                    />
                    <span className={styles.productVersion}>
                      <strong>Product version: </strong> API & Application Discovery Paid
                  ...
                  <div className={styles.right}>
                    ...
                    <div className={styles.desc}>
                      ...
                      design, implementation and management of API & Application Discovery.
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div className={clsx(styles.tabContent, styles.active)}>
            <div className={styles.cardContainer}>
              ...
              {spt
                .filter((spt) => {
                  return (
                    (spt.module === "asp" && spt.cardType === "FREE") ||
                    (spt.module === "asp" && spt.tileType === "comming soon")
                  );
                })
                .map((spt) => (
                  <IltCard {...spt} />
