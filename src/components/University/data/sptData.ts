...
export const spt: IltCardItem[] = [
  ...
  {
    title: "Introduction to Basic CD Deployments",
    module: MODULES.cd,
    type: type.user,
    description:
      "Self-paced tidbit introducing basic CD deployments.",
    version: "Harness CD & GitOps Free Plans",
    link: "https://university-registration.harness.io/self-paced-training-tidbit-introduction-to-basic-cd-deployments",
    tileType: tileType.normal,
    cardType: cardType.SPT,
  },
  {
  ...
  {
    title: "Introduction to Harness CI UI & YAML Editor",
    module: MODULES.ci,
    type: type.user,
    description:
      "Self-paced tidbit introducing Introduction to Harness CI UI & YAML Editor.",
    version: "Harness CI Paid Plans",
    link: "https://university-registration.harness.io/self-paced-training-tidbit-introduction-to-harness-ci-ui-yaml-editor",
    tileType: tileType.normal,
    cardType: cardType.SPT,
  },
  {
  ...
  {
    title: "Introduction to Governance Policies (OPA)",
    module: MODULES.ci,
    type: type.user,
    description:
      "Self-paced tidbit introducing Governance Policies (OPA).",
    version: "Harness CI Paid Plans",
    link: "https://university-registration.harness.io/self-paced-training-tidbit-introduction-to-governance-policies-opa",
    tileType: tileType.normal,
    cardType: cardType.SPT,
  },
  {
...

  {
    ...
    type: type.user,
    description:
      "Self-paced video course introducing Harness Application Security Testing focusing on STO.",
  ...
  },
  {
    ...
    type: type.user,
    description:
      "Self-paced video course introducing Harness Application Security Testing focusing on SCS.",
    version: "Harness Application Security Testing Paid Plans",
