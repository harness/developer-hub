...
// import AdminCertificationExamDetails from "./data/arp-certification-admin-exam-details.md";
// import AdminCertificationReviewDetails from "./data/arp-certification-admin-review-guide.md";
//import DeveloperCertificationExamDetails from "./data/arp-certification-developer-exam-details.md";
//import DeveloperCertificationReviewGuide from "./data/arp-certification-developer-review-guide.md";
// import ArchitectCertificationReviewDetails from "./data/arp-certification-architect-review-guide.md";
// import ArchitectCertificationExamDetails from "./data/arp-certification-architect-exam-details.md";
...
const getCertBadges = (url: string) => [
  {
    img: `${url}img/cert-dev-arp-badge.svg`,
    alt: "Harness Certified Expert - Developer",
    type: certType.developer,
  },
  {
    img: `${url}img/cert-adm-arp-badge.svg`,
    alt: "Harness Certified Expert - Administrator",
    type: certType.administrator,
  },
  {
    img: `${url}img/cert-arc-arp-badge.svg`,
...
export default function CertificationsTBH() {
  ...
  return (
    <div
      className={`${styles.certificationsARP} ${activePage === ActivePage.SelfPacedTraning
              ...
              >
                ...
                <div className={styles.innerCard}>
                  <div className={styles.left}>
                    ...
                    <img
                      src={`${baseUrl}img/cert-dev-arp-badge.svg`}
                      alt="Harness Certified Expert - Application & API Runtime Protection Developer"
                      className={styles.badge}
                    />
                    <span className={styles.productVersion}>
                      <strong>Product version: </strong> API & Application Runtime Protection Paid
                      Plans
                    </span>
                  </div>
