...
// import AdminCertificationExamDetails from "./data/ast-certification-admin-exam-details.md";
// import AdminCertificationReviewDetails from "./data/ast-certification-admin-review-guide.md";
// import DeveloperCertificationExamDetails from "./data/ast-certification-developer-exam-details.md";
// import DeveloperCertificationReviewGuide from "./data/ast-certification-developer-review-guide.md";
// import ArchitectCertificationReviewDetails from "./data/ast-certification-architect-review-guide.md";
// import ArchitectCertificationExamDetails from "./data/ast-certification-architect-exam-details.md";
...
const getCertBadges = (url: string) => [
  {
    img: `${url}img/cert-dev-ast-badge.svg`,
    alt: "Harness Certified Expert - Developer",
    type: certType.developer,
  },
  {
    img: `${url}img/cert-adm-ast-badge.svg`,
    alt: "Harness Certified Expert - Administrator",
    type: certType.administrator,
  },
  {
    img: `${url}img/cert-arc-ast-badge.svg`,
...
export default function CertificationsTBH() {
  ...
  return (
    <div
      className={`${styles.certificationsAST} ${activePage === ActivePage.SelfPacedTraning
              ...
              >
                ...
                <div className={styles.innerCard}>
                  <div className={styles.left}>
                    ...
                    <img
                      src={`${baseUrl}img/cert-dev-ast-badge.svg`}
                      alt="Harness Certified Expert - Application & API Security Testing Developer"
                      className={styles.badge}
                    />
                    <span className={styles.productVersion}>
                      <strong>Product version: </strong> API & Application Security Testing Paid
                      Plans
                    </span>
                  </div>
            ...
            <div className={styles.studyGuide}>
              ...
              >
                ...
                <div className={styles.innerCard}>
                  <div className={styles.left}>
                    <h2>
                      Application & API Security Testing - Administrator (BETA COMING
                      SOON)
                    </h2>
                    <img
                      src={`${baseUrl}img/cert-adm-ast-badge.svg`}
                      alt="Harness Certified Expert - Application & API Security Testing Administrator"
                      className={styles.badge}
                    />
                    <span className={styles.productVersion}>
                      <strong>Product version: </strong> API & Application Security Testing Paid
              ...
              >
                ...
                <div className={styles.innerCard}>
                  <div className={styles.left}>
                    ...
                    <img
                      src={`${baseUrl}img/cert-arc-ast-badge.svg`}
                      alt="Harness Certified Expert - Application & API Security Testing Architect"
                      className={styles.badge}
                    />
                    <span className={styles.productVersion}>
                      <strong>Product version: </strong> Application & API Security Testing Paid
                      Plans
                    </span>
                  </div>
                  <div className={styles.right}>
                    ...
                    <div className={styles.desc}>
                      ...
                      design, implementation and management of Application & API Security Testing.
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div className={clsx(styles.tabContent, styles.active)}>
            <div className={styles.cardContainer}>
              ...
              {spt
                .filter((spt) => {
                  return (
                    (spt.module === "ast" && spt.cardType === "FREE") ||
                    (spt.module === "ast" && spt.tileType === "comming soon")
                  );
                })
                .map((spt) => (
                  <IltCard {...spt} />
