...
export default function CertificationsDBDEVOPS() {
  ...
  return (
    <div
      className={`${styles.certificationsFME} ${activePage === ActivePage.SelfPacedTraning
            ...
            <div className={styles.studyGuide}>
              ...
              >
                ...
                <div className={styles.innerCard}>
                  <div className={styles.left}>
                    <h2>
                      Feature Management & Experimentation - Developer (BETA COMING
                      SOON)
                    </h2>
                    <img
                    ...
                    <span className={styles.productVersion}>
                      <strong>Product version: </strong> Harness FME Paid
                      Plans
                    </span>
                  </div>
                  <div className={styles.right}>
                    ...
                    <div className={styles.desc}>
                      ...
                      applications with FME projects.
                    </div>
                    {/*
                    <DeveloperCertificationReviewGuide />

                    <div className={styles.btnContainer}>
                      <Link href="https://university-registration.harness.io/feature-management-experimentation-developer">
            ...
            <div className={styles.studyGuide}>
              ...
              >
                ...
                <div className={styles.innerCard}>
                  <div className={styles.left}>
                    <h2>
                      Feature Management & Experimentation - Administrator (BETA COMING
                      SOON)
                    </h2>
                    <img
            ...
            <div className={styles.studyGuide}>
              ...
              >
                ...
                <div className={styles.innerCard}>
                  <div className={styles.left}>
                    <h2>
                      Feature Management & Experimentation - Architect (BETA COMING
                      SOON)
                    </h2>
                    <img
              ...
              {ilt
                .filter((ilt) => {
                  return (
                    ...
                    ilt.module === "fme" ||
                    (ilt.module === "fme" && ilt.tileType === "comming soon")
                  );
                })
          ...
          <div className={clsx(styles.tabContent, styles.active)}>
            <div className={styles.cardContainer}>
              ...
              {spt
                .filter((spt) => {
                  return (
                    (spt.module === "fme" && spt.cardType === "FREE") ||
                    (spt.module === "fme" && spt.tileType === "comming soon")
                  );
                })
                .map((spt) => (
                  <IltCard {...spt} />
