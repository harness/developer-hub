        ...
        >
          <main className={`container ${styles.container}`}>
            ...
            <ul>
              ...
              <li>
                <Link to={`${baseUrl}/doc/Harness_FF_VPAT_Report.pdf`} className={styles.link}>
                  Harness FF VPAT Report
                </Link>
              </li>
              <li>
                <Link to={`${baseUrl}/doc/Harness_CCM_VPAT_Report.pdf`} className={styles.link}>
                  Harness CCM VAT Report
                </Link>
              </li>
              <li>
                <Link to={`${baseUrl}/doc/Harness_STO_VPAT_Report.pdf`} className={styles.link}>
                  Harness STO VPAT Report
                </Link>
              </li>
              <li>
                <Link to={`${baseUrl}/doc/Harness_SRM_VPAT_Report.pdf`} className={styles.link}>
                  Harness SRM VPAT Report
                </Link>
              </li>
              <li>
                <Link to={`${baseUrl}/doc/Harness_Chaos_VPAT_Report.pdf`} className={styles.link}>
                  Harness Chaos Engineering VPAT Report
                </Link>
              </li>
              <li>
                <Link to={`${baseUrl}/doc/Harness_IaCM_VPAT_Report.pdf`} className={styles.link}>
                  Harness IaCM VPAT Report
                </Link>
              </li>
              <li>
                <Link to={`${baseUrl}/doc/Harness_IDP_VPAT_Report.pdf`} className={styles.link}>
                  Harness IDP VPAT Report
                </Link>
              </li>
              <li>
                <Link to={`${baseUrl}/doc/Harness_Code_VPAT_Report.pdf`} className={styles.link}>
                  Harness Code VPAT Report
                </Link>
              </li>
              <li>
                <Link to={`${baseUrl}/doc/Harness_SEI_VPAT_Report.pdf`} className={styles.link}>
                  Harness SEI VPAT Report
                </Link>
              </li>
              <li>
                <Link to={`${baseUrl}/doc/Harness_SSCA_VPAT_Report.pdf`} className={styles.link}>
                  Harness SCS VPAT Report
                </Link>
              </li>
            </ul>
            <h1>PDF added here </h1>
            <object
              data={`/doc/Harness_CI_CD_Platform_VPAT_Report_2025.pdf`}
