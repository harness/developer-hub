...
slug: /ci-pipelines/build/signed-image
---
...
[Build Go Application Containers CI Pipeline](./ci-go-containers.md).
...
After you have built your artifact, the next step is to deploy your artifact. This is where Continuous Delivery steps in. Make sure to check out some other [CD Tutorials](/tutorials/cd-pipelines#all-tutorials).
