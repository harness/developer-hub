...
[FastAPI](https://fastapi.tiangolo.com/) is a modern and highly performant web framework that allows developers to build APIs in Python 3.7+ using standard Python type hints. One of the most notable features of FastAPI is its impressive speed, which rivals that of popular frameworks such as NodeJS and Go. This is made possible thanks to the underlying Starlette and Pydantic libraries. 
