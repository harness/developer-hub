...
- Once the bucket is created, Click on the UPLOAD FILES and upload file **hello_world.zip** for 1st gen and **helloHttp.zip** for 2nd gen.
...
8. In your Harness project, select **Environments**.
...
9. In your Harness project, select **Services**.
    - Select **New Service**.
...
10. In your Harness project, select **Pipelines**.
...
- Copy the contents of [canary-deployment.yml](https://github.com/harness-community/harnesscd-example-apps/blob/master/google_cloud_function/2nd%20gen/6-canary-pipeline.yml).
...
- Copy the contents of [bluegreen-deployment.yml](https://github.com/harness-community/harnesscd-example-apps/blob/master/google_cloud_function/2nd%20gen/6-bluegreen-pipeline.yml).
...
- Copy the contents of [rolling-deployment.yml](https://github.com/harness-community/harnesscd-example-apps/blob/master/google_cloud_function/2nd%20gen/6-rolling-pipeline.yml).
...
You can also follow the [Install Harness Delegate on Kubernetes or Docker](https://developer.harness.io/tutorials/platform/install-delegate/) tutorial to install the delegate.
...
- Copy the contents of [rolling-deployment.yml](https://github.com/harness-community/harnesscd-example-apps/blob/master/google_cloud_function/1st%20gen/6-rolling-pipeline.yml).
