...
4. **Fork the [harnessed-example-apps](https://github.com/harness-community/harnesscd-example-apps/fork)** repository through the GitHub website and download it on your local machine. 
...
5. **Install Harness CLI** 

## Getting Started with Harness CD
----------------------------------

1. Login to [Harness](https://app.harness.io/).
2. Use the Account ID from the URL and X-api-key in the following CLI command to login. 
    ```
...
1. Create the **GitHub connector** using the following CLI Command
    ```
    <CLI Command to create Github Connector>
    ```
    
2. Create the **Kubernetes connector** using the following CLI Command
    ```
    <CLI Command to create the Kubernetes Connector>
    ```
