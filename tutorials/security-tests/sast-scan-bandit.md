---
title: Codebase scans with Bandit
description: Start with this tutorial! Learn how to set up a pipeline with one scanner, run scans, analyze the results, and learn the key features of STO.
sidebar_position: 1
