...
- **Holistic platform view:** The primary navigation shows all platform capabilities (Pipelines, Environments, Connectors, Secrets, Code, etc.) without requiring you to select a module first. This reduces context switching and provides a unified view of your project.
