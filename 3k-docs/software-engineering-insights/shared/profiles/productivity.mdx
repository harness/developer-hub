import trellisProfile from '@site/docs/software-engineering-insights/propelo-sei/setup-sei/sei-profiles/static/trellis-profile.png';
import trellisAssociations from '@site/docs/software-engineering-insights/propelo-sei/setup-sei/sei-profiles/static/trellis-associations.png';
import trellisAdvanced from '@site/docs/software-engineering-insights/propelo-sei/setup-sei/sei-profiles/static/trellis-advanced-options.png';
import factors from '@site/docs/software-engineering-insights/propelo-sei/setup-sei/sei-profiles/static/factors-and-weights.png';

Trellis Scores are a proprietary scoring mechanism from Harness SEI. Your Trellis Score helps you understand your team's productivity. [Trellis Scores](/docs/category/trellis-scores) are calculated from factors such as code quality, code volume, speed, impact, proficiency, and collaboration. You can adjust the weight given to each factor.
...
<img src={trellisProfile} alt="Predefined Trellis Profiles" width="1000" />
...
<img src={trellisAssociations} alt="Trellis Associations" width="1000" />
...
<img src={trellisAdvanced} alt="Advanced Options" width="1000" />
...
<img src={factors} alt="Factors and Weights" width="1000" />
