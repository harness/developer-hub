import businessAlignment from '@site/docs/software-engineering-insights/propelo-sei/analytics-and-reporting/static/ba-report.png';
import drilldownContributors from '@site/docs/software-engineering-insights/propelo-sei/analytics-and-reporting/static/drilldown-contributors.png';
import drilldownTickets from '@site/docs/software-engineering-insights/propelo-sei/analytics-and-reporting/static/drilldown-tickets.png';
import unresolvedIssues from '@site/docs/software-engineering-insights/propelo-sei/analytics-and-reporting/static/unresolved-issues.png';
import timePeriod from '@site/docs/software-engineering-insights/propelo-sei/analytics-and-reporting/static/inprogress-time-period.png';
import effortAttribution from '@site/docs/software-engineering-insights/propelo-sei/analytics-and-reporting/static/effort-attribution.png';
import effortUnit from '@site/docs/software-engineering-insights/propelo-sei/analytics-and-reporting/static/effort-unit.png';
import effortCalculation from '@site/docs/software-engineering-insights/propelo-sei/analytics-and-reporting/static/effort-calculation.png';
...
<img src={businessAlignment} alt="Business Alignment Report" width="1000" />
...
<img src={drilldownContributors} alt="Drilldown Contributors" width="1000" />
...
<img src={drilldownTickets} alt="Drilldown Tickets" width="1000" />

:::info
The **Drilldown by Contributor** option is available only if the widget is configured to calculate effort by engineer (FTE).
:::
...
:::info
If an engineer has worked on 5 tickets, belonging to 3 different categories, their effort is distributed across the 3 categories based on the Effort Unit and Effort Attribution selected.
:::
...
:::info
This feature is behind the Feature Flag `<SEI_NEW_BA_COMBINED_WIDGET>` and `<SEI_BA_INCLUDE_UNRESOLVED_ISSUES>`. Contact [Harness Support](mailto:support@harness.io) to enable this feature.
:::
...
* Under the **Filters** tab, enable the **Include Unresolved Issues** option. By selecting this option, tickets that are in the **In Progress status category** will be included in the metric calculation. If you only want to include only resolved tickets, leave this option unchecked.
  ...
  <img src={unresolvedIssues} alt="Include Unresolved Issues" width="1000" />
...
* Specify the time period or date range for which you want to include tickets in the calculation and display within the widget.
  ...
  <img src={timePeriod} alt="In Progress Time Period" width="1000" />
...
* The **Effort Attribution** will automatically be selected as **Only use current assignee**
  ...
  <img src={effortAttribution} alt="Effort Attribution" width="1000" />

* In this case, **Ticket Time Spent** is the only supported **Effort Unit** and not **Story Points** or **Ticket Count**.

  <img src={effortUnit} alt="Effort Unit" width="1000" />
...
* The **Effort Calculation** will automatically be selected as **Absolute (By ticket)**.
  ...
  <img src={effortCalculation} alt="Effort Calculation" width="1000" />
