...
You can use all of the [instance expressions](/docs/platform/variables-and-expressions/harness-variables#deployment-instance-expressions) to reference your hosts. These expressions can only be used with a looping strategy.
