          ...
          items: [
            {
              ...
              items: [
                ...
                'ai/configure-ai-clients',
                'ai/hosted-mcp',
                'ai/self-hosted-deployment',
                'ai/environment-variables',
                'ai/tools-reference',
                'ai/resource-types',
                'ai/prompt-templates',
                'ai/approvals-and-safety',
                'ai/troubleshooting',
              ],
            },
            'ai/vscode-extension',
  ...
  continuousdelivery: [
    {
      ...
      collapsed: true,
      items: [
        { type: 'html', value: 'New to Deployments?', className: 'horizontal-bar' },
        'continuous-delivery/overview',
        'continuous-delivery/getting-started',
        'continuous-delivery/cd-integrations',
        { type: 'html', value: 'Use Deployments', className: 'horizontal-bar' },
        {
          type: 'category',
          label: 'Kubernetes',
          link: { type: 'generated-index', title: 'Kubernetes Deployments' },
          collapsed: true,
          items: [
            { type: 'autogenerated', dirName: 'continuous-delivery/v1-deployments/kubernetes' },
          ],
        },
        {
          type: 'category',
          label: 'Helm',
          link: { type: 'generated-index', title: 'Helm Deployments' },
          collapsed: true,
          items: [
            { type: 'autogenerated', dirName: 'continuous-delivery/v1-deployments/helm' },
          ],
        },
        { type: 'html', value: 'YAML Reference', className: 'horizontal-bar' },
        'continuous-delivery/v1-deployments/step-library-yaml-reference',
      ],
    },
  ],
  infrastructureascodemanagement: [
    {
      ...
      items: [
        ...
        },
        {
          ...
          link: {
            type: 'generated-index',
            slug: '/category/iacm-provisioners',
          },
          collapsed: true,
          items: [
            {
