    ...
    // Documentation Parent
    {
      ...
      items: [
        ...
        // Cloud Development Environments Landing Page
        {
          ...
          href: "/docs/cloud-development-environment",
          
          customProps: {
            description:
              "Accelerate developer experience with secure, scalable and pre-configured developer environments",
          },
        },
        // SEI
        {
        ...
        {
          type: "link",
          href: "docs/category/docs/open-source",
          label: "Open Source",
  ...
  clouddevelopmentenvironment: [
    {
      ...
      collapsed: true,
      items: [{ type: "autogenerated", dirName: "cloud-development-environment" }],
    }, // Release Notes
    {
      type: "link",
      label: "Release Notes",
      className: "sidebar-Release_Notes",
      href: "/release-notes/cloud-development-environment",
      customProps: {
        description: "Learn about recent changes to Harness products.",
      },
    },
