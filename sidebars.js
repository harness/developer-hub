  ...
  infrastructureascodemanagement: [
    {
      ...
      items: [
        ...
        {
          type: "category",
          label: "Getting started with IaCM",
          link: {
            type: "generated-index",
            slug: "infra-as-code-management/get-started-with-iacm", // I had to provide this folder path,
            // and also change the path in /src/components/HomepageFeatures/data/featureListData.tsx for some reason.
            // yarn build complained that it couldn't find docs/category/get-started-with-iacm
            // Maybe it was a build timing issue.
          },
          collapsed: true,
          items: [ { type: "autogenerated", dirName: "infra-as-code-management/get-started", } ],
        },,
        {
          type: "html",
          value: "Use IaCM",
        ...
        },
        {
          ...
          collapsed: true,
          items: [ { type: "autogenerated", dirName: "infra-as-code-management/policies", } ],
        },
        {
          type: "category",
        ...
        "infra-as-code-management/iacm_security",
        {
          type: "category",
        ...
        "infra-as-code-management/module-registry",
